import { Megaphone, Download, ArrowLeft, Lock } from 'lucide-react';
import { BackButton } from '@/app/components/BackButton';

interface InternalMarketingDocsProps {
  onNavigate: (page: string) => void;
}

export function InternalMarketingDocs({ onNavigate }: InternalMarketingDocsProps) {
  const documents = [
    { name: 'Brand Guidelines 2026', file: 'Brand_Guidelines.pdf', size: '18.2 MB', date: 'Jan 30, 2026' },
    { name: 'Marketing Strategy Q1-Q2 2026', file: 'Marketing_Strategy.pdf', size: '7.6 MB', date: 'Jan 28, 2026' },
    { name: 'Social Media Content Calendar', file: 'Content_Calendar.pdf', size: '3.9 MB', date: 'Jan 25, 2026' },
    { name: 'Student Recruitment Materials', file: 'Student_Materials.pdf', size: '11.4 MB', date: 'Jan 20, 2026' },
    { name: 'Employer Outreach Templates', file: 'Employer_Templates.pdf', size: '4.8 MB', date: 'Jan 18, 2026' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-zinc-900">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-orange-300">✓ {documents.length} Documents Available</p>
              </div>
            </div>
      ...
      <div className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <h2 className="text-4xl font-bold text-white mb-2">Marketing Materials Repository</h2>
          ...
          <div className="grid gap-4">
            {documents.map((doc, index) => (
              <button
                ...
                className="group bg-white/10 backdrop-blur-xl rounded-2xl p-6 border-2 border-orange-400/30 hover:border-orange-400/60 hover:bg-white/15 transition-all cursor-pointer"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <div className="flex items-center gap-4 text-sm text-white/60">
                        ...
                        <span>•</span>
                        <span className="text-orange-400 font-semibold">PDF</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 px-4 py-2 bg-orange-500/20 rounded-lg">
                      ...
                      <span className="text-orange-300 font-semibold">Download</span>
                    </div>
                  </div>
                </div>
              </button>
