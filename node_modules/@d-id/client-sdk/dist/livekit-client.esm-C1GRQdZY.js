...
var Ma = Object.defineProperty, Aa = (n, e, t) => e in n ? Ma(n, e, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: t
}) : n[e] = t, Un = (n, e, t) => Aa(n, typeof e != "symbol" ? e + "" : e, t);
class re {
  constructor() {
    Un(this, "_locking"), Un(this, "_locks"), this._locking = Promise.resolve(), this._locks = 0;
  }
  isLocked() {
...
const Na = 34028234663852886e22, La = -34028234663852886e22, Ua = 4294967295, Fa = 2147483647, Ba = -2147483648;
function Nt(n) {
  if (typeof n != "number") throw new Error("invalid int 32: " + typeof n);
  if (!Number.isInteger(n) || n > Fa || n < Ba) throw new Error("invalid int 32: " + n);
}
function Ni(n) {
  if (typeof n != "number") throw new Error("invalid uint 32: " + typeof n);
  if (!Number.isInteger(n) || n > Ua || n < 0) throw new Error("invalid uint 32: " + n);
}
function Bs(n) {
  if (typeof n != "number") throw new Error("invalid float 32: " + typeof n);
  if (Number.isFinite(n) && (n > Na || n < La))
    throw new Error("invalid float 32: " + n);
}
const js = Symbol("@bufbuild/protobuf/enum-type");
function ja(n) {
  const e = n[js];
...
function qa(n, e, t, i) {
  var s;
  const r = (s = i == null ? void 0 : i.localName) !== null && s !== void 0 ? s : e.substring(e.lastIndexOf(".") + 1), a = {
    [r]: function(o) {
      n.util.initFields(this), n.util.initPartial(o, this);
    }
  }[r];
  return Object.setPrototypeOf(a.prototype, new gn()), Object.assign(a, {
    runtime: n,
    typeName: e,
...
function Fn(n) {
  ...
  return r(-24, -18), r(-18, -12), r(-12, -6), r(-6), e ? Ws(i, s) : vn(i, s);
}
function Ga(n, e) {
  let t = vn(n, e);
  const i = t.hi & 2147483648;
  i && (t = Ws(t.lo, t.hi));
  const s = Gs(t.lo, t.hi);
  return i ? "-" + s : s;
}
function Gs(n, e) {
  if ({
  ...
  const c = 1e7;
  return r >= c && (a += Math.floor(r / c), r %= c), a >= c && (o += Math.floor(a / c), a %= c), o.toString() + Bn(a) + Bn(r);
}
function Wa(n, e) {
  return {
    lo: n >>> 0,
...
function za() {
  ...
  return {
    ...
    enc(s) {
      return typeof s != "string" && (s = s.toString()), t(s), Fn(s);
    },
    uEnc(s) {
      return typeof s != "string" && (s = s.toString()), i(s), Fn(s);
    },
    dec(s, r) {
      return Ga(s, r);
    },
...
class Ja {
   ...
   */
  sfixed64(e) {
    let t = new Uint8Array(8), i = new DataView(t.buffer), s = W.enc(e);
   ...
   */
  fixed64(e) {
    let t = new Uint8Array(8), i = new DataView(t.buffer), s = W.uEnc(e);
    return i.setInt32(0, s.lo, !0), i.setInt32(4, s.hi, !0), this.raw(t);
  }
  /**
  ...
  int64(e) {
    let t = W.enc(e);
    return gi(t.lo, t.hi, this.buf), this;
  }
  /**
   * Write a `sint64` value, a signed, zig-zag-encoded 64-bit varint.
   */
  sint64(e) {
    let t = W.enc(e), i = t.hi >> 31, s = t.lo << 1 ^ i, r = (t.hi << 1 | t.lo >>> 31) ^ i;
    return gi(s, r, this.buf), this;
  }
  /**
...
class Qa {
  constructor(e, t) {
    this.varint64 = Ka, this.uint32 = Ha, this.buf = e, this.len = e.length, this.pos = 0, this.view = new DataView(e.buffer, e.byteOffset, e.byteLength), this.textDecoder = t ?? new TextDecoder();
  }
  /**
  ...
  sint64() {
    ...
    return e = (e >>> 1 | (t & 1) << 31) ^ i, t = t >>> 1 ^ i, W.dec(e, t);
  }
  /**
...
let Oe = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""), ti = [];
for (let n = 0; n < Oe.length; n++) ti[Oe[n].charCodeAt(0)] = n;
ti[45] = Oe.indexOf("+");
ti[95] = Oe.indexOf("/");
const Js = {
  /**
  ...
  dec(n) {
    ...
    for (let o = 0; o < n.length; o++) {
      if (r = ti[n.charCodeAt(o)], r === void 0)
        switch (n[o]) {
          case "=":
            s = 0;
          case `
`:
  ...
  enc(n) {
    ...
    for (let r = 0; r < n.length; r++)
      switch (i = n[r], t) {
        case 0:
          e += Oe[i >> 2], s = (i & 3) << 4, t = 1;
          break;
        case 1:
          e += Oe[s | i >> 4], s = (i & 15) << 2, t = 2;
          break;
        case 2:
          e += Oe[s | i >> 6], e += Oe[i & 63], t = 0;
          break;
      }
    return t && (e += Oe[s], e += "=", t == 1 && (e += "=")), e;
  }
};
function Za(n, e, t) {
  Ys(e, n);
  const i = e.runtime.bin.makeReadOptions(t), s = $a(n.getType().runtime.bin.listUnknownFields(n), e.field), [r, a] = zs(e);
  for (const o of s)
...
function Xs(n, e) {
  ...
  switch (n.kind) {
    case "enum":
    case "scalar":
      return n.opt || n.req ? e[t] !== void 0 : n.kind == "enum" ? e[t] !== n.T.values[0].no : !Hs(n.T, e[t]);
    case "message":
      return e[t] !== void 0;
    case "map":
...
function De(n, e) {
  if (n === null || typeof n != "object" || !Object.getOwnPropertyNames(gn.prototype).every((i) => i in n && typeof n[i] == "function"))
    return !1;
  const t = n.getType();
  return t === null || typeof t != "function" || !("typeName" in t) || typeof t.typeName != "string" ? !1 : e === void 0 ? !0 : t.typeName == e.typeName;
}
function $s(n, e) {
  return De(e) || !n.fieldWrapper ? e : n.fieldWrapper.wrapField(e);
}
T.DOUBLE, T.FLOAT, T.INT64, T.UINT64, T.INT32, T.UINT32, T.BOOL, T.STRING, T.BYTES;
const qn = {
...
function io(n) {
  return n ? Object.assign(Object.assign({}, Kn), n) : Kn;
}
const Jt = Symbol(), Ut = Symbol();
function no() {
  return {
    makeReadOptions: to,
    makeWriteOptions: io,
      ...
      try {
        for (s of t.fields.byNumber()) {
          if (!Xs(s, n)) {
            ...
            if (!e.emitDefaultValues || !ro(s))
              continue;
          }
          const a = s.oneof ? n[s.oneof.localName].value : n[s.localName], o = Wn(s, a, e);
        ...
        if (r != null && r.findExtensionFor)
          for (const a of t.runtime.bin.listUnknownFields(n)) {
            ...
            if (o && Qs(n, o)) {
              const c = Za(n, o, e), d = Wn(o.field, c, e);
    ...
    readScalar(n, e, t) {
      return kt(n, e, t ?? Ke.BIGINT, !0);
    },
    writeScalar(n, e, t) {
      if (e !== void 0 && (t || Hs(n, e)))
        return Ft(n, e);
    },
    debug: ke
  };
...
function Gn(n, e, t, i, s) {
  ...
  if (t.repeated) {
    if (z(t.kind != "map"), e === null)
      return;
    if (!Array.isArray(e))
      throw new Error("cannot decode field ".concat(s.typeName, ".").concat(t.name, " from JSON: ").concat(ke(e)));
    const a = n[r];
    for (const o of e) {
      if (o === null)
        throw new Error("cannot decode field ".concat(s.typeName, ".").concat(t.name, " from JSON: ").concat(ke(o)));
      switch (t.kind) {
        case "message":
          a.push(t.T.fromJson(o, i));
          break;
        case "enum":
          const c = vi(t.T, o, i.ignoreUnknownFields, !0);
          c !== Ut && a.push(c);
          break;
        case "scalar":
          try {
            ...
            let l = "cannot decode field ".concat(s.typeName, ".").concat(t.name, " from JSON: ").concat(ke(o));
    ...
    for (const [o, c] of Object.entries(e)) {
      ...
      try {
        ...
        let u = "cannot decode map key for field ".concat(s.typeName, ".").concat(t.name, " from JSON: ").concat(ke(e));
      ...
      switch (t.V.kind) {
        case "message":
          ...
          break;
        case "enum":
          const l = vi(t.V.T, c, i.ignoreUnknownFields, !0);
          l !== Ut && (a[d] = l);
          break;
        case "scalar":
          try {
            a[d] = kt(t.V.T, c, Ke.BIGINT, !0);
          } catch (u) {
            let h = "cannot decode map value for field ".concat(s.typeName, ".").concat(t.name, " from JSON: ").concat(ke(e));
    ...
    switch (t.oneof && (n = n[t.oneof.localName] = {
      ...
      case "message":
        ...
        if (e === null && a.typeName != "google.protobuf.Value")
          return;
        let o = n[r];
        De(o) ? o.fromJson(e, i) : (n[r] = o = a.fromJson(e, i), a.fieldWrapper && !t.oneof && (n[r] = a.fieldWrapper.unwrapField(o)));
        break;
      case "enum":
        const c = vi(t.T, e, i.ignoreUnknownFields, !1);
        switch (c) {
          case Jt:
            Vn(t, n);
            break;
      ...
      case "scalar":
        try {
          ...
          let l = "cannot decode field ".concat(s.typeName, ".").concat(t.name, " from JSON: ").concat(ke(e));
          throw d instanceof Error && d.message.length > 0 && (l += ": ".concat(d.message)), new Error(l);
        }
        break;
    }
...
function so(n, e) {
  ...
  return kt(n, e, Ke.BIGINT, !0).toString();
}
function kt(n, e, t, i) {
  if (e === null)
    return i ? lt(n, t) : Jt;
  switch (n) {
    ...
    case T.UINT32:
      ...
      return n == T.UINT32 || n == T.FIXED32 ? Ni(r) : Nt(r), r;
    case T.INT64:
    case T.SFIXED64:
    case T.SINT64:
...
function vi(n, e, t, i) {
  if (e === null)
    return n.typeName == "google.protobuf.NullValue" ? 0 : i ? n.values[0].no : Jt;
  switch (typeof e) {
    case "number":
...
function Wn(n, e, t) {
  if (n.kind == "map") {
    ...
    switch (n.V.kind) {
      ...
      case "enum":
        const r = n.V.T;
        for (const [a, o] of s)
          i[a.toString()] = bi(r, o, t.enumAsInteger);
        break;
    }
  ...
  if (n.repeated) {
    ...
    switch (n.kind) {
      ...
      case "enum":
        for (let s = 0; s < e.length; s++)
          i.push(bi(n.T, e[s], t.enumAsInteger));
        break;
      case "message":
        for (let s = 0; s < e.length; s++)
          i.push(e[s].toJson(t));
  ...
  switch (n.kind) {
    case "scalar":
      return Ft(n.T, e);
    case "enum":
      return bi(n.T, e, t.enumAsInteger);
    case "message":
      return $s(n.T, e).toJson(t);
  }
}
function bi(n, e, t) {
  var i;
...
function Ft(n, e) {
  switch (n) {
    ...
    case T.BYTES:
      return z(e instanceof Uint8Array), Js.enc(e);
  }
}
const et = Symbol("@bufbuild/protobuf/unknown-fields"), Hn = {
  readUnknownFields: !0,
  readerFactory: (n) => new Qa(n)
}, zn = {
  writeUnknownFields: !0,
  writerFactory: () => new Ja()
};
function ao(n) {
  return n ? Object.assign(Object.assign({}, Hn), n) : Hn;
}
function oo(n) {
...
function co() {
  return {
    ...
    readMessage(n, e, t, i, s) {
      ...
      let o, c;
      for (; e.pos < a && ([o, c] = e.tag(), !(s === !0 && c == Q.EndGroup)); ) {
...
function Jn(n, e, t, i, s) {
  ...
  switch (t.oneof && (n = n[t.oneof.localName], n.case != a && delete n.value, n.case = a, a = "value"), t.kind) {
    case "scalar":
    case "enum":
      const o = t.kind == "enum" ? T.INT32 : t.T;
      let c = Qt;
      if (t.kind == "scalar" && t.L > 0 && (c = uo), r) {
        let h = n[a];
        if (i == Q.LengthDelimited && o != T.STRING && o != T.BYTES) {
    ...
    case "message":
      const d = t.T;
      r ? n[a].push(Bt(e, new d(), s, t)) : De(n[a]) ? Bt(e, n[a], s, t) : (n[a] = Bt(e, new d(), s, t), d.fieldWrapper && !t.oneof && !t.repeated && (n[a] = d.fieldWrapper.unwrapField(n[a])));
      break;
    case "map":
      let [l, u] = lo(t, e, s);
      n[a][l] = u;
      ...
      case 2:
        switch (n.V.kind) {
          ...
          case "enum":
            ...
            break;
          case "message":
            a = Bt(e, new n.V.T(), t, void 0);
            break;
        }
        break;
    }
  }
  if (r === void 0 && (r = lt(n.K, Ke.BIGINT)), typeof r != "string" && typeof r != "number" && (r = r.toString()), a === void 0)
    switch (n.V.kind) {
      case "scalar":
        a = lt(n.V.T, Ke.BIGINT);
        break;
      case "enum":
        a = n.V.T.values[0].no;
        break;
...
function ho(n, e, t, i, s) {
  n.tag(t.no, Q.LengthDelimited), n.fork();
  let r = i;
  switch (t.K) {
    case T.INT32:
    case T.FIXED32:
  ...
  switch (Tt(n, t.K, 1, r), t.V.kind) {
    ...
    case "enum":
      ...
      break;
    case "message":
      z(s !== void 0), n.tag(2, Q.LengthDelimited).bytes(s.toBinary(e));
      break;
  }
  n.join();
}
function Yn(n, e, t, i) {
  const s = $s(t.T, i);
  t.delimited ? n.tag(t.no, Q.StartGroup).raw(s.toBinary(e)).tag(t.no, Q.EndGroup) : n.tag(t.no, Q.LengthDelimited).bytes(s.toBinary(e));
}
function Tt(n, e, t, i) {
  z(i !== void 0);
  let [s, r] = Zs(e);
...
function fo(n, e, t, i) {
  if (!i.length)
    return;
  n.tag(t, Q.LengthDelimited).fork();
  let [, s] = Zs(e);
        ...
        if (a[s] != null)
          switch (i.kind) {
            case "oneof":
              ...
              let d = a[s].value;
              c && c.kind == "message" && !De(d, c.T) ? d = new c.T(d) : c && c.kind === "scalar" && c.T === T.BYTES && (d = ht(d)), r[s] = {
                case: o,
                value: d
              };
              break;
            ...
            case "enum":
              let l = a[s];
              i.T === T.BYTES && (l = i.repeated ? l.map(ht) : ht(l)), r[s] = l;
              break;
            case "map":
              switch (i.V.kind) {
                case "scalar":
                case "enum":
                  if (i.V.T === T.BYTES)
                    for (const [m, b] of Object.entries(a[s]))
                      r[s][m] = ht(b);
                  else
                ...
                case "message":
                  ...
                  for (const m of Object.keys(a[s])) {
                    let b = a[s][m];
                    h.fieldWrapper || (b = new h(b)), r[s][m] = b;
                  }
                  break;
              }
              break;
            case "message":
              const u = i.T;
              if (i.repeated)
                r[s] = a[s].map((h) => De(h, u) ? h : new u(h));
              else {
                const h = a[s];
                u.fieldWrapper ? /* We can't use BytesValue.typeName as that will create a circular import */ u.typeName === "google.protobuf.BytesValue" ? r[s] = ht(h) : r[s] = h : r[s] = De(h, u) ? h : new u(h);
              }
              break;
          }
      }
      ...
      return e === t ? !0 : !e || !t ? !1 : n.fields.byMember().every((i) => {
        ...
        if (i.repeated) {
          ...
          switch (i.kind) {
            ...
            case "scalar":
              return s.every((a, o) => Ne(i.T, a, r[o]));
            case "enum":
              return s.every((a, o) => Ne(T.INT32, a, r[o]));
          }
        ...
        switch (i.kind) {
          case "message":
            let a = s, o = r;
            return i.T.fieldWrapper && (a !== void 0 && !De(a) && (a = i.T.fieldWrapper.wrapField(a)), o !== void 0 && !De(o) && (o = i.T.fieldWrapper.wrapField(o))), i.T.equals(a, o);
          case "enum":
            return Ne(T.INT32, s, r);
          case "scalar":
            return Ne(i.T, s, r);
          case "oneof":
            if (s.case !== r.case)
            ...
            switch (c.kind) {
              ...
              case "enum":
                return Ne(T.INT32, s.value, r.value);
              case "scalar":
                return Ne(c.T, s.value, r.value);
            }
          ...
          case "map":
            ...
            switch (i.V.kind) {
              ...
              case "enum":
                return d.every((h) => Ne(T.INT32, s[h], r[h]));
              case "scalar":
                const u = i.V.T;
                return d.every((h) => Ne(u, s[h], r[h]));
            }
            break;
        }
      });
...
function po(n, e, t) {
  return {
    ...
    json: no(),
    bin: co(),
    util: Object.assign(Object.assign({}, mo()), {
      newFieldList: e,
      initFields: t
    }),
    makeMessageType(i, s, r) {
      return qa(this, i, s, r);
    },
    makeEnum: Va,
    makeEnumType: qs,
    getEnumType: ja,
    makeExtension(i, s, r) {
      return Ya(this, i, s, r);
    }
  };
}
class go {
...
const yo = /* @__PURE__ */ new Set([
  ...
  "toObject"
]), ir = (n) => "".concat(n, "$"), To = (n) => ko.has(n) ? ir(n) : n, So = (n) => yo.has(n) ? ir(n) : n;
class Co {
  constructor(e) {
    this.kind = "oneof", this.repeated = !1, this.packed = !1, this.opt = !1, this.req = !1, this.default = void 0, this.fields = [], this.name = e, this.localName = vo(e);
  }
  addField(e) {
...
class ie extends gn {
  constructor(e) {
    super(), this.seconds = W.zero, this.nanos = 0, g.util.initPartial(e, this);
  }
  fromJson(e, t) {
    if (typeof e != "string")
      throw new Error("cannot decode google.protobuf.Timestamp from JSON: ".concat(g.json.debug(e)));
    ...
    return this.seconds = W.parse(s / 1e3), this.nanos = 0, i[7] && (this.nanos = parseInt("1" + i[7] + "0".repeat(9 - i[7].length)) - 1e9), this;
  }
  toJson(e) {
  ...
  static now() {
    return ie.fromDate(/* @__PURE__ */ new Date());
  }
  static fromDate(e) {
    const t = e.getTime();
    return new ie({
      seconds: W.parse(Math.floor(t / 1e3)),
      nanos: t % 1e3 * 1e6
    });
  }
  ...
  static equals(e, t) {
    return g.util.equals(ie, e, t);
  }
}
ie.runtime = g;
ie.typeName = "google.protobuf.Timestamp";
ie.fields = g.util.newFieldList(() => [{
  no: 1,
  name: "seconds",
  kind: "scalar",
  T: 3
...
const Eo = /* @__PURE__ */ g.makeMessageType("livekit.MetricsBatch", () => [{
  no: 1,
  name: "timestamp_ms",
  kind: "scalar",
  T: 3
  ...
  T: _o,
  repeated: !0
}]), Ro = /* @__PURE__ */ g.makeMessageType("livekit.TimeSeriesMetric", () => [{
  no: 1,
  name: "label",
  kind: "scalar",
  T: 13
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), wo = /* @__PURE__ */ g.makeMessageType("livekit.MetricSample", () => [{
  no: 1,
  name: "timestamp_ms",
  kind: "scalar",
  T: 3
  ...
  T: 2
  /* ScalarType.FLOAT */
}]), _o = /* @__PURE__ */ g.makeMessageType("livekit.EventMetric", () => [{
  no: 1,
  name: "label",
  kind: "scalar",
  T: 13
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), nr = /* @__PURE__ */ g.makeEnum("livekit.BackupCodecPolicy", [{
  no: 0,
  ...
  no: 2,
  name: "REGRESSION"
}]), fe = /* @__PURE__ */ g.makeEnum("livekit.TrackType", [{
  no: 0,
  name: "AUDIO"
}, {
  no: 1,
  ...
  no: 2,
  name: "DATA"
}]), Y = /* @__PURE__ */ g.makeEnum("livekit.TrackSource", [{
  no: 0,
  name: "UNKNOWN"
}, {
  no: 1,
...
}]), bn = /* @__PURE__ */ g.makeEnum("livekit.VideoQuality", [{
  no: 0,
  name: "LOW"
}, {
  no: 1,
  ...
  no: 3,
  name: "OFF"
}]), bt = /* @__PURE__ */ g.makeEnum("livekit.ConnectionQuality", [{
  no: 0,
  name: "POOR"
}, {
  no: 1,
  ...
  no: 3,
  name: "LOST"
}]), Pt = /* @__PURE__ */ g.makeEnum("livekit.ClientConfigSetting", [{
  no: 0,
  name: "UNSET"
}, {
  no: 1,
  ...
  no: 2,
  name: "ENABLED"
}]), ge = /* @__PURE__ */ g.makeEnum("livekit.DisconnectReason", [{
  no: 0,
  name: "UNKNOWN_REASON"
}, {
  no: 1,
  ...
  no: 15,
  name: "MEDIA_FAILURE"
}]), tt = /* @__PURE__ */ g.makeEnum("livekit.ReconnectReason", [{
  no: 0,
  name: "RR_UNKNOWN"
}, {
  no: 1,
...
}]), Io = /* @__PURE__ */ g.makeEnum("livekit.SubscriptionError", [{
  no: 0,
  name: "SE_UNKNOWN"
}, {
  no: 1,
...
}]), $ = /* @__PURE__ */ g.makeEnum("livekit.AudioTrackFeature", [{
  no: 0,
  name: "TF_STEREO"
}, {
  no: 1,
...
}]), ii = /* @__PURE__ */ g.makeMessageType("livekit.Room", () => [{
  no: 1,
  name: "sid",
  kind: "scalar",
  T: 9
  ...
  kind: "message",
  T: gr
}]), Yt = /* @__PURE__ */ g.makeMessageType("livekit.Codec", () => [{
  no: 1,
  name: "mime",
  kind: "scalar",
  T: 9
  ...
  T: 9
  /* ScalarType.STRING */
}]), Oo = /* @__PURE__ */ g.makeMessageType("livekit.ParticipantPermission", () => [{
  no: 1,
  name: "can_subscribe",
  kind: "scalar",
  T: 8
  ...
  T: 8
  /* ScalarType.BOOL */
}]), Qe = /* @__PURE__ */ g.makeMessageType("livekit.ParticipantInfo", () => [{
  no: 1,
  name: "sid",
  kind: "scalar",
  T: 9
  ...
  T: g.getEnumType(Do),
  repeated: !0
}]), rt = /* @__PURE__ */ g.makeEnum("livekit.ParticipantInfo.State", [{
  no: 0,
  name: "JOINING"
}, {
  no: 1,
  ...
  no: 3,
  name: "DISCONNECTED"
}]), Et = /* @__PURE__ */ g.makeEnum("livekit.ParticipantInfo.Kind", [{
  no: 0,
  name: "STANDARD"
}, {
  no: 1,
  ...
  no: 4,
  name: "AGENT"
}]), Do = /* @__PURE__ */ g.makeEnum("livekit.ParticipantInfo.KindDetail", [{
  no: 0,
  name: "CLOUD_AGENT"
}, {
  no: 1,
  name: "FORWARDED"
}]), oe = /* @__PURE__ */ g.makeEnum("livekit.Encryption.Type", [{
  no: 0,
  name: "NONE"
}, {
  no: 1,
  ...
  no: 2,
  name: "CUSTOM"
}]), xo = /* @__PURE__ */ g.makeMessageType("livekit.SimulcastCodecInfo", () => [{
  no: 1,
  name: "mime_type",
  kind: "scalar",
  T: 9
  ...
  T: ze,
  repeated: !0
}]), nt = /* @__PURE__ */ g.makeMessageType("livekit.TrackInfo", () => [{
  no: 1,
  name: "sid",
  kind: "scalar",
  T: 9
  ...
  T: 9
  /* ScalarType.STRING */
}]), ne = /* @__PURE__ */ g.makeMessageType("livekit.DataPacket", () => [{
  no: 1,
  name: "kind",
  kind: "enum",
  T: g.getEnumType(L)
  ...
  T: 9
  /* ScalarType.STRING */
}]), L = /* @__PURE__ */ g.makeEnum("livekit.DataPacket.Kind", [{
  no: 0,
  name: "RELIABLE"
}, {
  no: 1,
  name: "LOSSY"
}]), Mo = /* @__PURE__ */ g.makeMessageType("livekit.ActiveSpeakerUpdate", () => [{
  no: 1,
  name: "speakers",
  kind: "message",
  T: sr,
  repeated: !0
}]), sr = /* @__PURE__ */ g.makeMessageType("livekit.SpeakerInfo", () => [{
  no: 1,
  name: "sid",
  kind: "scalar",
  T: 9
  ...
  T: 8
  /* ScalarType.BOOL */
}]), rr = /* @__PURE__ */ g.makeMessageType("livekit.UserPacket", () => [{
  no: 1,
  name: "participant_sid",
  kind: "scalar",
  T: 9
  ...
  T: 12
  /* ScalarType.BYTES */
}]), ar = /* @__PURE__ */ g.makeMessageType("livekit.SipDTMF", () => [{
  no: 3,
  name: "code",
  kind: "scalar",
  T: 13
  ...
  T: 9
  /* ScalarType.STRING */
}]), Ao = /* @__PURE__ */ g.makeMessageType("livekit.Transcription", () => [{
  no: 2,
  ...
  T: No,
  repeated: !0
}]), No = /* @__PURE__ */ g.makeMessageType("livekit.TranscriptionSegment", () => [{
  no: 1,
  name: "id",
  kind: "scalar",
  T: 9
  ...
  T: 9
  /* ScalarType.STRING */
}]), Li = /* @__PURE__ */ g.makeMessageType("livekit.ChatMessage", () => [{
  no: 1,
  name: "id",
  kind: "scalar",
  T: 9
  ...
  T: 8
  /* ScalarType.BOOL */
}]), or = /* @__PURE__ */ g.makeMessageType("livekit.RpcRequest", () => [{
  no: 1,
  name: "id",
  kind: "scalar",
  T: 9
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), cr = /* @__PURE__ */ g.makeMessageType("livekit.RpcAck", () => [{
  no: 1,
  name: "request_id",
  kind: "scalar",
  T: 9
  /* ScalarType.STRING */
}]), dr = /* @__PURE__ */ g.makeMessageType("livekit.RpcResponse", () => [{
  no: 1,
  name: "request_id",
  kind: "scalar",
  T: 9
  ...
  T: lr,
  oneof: "value"
}]), lr = /* @__PURE__ */ g.makeMessageType("livekit.RpcError", () => [{
  no: 1,
  name: "code",
  kind: "scalar",
  T: 13
  ...
  T: 9
  /* ScalarType.STRING */
}]), ur = /* @__PURE__ */ g.makeMessageType("livekit.ParticipantTracks", () => [{
  no: 1,
  name: "participant_sid",
  kind: "scalar",
  T: 9
  ...
  T: 9,
  repeated: !0
}]), hr = /* @__PURE__ */ g.makeMessageType("livekit.ServerInfo", () => [{
  no: 1,
  name: "edition",
  kind: "enum",
  T: g.getEnumType(fr)
  ...
  T: 5
  /* ScalarType.INT32 */
}]), fr = /* @__PURE__ */ g.makeEnum("livekit.ServerInfo.Edition", [{
  no: 0,
  name: "Standard"
}, {
  no: 1,
  name: "Cloud"
}]), Lo = /* @__PURE__ */ g.makeMessageType("livekit.ClientInfo", () => [{
  no: 1,
  name: "sdk",
  kind: "enum",
  T: g.getEnumType(mr)
  ...
  T: 9
  /* ScalarType.STRING */
}]), mr = /* @__PURE__ */ g.makeEnum("livekit.ClientInfo.SDK", [{
  no: 0,
  name: "UNKNOWN"
}, {
  no: 1,
  ...
  no: 14,
  name: "ESP32"
}]), pr = /* @__PURE__ */ g.makeMessageType("livekit.ClientConfiguration", () => [{
  no: 1,
  name: "video",
  kind: "message",
  T: Xn
  ...
  kind: "enum",
  T: g.getEnumType(Pt)
}]), Xn = /* @__PURE__ */ g.makeMessageType("livekit.VideoConfiguration", () => [{
  no: 1,
  name: "hardware_encoder",
  kind: "enum",
  T: g.getEnumType(Pt)
}]), Uo = /* @__PURE__ */ g.makeMessageType("livekit.DisabledCodecs", () => [{
  no: 1,
  name: "codecs",
  kind: "message",
  T: Yt,
  ...
  T: Yt,
  repeated: !0
}]), gr = /* @__PURE__ */ g.makeMessageType("livekit.TimedVersion", () => [{
  no: 1,
  name: "unix_micro",
  kind: "scalar",
  T: 3
  ...
  T: 5
  /* ScalarType.INT32 */
}]), Ui = /* @__PURE__ */ g.makeEnum("livekit.DataStream.OperationType", [{
  no: 0,
  name: "CREATE"
}, {
  no: 1,
  ...
  no: 3,
  name: "REACTION"
}]), vr = /* @__PURE__ */ g.makeMessageType("livekit.DataStream.TextHeader", () => [{
  no: 1,
  name: "operation_type",
  kind: "enum",
  T: g.getEnumType(Ui)
...
}), br = /* @__PURE__ */ g.makeMessageType("livekit.DataStream.ByteHeader", () => [{
  no: 1,
  name: "name",
  kind: "scalar",
  T: 9
...
}), Fi = /* @__PURE__ */ g.makeMessageType("livekit.DataStream.Header", () => [{
  no: 1,
  name: "stream_id",
  kind: "scalar",
  T: 9
...
}), Bi = /* @__PURE__ */ g.makeMessageType("livekit.DataStream.Chunk", () => [{
  no: 1,
  name: "stream_id",
  kind: "scalar",
  T: 9
...
}), ji = /* @__PURE__ */ g.makeMessageType("livekit.DataStream.Trailer", () => [{
  no: 1,
  name: "stream_id",
  kind: "scalar",
  T: 9
...
}), me = /* @__PURE__ */ g.makeEnum("livekit.SignalTarget", [{
  no: 0,
  name: "PUBLISHER"
}, {
  no: 1,
  name: "SUBSCRIBER"
}]), Vi = /* @__PURE__ */ g.makeEnum("livekit.StreamState", [{
  no: 0,
  name: "ACTIVE"
}, {
  no: 1,
  name: "PAUSED"
}]), Fo = /* @__PURE__ */ g.makeEnum("livekit.CandidateProtocol", [{
  no: 0,
  name: "UDP"
}, {
  no: 1,
  ...
  no: 2,
  name: "TLS"
}]), Bo = /* @__PURE__ */ g.makeMessageType("livekit.SignalRequest", () => [{
  no: 1,
  name: "offer",
  kind: "message",
  T: Ye,
  ...
  T: Go,
  oneof: "message"
}]), $n = /* @__PURE__ */ g.makeMessageType("livekit.SignalResponse", () => [{
  no: 1,
  name: "join",
  kind: "message",
  T: jo,
  ...
  T: ec,
  oneof: "message"
}]), qi = /* @__PURE__ */ g.makeMessageType("livekit.SimulcastCodec", () => [{
  no: 1,
  name: "codec",
  kind: "scalar",
  T: 9
  ...
  T: 9
  /* ScalarType.STRING */
}]), Ki = /* @__PURE__ */ g.makeMessageType("livekit.AddTrackRequest", () => [{
  no: 1,
  name: "cid",
  kind: "scalar",
  T: 9
  ...
  T: g.getEnumType($),
  repeated: !0
}]), yn = /* @__PURE__ */ g.makeMessageType("livekit.TrickleRequest", () => [{
  no: 1,
  name: "candidateInit",
  kind: "scalar",
  T: 9
  ...
  T: 8
  /* ScalarType.BOOL */
}]), kn = /* @__PURE__ */ g.makeMessageType("livekit.MuteTrackRequest", () => [{
  no: 1,
  name: "sid",
  kind: "scalar",
  T: 9
  ...
  T: 8
  /* ScalarType.BOOL */
}]), jo = /* @__PURE__ */ g.makeMessageType("livekit.JoinResponse", () => [{
  no: 1,
  name: "room",
  kind: "message",
  T: ii
  ...
  T: 8
  /* ScalarType.BOOL */
}]), Vo = /* @__PURE__ */ g.makeMessageType("livekit.ReconnectResponse", () => [{
  no: 1,
  name: "ice_servers",
  kind: "message",
  T: Cr,
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), Tn = /* @__PURE__ */ g.makeMessageType("livekit.TrackPublishedResponse", () => [{
  no: 1,
  name: "cid",
  kind: "scalar",
  T: 9
  ...
  kind: "message",
  T: nt
}]), qo = /* @__PURE__ */ g.makeMessageType("livekit.TrackUnpublishedResponse", () => [{
  no: 1,
  name: "track_sid",
  kind: "scalar",
  T: 9
  /* ScalarType.STRING */
}]), Ye = /* @__PURE__ */ g.makeMessageType("livekit.SessionDescription", () => [{
  no: 1,
  name: "type",
  kind: "scalar",
  T: 9
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), Ko = /* @__PURE__ */ g.makeMessageType("livekit.ParticipantUpdate", () => [{
  no: 1,
  name: "participants",
  kind: "message",
  T: Qe,
  repeated: !0
}]), ni = /* @__PURE__ */ g.makeMessageType("livekit.UpdateSubscription", () => [{
  no: 1,
  name: "track_sids",
  kind: "scalar",
  T: 9,
  ...
  T: ur,
  repeated: !0
}]), yr = /* @__PURE__ */ g.makeMessageType("livekit.UpdateTrackSettings", () => [{
  no: 1,
  name: "track_sids",
  kind: "scalar",
  T: 9,
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), kr = /* @__PURE__ */ g.makeMessageType("livekit.UpdateLocalAudioTrack", () => [{
  no: 1,
  name: "track_sid",
  kind: "scalar",
  T: 9
  ...
  T: g.getEnumType($),
  repeated: !0
}]), Go = /* @__PURE__ */ g.makeMessageType("livekit.UpdateLocalVideoTrack", () => [{
  no: 1,
  name: "track_sid",
  kind: "scalar",
  T: 9
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), si = /* @__PURE__ */ g.makeMessageType("livekit.LeaveRequest", () => [{
  no: 1,
  name: "can_reconnect",
  kind: "scalar",
  T: 8
  ...
  kind: "message",
  T: ic
}]), at = /* @__PURE__ */ g.makeEnum("livekit.LeaveRequest.Action", [{
  no: 0,
  name: "DISCONNECT"
}, {
  no: 1,
  ...
  no: 2,
  name: "RECONNECT"
}]), Tr = /* @__PURE__ */ g.makeMessageType("livekit.UpdateVideoLayers", () => [{
  no: 1,
  name: "track_sid",
  kind: "scalar",
  T: 9
  ...
  T: ze,
  repeated: !0
}]), Sr = /* @__PURE__ */ g.makeMessageType("livekit.UpdateParticipantMetadata", () => [{
  no: 1,
  name: "metadata",
  kind: "scalar",
  T: 9
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), Cr = /* @__PURE__ */ g.makeMessageType("livekit.ICEServer", () => [{
  no: 1,
  name: "urls",
  kind: "scalar",
  T: 9,
  ...
  T: 9
  /* ScalarType.STRING */
}]), Wo = /* @__PURE__ */ g.makeMessageType("livekit.SpeakersChanged", () => [{
  no: 1,
  name: "speakers",
  kind: "message",
  T: sr,
  repeated: !0
}]), Ho = /* @__PURE__ */ g.makeMessageType("livekit.RoomUpdate", () => [{
  no: 1,
  name: "room",
  kind: "message",
  T: ii
}]), zo = /* @__PURE__ */ g.makeMessageType("livekit.ConnectionQualityInfo", () => [{
  no: 1,
  name: "participant_sid",
  kind: "scalar",
  T: 9
  ...
  T: 2
  /* ScalarType.FLOAT */
}]), Jo = /* @__PURE__ */ g.makeMessageType("livekit.ConnectionQualityUpdate", () => [{
  no: 1,
  name: "updates",
  kind: "message",
  T: zo,
  repeated: !0
}]), Qo = /* @__PURE__ */ g.makeMessageType("livekit.StreamStateInfo", () => [{
  no: 1,
  name: "participant_sid",
  kind: "scalar",
  T: 9
  ...
  kind: "enum",
  T: g.getEnumType(Vi)
}]), Yo = /* @__PURE__ */ g.makeMessageType("livekit.StreamStateUpdate", () => [{
  no: 1,
  name: "stream_states",
  kind: "message",
  T: Qo,
  repeated: !0
}]), Sn = /* @__PURE__ */ g.makeMessageType("livekit.SubscribedQuality", () => [{
  no: 1,
  name: "quality",
  kind: "enum",
  T: g.getEnumType(bn)
  ...
  T: 8
  /* ScalarType.BOOL */
}]), Xo = /* @__PURE__ */ g.makeMessageType("livekit.SubscribedCodec", () => [{
  no: 1,
  name: "codec",
  kind: "scalar",
  T: 9
  ...
  T: Sn,
  repeated: !0
}]), $o = /* @__PURE__ */ g.makeMessageType("livekit.SubscribedQualityUpdate", () => [{
  no: 1,
  name: "track_sid",
  kind: "scalar",
  T: 9
  ...
  T: Xo,
  repeated: !0
}]), Pr = /* @__PURE__ */ g.makeMessageType("livekit.TrackPermission", () => [{
  no: 1,
  name: "participant_sid",
  kind: "scalar",
  T: 9
  ...
  T: 9
  /* ScalarType.STRING */
}]), Er = /* @__PURE__ */ g.makeMessageType("livekit.SubscriptionPermission", () => [{
  no: 1,
  ...
  T: Pr,
  repeated: !0
}]), Zo = /* @__PURE__ */ g.makeMessageType("livekit.SubscriptionPermissionUpdate", () => [{
  no: 1,
  name: "participant_sid",
  kind: "scalar",
  T: 9
  ...
  T: 8
  /* ScalarType.BOOL */
}]), ec = /* @__PURE__ */ g.makeMessageType("livekit.RoomMovedResponse", () => [{
  no: 1,
  name: "room",
  kind: "message",
  T: ii
  ...
  T: Qe,
  repeated: !0
}]), Rr = /* @__PURE__ */ g.makeMessageType("livekit.SyncState", () => [{
  no: 1,
  name: "answer",
  kind: "message",
  T: Ye
  ...
  T: wr,
  repeated: !0
}]), wr = /* @__PURE__ */ g.makeMessageType("livekit.DataChannelReceiveState", () => [{
  no: 1,
  name: "publisher_sid",
  kind: "scalar",
  T: 9
  ...
  T: 13
  /* ScalarType.UINT32 */
}]), _r = /* @__PURE__ */ g.makeMessageType("livekit.DataChannelInfo", () => [{
  no: 1,
  name: "label",
  kind: "scalar",
  T: 9
  ...
  kind: "enum",
  T: g.getEnumType(me)
}]), ye = /* @__PURE__ */ g.makeMessageType("livekit.SimulateScenario", () => [{
  no: 1,
  name: "speaker_update",
  kind: "scalar",
  T: 5,
  ...
  T: 8,
  oneof: "scenario"
}]), Ir = /* @__PURE__ */ g.makeMessageType("livekit.Ping", () => [{
  no: 1,
  name: "timestamp",
  kind: "scalar",
  T: 3
  ...
  T: 3
  /* ScalarType.INT64 */
}]), tc = /* @__PURE__ */ g.makeMessageType("livekit.Pong", () => [{
  no: 1,
  ...
  T: 3
  /* ScalarType.INT64 */
}]), ic = /* @__PURE__ */ g.makeMessageType("livekit.RegionSettings", () => [{
  no: 1,
  name: "regions",
  kind: "message",
  T: nc,
  repeated: !0
}]), nc = /* @__PURE__ */ g.makeMessageType("livekit.RegionInfo", () => [{
  no: 1,
  name: "region",
  kind: "scalar",
  T: 9
  ...
  T: 3
  /* ScalarType.INT64 */
}]), sc = /* @__PURE__ */ g.makeMessageType("livekit.SubscriptionResponse", () => [{
  no: 1,
  name: "track_sid",
  kind: "scalar",
  T: 9
  ...
  kind: "enum",
  T: g.getEnumType(Io)
}]), rc = /* @__PURE__ */ g.makeMessageType("livekit.RequestResponse", () => [{
  no: 1,
  name: "request_id",
  kind: "scalar",
  T: 13
  ...
  T: 9
  /* ScalarType.STRING */
}]), Cn = /* @__PURE__ */ g.makeEnum("livekit.RequestResponse.Reason", [{
  no: 0,
  name: "OK"
}, {
  no: 1,
  ...
  no: 3,
  name: "LIMIT_EXCEEDED"
}]), ac = /* @__PURE__ */ g.makeMessageType("livekit.TrackSubscribed", () => [{
  no: 1,
  name: "track_sid",
  kind: "scalar",
  T: 9
...
var jt = { exports: {} }, cc = jt.exports, Zn;
function dc() {
    ...
    (function(e, t) {
      ...
      function o(p, P) {
        ...
        if (typeof S.bind == "function")
          return S.bind(p);
        try {
          return Function.prototype.bind.call(S, p);
        } catch {
          return function() {
            return Function.prototype.apply.apply(S, [p, arguments]);
          };
        }
      }
      function c() {
      ...
      function d(p) {
        return p === "debug" && (p = "log"), typeof console === t ? !1 : p === "trace" && i ? c : console[p] !== void 0 ? o(console, p) : console.log !== void 0 ? o(console, "log") : e;
      }
      function l() {
        for (var p = this.getLevel(), P = 0; P < s.length; P++) {
          var S = s[P];
          this[S] = P < p ? e : this.methodFactory(S, p, this.name);
        }
      ...
      function u(p) {
        return function() {
          typeof console !== t && (l.call(this), this[p].apply(this, arguments));
        };
      }
      function h(p, P, S) {
        return d(p) || u.apply(this, arguments);
      }
      function m(p, P) {
        var S = this, O, I, v, y = "loglevel";
        typeof p == "string" ? y += ":" + p : typeof p == "symbol" && (y = void 0);
        function C(N) {
          ...
          if (!(typeof window === t || !y)) {
            ...
            try {
              window.document.cookie = encodeURIComponent(y) + "=" + j + ";";
            } catch {
            }
          }
        }
        function x() {
          ...
          if (!(typeof window === t || !y)) {
            try {
              N = window.localStorage[y];
            } catch {
            }
            if (typeof N === t)
              try {
                var j = window.document.cookie, te = encodeURIComponent(y), Ae = j.indexOf(te + "=");
                Ae !== -1 && (N = /^([^;]+)/.exec(j.slice(Ae + te.length + 1))[1]);
              } catch {
              }
            return S.levels[N] === void 0 && (N = void 0), N;
          }
        }
        function M() {
          if (!(typeof window === t || !y)) {
        ...
        function D(N) {
          var j = N;
          if (typeof j == "string" && S.levels[j.toUpperCase()] !== void 0 && (j = S.levels[j.toUpperCase()]), typeof j == "number" && j >= 0 && j <= S.levels.SILENT)
            return j;
        ...
        S.name = p, S.levels = {
          ...
          ERROR: 4,
          SILENT: 5
        }, S.methodFactory = P || h, S.getLevel = function() {
          return v ?? I ?? O;
        }, S.setLevel = function(N, j) {
          return v = D(N), j !== !1 && C(v), l.call(S);
        }, S.setDefaultLevel = function(N) {
          I = D(N), x() || S.setLevel(N, !1);
        }, S.resetLevel = function() {
          v = null, M(), l.call(S);
        }, S.enableAll = function(N) {
          S.setLevel(S.levels.TRACE, N);
        }, S.disableAll = function(N) {
          S.setLevel(S.levels.SILENT, N);
        }, S.rebuild = function() {
          if (a !== S && (O = D(a.getLevel())), l.call(S), a === S)
            for (var N in r)
              r[N].rebuild();
        }, O = D(a ? a.getLevel() : "WARN");
        var A = x();
        A != null && (v = D(A)), l.call(S);
      }
      a = new m(), a.getLogger = function(P) {
        if (typeof P != "symbol" && typeof P != "string" || P === "")
          throw new TypeError("You must supply a name when creating a logger.");
        var S = r[P];
        return S || (S = r[P] = new m(P, a.methodFactory)), S;
      };
...
let U = xt.getLogger("livekit");
const Or = Object.values(ve).map((n) => xt.getLogger(n));
U.setDefaultLevel(Rt.info);
function Me(n) {
  const e = xt.getLogger(n);
  return e.setDefaultLevel(U.getLevel()), e;
}
function Il(n, e) {
  if (e)
    xt.getLogger(e).setLevel(n);
  else
    for (const t of Or)
      t.setLevel(n);
}
function Ol(n, e) {
  (e ? [e] : Or).forEach((i) => {
    const s = i.methodFactory;
    i.methodFactory = (r, a, o) => {
      const c = s(r, a, o), d = Rt[r], l = d >= a && d < Rt.silent;
      return (u, h) => {
        h ? c(u, h) : c(u), l && n(d, u, h);
      };
    }, i.setLevel(i.getLevel());
  });
}
const lc = xt.getLogger("lk-e2ee"), ft = 7e3, uc = [0, 300, 2 * 2 * 300, 3 * 3 * 300, 4 * 4 * 300, ft, ft, ft, ft, ft];
class hc {
  constructor(e) {
    this._retryDelays = e !== void 0 ? [...e] : uc;
  }
...
function xe(n) {
  ...
  return e ? e.call(n) : (n = typeof es == "function" ? es(n) : n[Symbol.iterator](), t = {}, i("next"), i("throw"), i("return"), t[Symbol.asyncIterator] = function() {
    return this;
  }, t);
  function i(r) {
    t[r] = n[r] && function(a) {
...
var At = { exports: {} }, ts;
function mc() {
  if (ts) return At.exports;
  ts = 1;
  var n = typeof Reflect == "object" ? Reflect : null, e = n && typeof n.apply == "function" ? n.apply : function(y, C, x) {
    return Function.prototype.apply.call(y, C, x);
  }, t;
  ...
  At.exports = r, At.exports.once = S, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._eventsCount = 0, r.prototype._maxListeners = void 0;
  var a = 10;
  function o(v) {
  ...
  r.prototype.getMaxListeners = function() {
    ...
    var M = y === "error", D = this._events;
    if (D !== void 0) M = M && D.error === void 0;
    else if (!M) return !1;
    if (M) {
      var A;
    ...
    if (typeof j == "function")
      ...
      for (var te = j.length, Ae = b(j, te), x = 0; x < te; ++x) e(Ae[x], this, C);
    return !0;
  };
  function d(v, y, C, x) {
    var M, D, A;
    if (o(C), D = v._events, D === void 0 ? (D = v._events = /* @__PURE__ */ Object.create(null), v._eventsCount = 0) : (D.newListener !== void 0 && (v.emit("newListener", y, C.listener ? C.listener : C), D = v._events), A = D[y]), A === void 0)
      A = D[y] = C, ++v._eventsCount;
    else if (typeof A == "function" ? A = D[y] = x ? [C, A] : [A, C] : x ? A.unshift(C) : A.push(C), M = c(v), M > 0 && A.length > M && !A.warned) {
      A.warned = !0;
      var N = new Error("Possible EventEmitter memory leak detected. " + A.length + " " + String(y) + " listeners added. Use emitter.setMaxListeners() to increase limit");
      N.name = "MaxListenersExceededWarning", N.emitter = v, N.type = y, N.count = A.length, i(N);
    }
    return v;
  }
  ...
  function u(v, y, C) {
    ...
    return M.listener = C, x.wrapFn = M, M;
  }
  r.prototype.once = function(y, C) {
    ...
    var x, M, D, A, N;
    if (o(C), M = this._events, M === void 0) return this;
    if (x = M[y], x === void 0) return this;
    if (x === C || x.listener === C)
      --this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : (delete M[y], M.removeListener && this.emit("removeListener", y, x.listener || C));
    else if (typeof x != "function") {
      for (D = -1, A = x.length - 1; A >= 0; A--)
        if (x[A] === C || x[A].listener === C) {
          N = x[A].listener, D = A;
          break;
        }
      if (D < 0) return this;
      D === 0 ? x.shift() : p(x, D), x.length === 1 && (M[y] = x[0]), M.removeListener !== void 0 && this.emit("removeListener", y, N || C);
    }
    return this;
    ...
    if (x.removeListener === void 0)
      return arguments.length === 0 ? (this._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0) : x[y] !== void 0 && (--this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : delete x[y]), this;
    if (arguments.length === 0) {
      var D = Object.keys(x), A;
      for (M = 0; M < D.length; ++M)
        A = D[M], A !== "removeListener" && this.removeAllListeners(A);
      return this.removeAllListeners("removeListener"), this._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0, this;
    }
    if (C = x[y], typeof C == "function")
      this.removeListener(y, C);
    else if (C !== void 0)
      for (M = C.length - 1; M >= 0; M--)
        this.removeListener(y, C[M]);
    return this;
  };
  function h(v, y, C) {
    var x = v._events;
    if (x === void 0) return [];
    var M = x[y];
    return M === void 0 ? [] : typeof M == "function" ? C ? [M.listener || M] : [M] : C ? P(M) : b(M, M.length);
  }
  r.prototype.listeners = function(y) {
    ...
    return typeof v.listenerCount == "function" ? v.listenerCount(y) : m.call(v, y);
  ...
  function b(v, y) {
    for (var C = new Array(y), x = 0; x < y; ++x) C[x] = v[x];
    return C;
  }
  function p(v, y) {
  ...
  function P(v) {
    for (var y = new Array(v.length), C = 0; C < y.length; ++C)
      y[C] = v[C].listener || v[C];
    return y;
  }
  function S(v, y) {
    return new Promise(function(C, x) {
      function M(A) {
        v.removeListener(y, D), x(A);
      }
      function D() {
        typeof v.removeListener == "function" && v.removeListener("error", M), C([].slice.call(arguments));
      }
      I(v, y, D, {
        once: !0
      }), y !== "error" && O(v, M, {
  ...
  function O(v, y, C) {
    typeof v.on == "function" && I(v, "error", y, C);
  }
  function I(v, y, C, x) {
    if (typeof v.on == "function")
      x.once ? v.once(y, C) : v.on(y, C);
    else if (typeof v.addEventListener == "function")
      v.addEventListener(y, function M(D) {
        x.once && v.removeEventListener(y, M), C(D);
      });
    else
...
function pc(n) {
  return typeof n != "boolean" ? new Error("Argument type: " + typeof n + ". Please use a boolean.") : (Dr = n, n ? "adapter.js logging disabled" : "adapter.js logging enabled");
}
function gc(n) {
  return typeof n != "boolean" ? new Error("Argument type: " + typeof n + ". Please use a boolean.") : (xr = !n, "adapter.js deprecation warnings " + (n ? "disabled" : "enabled"));
}
function Mr() {
...
function Pn(n, e) {
  xr && console.warn(n + " is deprecated, please use " + e + " instead.");
}
function vc(n) {
  const e = {
    browser: null,
  ...
  if (t.mozGetUserMedia)
    e.browser = "firefox", e.version = parseInt(yt(t.userAgent, /Firefox\/(\d+)\./, 1));
  else if (t.webkitGetUserMedia || n.isSecureContext === !1 && n.webkitRTCPeerConnection)
    e.browser = "chrome", e.version = parseInt(yt(t.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
  else if (n.RTCPeerConnection && t.userAgent.match(/AppleWebKit\/(\d+)\./))
    e.browser = "safari", e.version = parseInt(yt(t.userAgent, /AppleWebKit\/(\d+)\./, 1)), e.supportsUnifiedPlan = n.RTCRtpTransceiver && "currentDirection" in n.RTCRtpTransceiver.prototype, e._safariVersion = yt(t.userAgent, /Version\/(\d+(\.?\d+))/, 1);
  else
...
function Ar(n) {
  return is(n) ? Object.keys(n).reduce(function(e, t) {
    const i = is(n[t]), s = i ? Ar(n[t]) : n[t], r = i && !Object.keys(s).length;
      ...
      if (d && (d.exact === "user" || d.exact === "environment" || d.ideal === "user" || d.ideal === "environment") && !(t.mediaDevices.getSupportedConstraints && t.mediaDevices.getSupportedConstraints().facingMode && !l)) {
        ...
        if (d.exact === "environment" || d.ideal === "environment" ? u = ["back", "rear"] : (d.exact === "user" || d.ideal === "user") && (u = ["front"]), u)
          return t.mediaDevices.enumerateDevices().then((h) => {
            ...
            let m = h.find((b) => u.some((p) => b.label.toLowerCase().includes(p)));
            return !m && h.length && u.includes("back") && (m = h[h.length - 1]), m && (o.video.deviceId = d.exact ? {
              exact: m.deviceId
            } : {
              ideal: m.deviceId
            }), o.video = i(o.video), ss("chrome: " + JSON.stringify(o)), c(o);
          });
      }
      o.video = i(o.video);
    }
    return ss("chrome: " + JSON.stringify(o)), c(o);
  }, r = function(o) {
...
function Ur(n) {
  if (typeof n == "object" && n.RTCPeerConnection && !("ontrack" in n.RTCPeerConnection.prototype)) {
    ...
    Ze(n, "track", (e) => (e.transceiver || Object.defineProperty(e, "transceiver", {
      value: {
        receiver: e.receiver
      }
    }), e));
...
function Br(n) {
  ...
  if (!("getStats" in n.RTCRtpReceiver.prototype)) {
    ...
    }), Ze(n, "track", (i) => (i.receiver._pc = i.srcElement, i)), n.RTCRtpReceiver.prototype.getStats = function() {
      const s = this;
      return this._pc.getStats().then((r) => ns(r, s.track, !1));
    };
  }
...
function Vr(n, e) {
  ...
  n.RTCPeerConnection.prototype.removeStream = function(l) {
    ...
    if (h.length !== 1 || !h[0].getTracks().find((p) => p === l))
    ...
    if (b)
      ...
      const p = new n.MediaStream([l]);
      this._streams[u.id] = p, this._reverseStreams[p.id] = u, this.addStream(p);
    }
  ...
  function r(d, l) {
    ...
    return Object.keys(d._reverseStreams || []).forEach((h) => {
      const m = d._reverseStreams[h], b = d._streams[m.id];
      u = u.replace(new RegExp(b.id, "g"), m.id);
  ...
  function a(d, l) {
    ...
    return Object.keys(d._reverseStreams || []).forEach((h) => {
      const m = d._reverseStreams[h], b = d._streams[m.id];
      u = u.replace(new RegExp(m.id, "g"), b.id);
    }), new RTCSessionDescription({
      type: l.type,
      sdp: u
    });
  ...
  Object.defineProperty(n.RTCPeerConnection.prototype, "localDescription", {
    ...
    Object.keys(this._streams).forEach((m) => {
      this._streams[m].getTracks().find((p) => l.track === p) && (h = this._streams[m]);
...
var rs = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  fixNegotiationNeeded: qr,
  shimAddTrackRemoveTrack: Vr,
  shimAddTrackRemoveTrackWithNative: jr,
  shimGetSendersWithDtmf: Fr,
  shimGetUserMedia: Nr,
  shimMediaStream: Lr,
  shimOnTrack: Ur,
  shimPeerConnection: Wi,
  shimSenderReceiverGetStats: Br
});
function Kr(n, e) {
  const t = n && n.navigator, i = n && n.MediaStreamTrack;
  if (t.getUserMedia = function(s, r, a) {
    Pn("navigator.getUserMedia", "navigator.mediaDevices.getUserMedia"), t.mediaDevices.getUserMedia(s).then(r, a);
...
function Hr(n) {
  ...
  e && (n.RTCPeerConnection.prototype.getReceivers = function() {
    const i = e.apply(this, []);
    return i.forEach((s) => s._pc = this), i;
  }), Ze(n, "track", (t) => (t.receiver._pc = t.srcElement, t)), n.RTCRtpReceiver.prototype.getStats = function() {
...
function zr(n) {
  !n.RTCPeerConnection || "removeStream" in n.RTCPeerConnection.prototype || (n.RTCPeerConnection.prototype.removeStream = function(t) {
    Pn("removeStream", "removeTrack"), this.getSenders().forEach((i) => {
...
var as = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  shimAddTransceiver: Qr,
  shimCreateAnswer: $r,
  shimCreateOffer: Xr,
  shimGetDisplayMedia: bc,
  shimGetParameters: Yr,
  shimGetUserMedia: Kr,
  shimOnTrack: Gr,
  shimPeerConnection: Hi,
  shimRTCDataChannel: Jr,
  shimReceiverGetStats: Hr,
  shimRemoveStream: zr,
  shimSenderGetStats: Wr
});
function Zr(n) {
  if (!(typeof n != "object" || !n.RTCPeerConnection)) {
...
function ia(n) {
  ...
  if (e.mediaDevices && e.mediaDevices.getUserMedia) {
    ...
    e.mediaDevices.getUserMedia = (s) => i(na(s));
  }
  ...
  n.RTCPeerConnection = function(i, s) {
    if (i && i.iceServers) {
      ...
      for (let a = 0; a < i.iceServers.length; a++) {
        ...
        o.urls === void 0 && o.url ? (Pn("RTCIceServer.url", "RTCIceServer.urls"), o = JSON.parse(JSON.stringify(o)), o.urls = o.url, delete o.url, r.push(o)) : r.push(i.iceServers[a]);
      }
      i.iceServers = r;
    }
    return new e(i, s);
...
var os = /* @__PURE__ */ Object.freeze({
  ...
  shimGetUserMedia: ia,
  shimLocalStreamsAPI: Zr,
  shimRTCIceServerUrls: sa,
  shimRemoteStreamsAPI: ea,
  shimTrackEventTransceiver: ra
}), yi = { exports: {} }, cs;
function yc() {
  return cs || (cs = 1, function(n) {
    const e = {};
...
var ca = yc(), ot = /* @__PURE__ */ oc(ca), kc = /* @__PURE__ */ xa({
  __proto__: null,
  default: ot
}, [ca]);
function Vt(n) {
  ...
  n.RTCIceCandidate = function(i) {
    if (typeof i == "object" && i.candidate && i.candidate.indexOf("a=") === 0 && (i = JSON.parse(JSON.stringify(i)), i.candidate = i.candidate.substring(2)), i.candidate && i.candidate.length) {
      const s = new e(i), r = ot.parseCandidate(i.candidate);
      for (const a in r)
    ...
    return new e(i);
  }, n.RTCIceCandidate.prototype = e.prototype, Ze(n, "icecandidate", (t) => (t.candidate && Object.defineProperty(t, "candidate", {
    value: new n.RTCIceCandidate(t.candidate),
    writable: "false"
  }), t));
}
function zi(n) {
  !n.RTCIceCandidate || n.RTCIceCandidate && "relayProtocol" in n.RTCIceCandidate.prototype || Ze(n, "icecandidate", (e) => {
    if (e.candidate) {
...
function qt(n, e) {
  ...
  const t = function(o) {
    if (!o || !o.sdp)
      return !1;
    const c = ot.splitSections(o.sdp);
    return c.shift(), c.some((d) => {
      const l = ot.parseMLine(d);
    ...
    const l = ot.matchPrefix(o.sdp, "a=max-message-size:");
...
function Kt(n) {
  ...
  n.RTCPeerConnection.prototype.createDataChannel = function() {
    const s = t.apply(this, arguments);
    return e(s, this), s;
  }, Ze(n, "datachannel", (i) => (e(i.channel, i.target), i));
}
function Ji(n) {
...
function Sc() {
  ...
  switch (i.browser) {
    case "chrome":
      ...
      t("adapter.js shimming chrome."), s.browserShim = rs, Gt(n, i), Wt(n), Nr(n, i), Lr(n), Wi(n, i), Ur(n), Vr(n, i), Fr(n), Br(n), qr(n, i), Vt(n), zi(n), Ji(n), qt(n, i), Kt(n), Qi(n, i);
      break;
    case "firefox":
      if (!as || !Hi || !e.shimFirefox)
        return t("Firefox shim is not included in this adapter release."), s;
      t("adapter.js shimming firefox."), s.browserShim = as, Gt(n, i), Wt(n), Kr(n, i), Hi(n, i), Gr(n), zr(n), Wr(n), Hr(n), Jr(n), Qr(n), Yr(n), Xr(n), $r(n), Vt(n), Ji(n), qt(n, i), Kt(n);
      break;
    case "safari":
      if (!os || !e.shimSafari)
        return t("Safari shim is not included in this adapter release."), s;
      t("adapter.js shimming safari."), s.browserShim = os, Gt(n, i), Wt(n), sa(n), aa(n), ta(n), Zr(n), ea(n), ra(n), ia(n), oa(n), Vt(n), zi(n), qt(n, i), Kt(n), Qi(n, i);
      break;
    default:
...
const da = "AES-GCM", Cc = 10, mt = "lk_e2ee", Pc = "LKFrameEncryptionKey", Ec = {
  sharedKey: !1,
  ratchetSalt: Pc,
  ratchetWindowSize: 8,
  failureTolerance: Cc,
...
function xl(n) {
  return f(this, arguments, void 0, function(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {
      name: da
    }, i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "encrypt";
    return function* () {
      return crypto.subtle.importKey("raw", e, t, !1, i === "derive" ? ["deriveBits", "deriveKey"] : ["encrypt", "decrypt"]);
    }();
  });
}
function _c(n) {
...
function la(n, e) {
  ...
  switch (n) {
    ...
    default:
      throw new Error("algorithm ".concat(n, " is currently unsupported"));
  }
}
function Ml(n, e) {
  return f(this, void 0, void 0, function* () {
    const t = la(n.algorithm.name, e), i = yield crypto.subtle.deriveKey(t, n, {
      name: da,
      length: 128
    }, !1, ["encrypt", "decrypt"]);
    return {
...
function Nl(n, e) {
  return f(this, void 0, void 0, function* () {
    const t = la(n.algorithm.name, e);
    return crypto.subtle.deriveBits(t, n, 256);
  });
}
function Ll(n) {
  for (var e = 0; e < n.length - 3; e++)
    if (n[e] == 0 && n[e + 1] == 0 && n[e + 2] == 3) return !0;
  return !1;
}
function Ul(n) {
  const e = [];
  for (var t = n.length, i = 0; i < n.length; )
    t - i >= 3 && !n[i] && !n[i + 1] && n[i + 2] == 3 ? (e.push(n[i++]), e.push(n[i++]), i++) : e.push(n[i++]);
...
function Fl(n) {
  ...
  for (var t = 0, i = 0; i < n.length; ++i) {
    var s = n[i];
    s <= us && t >= Oc && (e.push(us), t = 0), e.push(s), s == 0 ? ++t : t = 0;
  }
  return new Uint8Array(e);
}
class Dc extends we.EventEmitter {
  constructor() {
    ...
    }, this.keyInfoMap = /* @__PURE__ */ new Map(), this.options = Object.assign(Object.assign({}, Ec), e), this.on(Ve.KeyRatcheted, this.onKeyRatcheted);
  }
  /**
  ...
  onSetEncryptionKey(e, t, i) {
    ...
    this.keyInfoMap.set("".concat(t ?? "shared", "-").concat(i ?? 0), s), this.emit(Ve.SetKey, s);
  }
  getKeys() {
  ...
  ratchetKey(e, t) {
    this.emit(Ve.RatchetRequest, e, t);
  }
}
class Bl extends Dc {
  constructor() {
  ...
  setKey(e) {
    return f(this, void 0, void 0, function* () {
      const t = typeof e == "string" ? yield _c(e) : yield Ic(e);
...
class fs extends be {
  constructor(e, t) {
    super(15, e), this.reason = t, this.reasonName = typeof t == "string" ? t : Cn[t];
  }
}
var pe;
(function(n) {
  n[n.AlreadyOpened = 0] = "AlreadyOpened", n[n.AbnormalEnd = 1] = "AbnormalEnd", n[n.DecodeFailed = 2] = "DecodeFailed", n[n.LengthExceeded = 3] = "LengthExceeded", n[n.Incomplete = 4] = "Incomplete", n[n.HandlerAlreadyRegistered = 7] = "HandlerAlreadyRegistered";
})(pe || (pe = {}));
class Fe extends be {
  constructor(e, t) {
...
class Vl extends be {
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : $i.InternalError, i = arguments.length > 2 ? arguments[2] : void 0;
...
const Ac = /version\/(\d+(\.?_?\d+)+)/i;
let ki;
function de(n) {
  let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
  if (typeof n > "u" && typeof navigator > "u")
    return;
...
const Nc = [
  {
    ...
    describe(n) {
      return {
        name: "Firefox",
        version: Ht(/(?:firefox|iceweasel|fxios)[\s/](\d+(\.?_?\d+)+)/i, n),
  ...
  },
  {
    ...
    describe(n) {
      return {
        name: "Chrome",
        version: Ht(/(?:chrome|chromium|crios|crmo)\/(\d+(\.?_?\d+)+)/i, n),
...
function Ti(n) {
  return n.includes("mac os") ? Ht(/\(.+?(\d+_\d+(:?_\d+)?)/, n, 1).replace(/_/g, ".") : void 0;
}
var Lc = "2.15.6";
const Uc = Lc, Fc = 16;
class ee {
...
ee.setInterval = // eslint-disable-next-line @typescript-eslint/no-implied-eval
function() {
  return setInterval(...arguments);
};
ee.clearTimeout = function() {
  return clearTimeout(...arguments);
};
ee.clearInterval = function() {
...
class k extends we.EventEmitter {
  ...
  constructor(e, t) {
    ...
    var s;
    super(), this.attachedElements = [], this.isMuted = !1, this._streamState = k.StreamState.Active, this.isInBackground = !1, this._currentBitrate = 0, this.log = U, this.appVisibilityChangedListener = () => {
      this.backgroundTimeout && clearTimeout(this.backgroundTimeout), document.visibilityState === "hidden" ? this.backgroundTimeout = setTimeout(() => this.handleAppVisibilityChanged(), Bc) : this.handleAppVisibilityChanged();
    }, this.log = Me((s = i.loggerName) !== null && s !== void 0 ? s : ve.Track), this.loggerContextCb = i.loggerContextCb, this.setMaxListeners(100), this.kind = t, this._mediaStreamTrack = e, this._mediaStreamID = e.id, this.source = k.Source.Unknown;
  }
  get logContext() {
    var e;
  ...
  attach(e) {
    let t = "audio";
    this.kind === k.Kind.Video && (t = "video"), this.attachedElements.length === 0 && this.kind === k.Kind.Video && this.addAppVisibilityListener(), e || (t === "audio" && (pt.forEach((r) => {
      r.parentElement === null && !e && (e = r);
    }), e && pt.splice(pt.indexOf(e), 1)), e || (e = document.createElement(t))), this.attachedElements.includes(e) || this.attachedElements.push(e), st(this.mediaStreamTrack, e);
    const i = e.srcObject.getTracks(), s = i.some((r) => r.kind === "audio");
    return e.play().then(() => {
      this.emit(s ? R.AudioPlaybackStarted : R.VideoPlaybackStarted);
    }).catch((r) => {
      r.name === "NotAllowedError" ? this.emit(s ? R.AudioPlaybackFailed : R.VideoPlaybackFailed, r) : r.name === "AbortError" ? U.debug("".concat(s ? "audio" : "video", " playback aborted, likely due to new play request")) : U.warn("could not playback ".concat(s ? "audio" : "video"), r), s && e && i.some((a) => a.kind === "video") && r.name === "NotAllowedError" && (e.muted = !0, e.play().catch(() => {
      }));
  ...
  updateLoggerOptions(e) {
    e.loggerName && (this.log = Me(e.loggerName)), e.loggerContextCb && (this.loggerContextCb = e.loggerContextCb);
  }
  recycleElement(e) {
    if (e instanceof HTMLAudioElement) {
      let t = !0;
      e.pause(), pt.forEach((i) => {
        i.parentElement || (t = !1);
      }), t && pt.push(e);
    }
  }
  handleAppVisibilityChanged() {
    return f(this, void 0, void 0, function* () {
      this.isInBackground = document.visibilityState === "hidden", !this.isInBackground && this.kind === k.Kind.Video && setTimeout(() => this.attachedElements.forEach((e) => e.play().catch(() => {
      })), 0);
    });
  }
...
function st(n, e) {
  ...
  n.kind === "audio" ? i = t.getAudioTracks() : i = t.getVideoTracks(), i.includes(n) || (i.forEach((s) => {
    t.removeTrack(s);
  }), t.addTrack(n)), (!$e() || !(e instanceof HTMLVideoElement)) && (e.autoplay = !0), e.muted = t.getAudioTracks().length === 0, e instanceof HTMLVideoElement && (e.playsInline = !0), e.srcObject !== t && (e.srcObject = t, ($e() || Xe()) && e instanceof HTMLVideoElement && setTimeout(() => {
...
const jc = ["vp8", "h264"], Vc = ["vp8", "h264", "vp9", "av1", "h265"];
function qc(n) {
  return !!jc.find((e) => e === n);
}
var ms;
(function(n) {
...
}, Kc = "|", ps = "https://aomediacodec.github.io/av1-rtp-spec/#dependency-descriptor-rtp-header-extension";
function Gc(n) {
  const e = n.split(Kc);
...
function ae(n) {
  return f(this, void 0, void 0, function* () {
    return new Promise((e) => ee.setTimeout(e, n));
  });
}
function $t() {
...
function Wc() {
  if (!("getCapabilities" in RTCRtpSender) || $e() || Xe())
    return !1;
...
function Hc() {
  if (!("getCapabilities" in RTCRtpSender) || Xe())
    return !1;
  if ($e()) {
    const t = de();
    if (t != null && t.version && Re(t.version, "16") < 0 || (t == null ? void 0 : t.os) === "iOS" && (t != null && t.osVersion) && Re(t.osVersion, "16") < 0)
      return !1;
  }
  const n = RTCRtpSender.getCapabilities("video");
  let e = !1;
...
function nn(n) {
  return !document || _t() ? !1 : (n || (n = document.createElement("audio")), "setSinkId" in n);
}
function zc() {
  return typeof RTCPeerConnection > "u" ? !1 : $t() || tn();
}
function Xe() {
  var n;
  return ((n = de()) === null || n === void 0 ? void 0 : n.name) === "Firefox";
}
function $e() {
  var n;
  return ((n = de()) === null || n === void 0 ? void 0 : n.name) === "Safari";
}
function _t() {
  const n = de();
...
function ua() {
  const n = de();
  return (n == null ? void 0 : n.name) === "Safari" && n.version.startsWith("17.") || (n == null ? void 0 : n.os) === "iOS" && !!(n != null && n.osVersion) && Re(n.osVersion, "17") >= 0;
}
function Jc(n) {
  return n || (n = de()), (n == null ? void 0 : n.name) === "Safari" && Re(n.version, "18.3") > 0 || (n == null ? void 0 : n.os) === "iOS" && !!(n != null && n.osVersion) && Re(n.osVersion, "18.3") > 0;
}
function ha() {
  var n, e;
  return se() ? (
...
function Qc() {
  const n = de(), e = "17.2";
  if (n)
    return n.name !== "Safari" && n.os !== "iOS" || n.os === "iOS" && n.osVersion && Re(n.osVersion, e) >= 0 ? !0 : n.name === "Safari" && Re(n.version, e) >= 0;
}
function se() {
...
let Si = null;
const vs = () => (Si || (Si = new ResizeObserver(Yc)), Si);
let Ci = null;
const bs = () => (Ci || (Ci = new IntersectionObserver(Xc, {
  root: null,
  rootMargin: "0px"
})), Ci);
function $c() {
  ...
  return Ee() && (e.os = (n = ma()) !== null && n !== void 0 ? n : ""), e;
}
let Pi;
function Gl() {
  return Pi || (Pi = rn()), Pi.clone();
}
function rn() {
  ...
  r == null || r.fillRect(0, 0, s.width, s.height), i && r && (r.beginPath(), r.arc(n / 2, e / 2, 50, 0, Math.PI * 2, !0), r.closePath(), r.fillStyle = "grey", r.fill());
...
function Ei() {
  if (!gt) {
    ...
    if (e.connect(t), t.connect(i), e.start(), [gt] = i.stream.getAudioTracks(), !gt)
...
function Wl(n, e) {
  ...
  const s = t.cloneTrack ? n.mediaStreamTrack.clone() : n.mediaStreamTrack, r = i.createMediaStreamSource(new MediaStream([s])), a = i.createAnalyser();
...
function ys(n) {
  switch (n.reason) {
    case B.LeaveRequest:
      return n.context;
    case B.Cancelled:
      return ge.CLIENT_INITIATED;
    case B.NotAllowed:
      return ge.USER_REJECTED;
    case B.ServerUnreachable:
      return ge.JOIN_FAILURE;
    default:
      return ge.UNKNOWN_REASON;
  }
}
function zt(n) {
...
function Pe(n) {
  return !!n && n.kind == k.Kind.Audio;
}
function Ge(n) {
  return !!n && n.kind == k.Kind.Video;
}
function Le(n) {
  return Je(n) && Ge(n);
}
...
function pa(n, e, t) {
  ...
  const {
    ...
    audioProcessor: c,
    videoProcessor: d
  } = ba(n ?? {}), l = e == null ? void 0 : e.processor, u = t == null ? void 0 : t.processor, h = o ?? {};
  return h.audio === !0 && (h.audio = {}), h.video === !0 && (h.video = {}), h.audio && (cn(h.audio, e), (i = (r = h.audio).deviceId) !== null && i !== void 0 || (r.deviceId = {
    ideal: "default"
  }), (c || l) && (h.audio.processor = c ?? l)), h.video && (cn(h.video, t), (s = (a = h.video).deviceId) !== null && s !== void 0 || (a.deviceId = {
    ideal: "default"
...
function ad(n) {
  return n === "audioinput" ? k.Source.Microphone : n === "videoinput" ? k.Source.Camera : k.Source.Unknown;
}
function dn(n) {
  return n === k.Source.Microphone ? "audioinput" : n === k.Source.Camera ? "videoinput" : void 0;
}
function va(n) {
  var e, t;
  let i = (e = n.video) !== null && e !== void 0 ? e : !0;
  return n.resolution && n.resolution.width > 0 && n.resolution.height > 0 && (i = typeof i == "boolean" ? {} : i, $e() ? i = Object.assign(Object.assign({}, i), {
    width: {
...
function ba(n) {
  ...
  return typeof e.audio == "object" && e.audio.processor && (t = e.audio.processor, e.audio = Object.assign(Object.assign({}, e.audio), {
    ...
    audioProcessor: t,
    videoProcessor: i,
    optionsWithoutProcessor: Mc(e)
  };
}
function ld(n) {
  switch (n) {
    case Y.CAMERA:
      return k.Source.Camera;
    case Y.MICROPHONE:
      return k.Source.Microphone;
    case Y.SCREEN_SHARE:
      return k.Source.ScreenShare;
    case Y.SCREEN_SHARE_AUDIO:
      return k.Source.ScreenShareAudio;
    default:
      return k.Source.Unknown;
  }
}
function ks(n, e) {
...
class hd extends we.EventEmitter {
  constructor(e) {
    super(), this.onWorkerMessage = (t) => {
      ...
      switch (r) {
        case "error":
          U.error(a.error.message), this.emit(je.EncryptionError, a.error);
          break;
        case "initAck":
        ...
        case "enable":
          if (a.enabled && this.keyProvider.getKeys().forEach((o) => {
            this.postKey(o);
          }), this.encryptionEnabled !== a.enabled && a.participantIdentity === ((i = this.room) === null || i === void 0 ? void 0 : i.localParticipant.identity))
            this.emit(je.ParticipantEncryptionStatusChanged, a.enabled, this.room.localParticipant), this.encryptionEnabled = a.enabled;
            ...
            this.emit(je.ParticipantEncryptionStatusChanged, a.enabled, o);
          }
          break;
        case "ratchetKey":
          this.keyProvider.emit(Ve.KeyRatcheted, a.ratchetResult, a.participantIdentity, a.keyIndex);
          break;
      }
    }, this.onWorkerError = (t) => {
      U.error("e2ee worker encountered an error:", {
        error: t.error
      }), this.emit(je.EncryptionError, t.error);
  ...
  setup(e) {
    if (!Rc())
      throw new ri("tried to setup end-to-end encryption on an unsupported browser");
  ...
  setupEventListeners(e, t) {
    e.on(E.TrackPublished, (i, s) => this.setParticipantCryptorEnabled(i.trackInfo.encryption !== oe.NONE, s.identity)), e.on(E.ConnectionStateChanged, (i) => {
      i === V.Connected && e.remoteParticipants.forEach((s) => {
        s.trackPublications.forEach((r) => {
          this.setParticipantCryptorEnabled(r.trackInfo.encryption !== oe.NONE, s.identity);
        });
      });
      ...
      const s = {
        ...
        data: {
          ...
          codec: St(i.trackInfo.codecs[0].mimeType),
          participantIdentity: this.room.localParticipant.identity
        }
      };
      this.worker.postMessage(s);
    }), t.on(Ve.SetKey, (i) => this.postKey(i)).on(Ve.RatchetRequest, (i, s) => this.postRatchetRequest(i, s));
  }
  ...
  setupE2EEReceiver(e, t, i) {
    if (e.receiver) {
      if (!(i != null && i.mimeType) || i.mimeType === "")
        throw new TypeError("MimeType missing from trackInfo, cannot set up E2EE cryptor");
      this.handleReceiver(e.receiver, e.mediaStreamID, t, e.kind === "video" ? St(i.mimeType) : void 0);
    }
  }
  setupE2EESender(e, t) {
    if (!Je(e) || !t) {
...
class Z {
  ...
  static getInstance() {
    return this.instance === void 0 && (this.instance = new Z()), this.instance;
  }
  get previousDevices() {
  ...
  getDevices(e) {
    return f(this, arguments, void 0, function(t) {
      ...
      return function* () {
        var r;
        if (((r = Z.userMediaPromiseMap) === null || r === void 0 ? void 0 : r.size) > 0) {
          U.debug("awaiting getUserMedia promise");
          try {
            t ? yield Z.userMediaPromiseMap.get(t) : yield Promise.all(Z.userMediaPromiseMap.values());
          } catch {
        ...
        !($e() && i.hasDeviceInUse(t)) && (a.filter((c) => c.kind === t).length === 0 || a.some((c) => {
  ...
  normalizeDeviceId(e, t, i) {
    return f(this, void 0, void 0, function* () {
      if (t !== wi)
        return t;
      const s = yield this.getDevices(e), r = s.find((o) => o.deviceId === wi);
      if (!r) {
        U.warn("could not reliably determine default device");
        return;
      }
      const a = s.find((o) => o.deviceId !== wi && o.groupId === (i ?? r.groupId));
      if (!a) {
        U.warn("could not reliably determine default device");
        return;
      }
  ...
  hasDeviceInUse(e) {
    return e ? Z.userMediaPromiseMap.has(e) : Z.userMediaPromiseMap.size > 0;
  }
}
Z.mediaDeviceKinds = ["audioinput", "audiooutput", "videoinput"];
Z.userMediaPromiseMap = /* @__PURE__ */ new Map();
var Ct;
(function(n) {
...
class fd {
  constructor() {
    this.pendingTasks = /* @__PURE__ */ new Map(), this.taskMutex = new re(), this.nextTaskIndex = 0;
  }
  run(e) {
    return f(this, void 0, void 0, function* () {
      const t = {
      ...
      try {
        return t.executedAt = Date.now(), t.status = Ct.RUNNING, yield e();
      } finally {
        t.status = Ct.COMPLETED, this.pendingTasks.delete(t.id), i();
      }
    });
  }
  flush() {
...
function md(n, e) {
  const t = new URL(ed(n));
  return e.forEach((i, s) => {
    t.searchParams.set(s, i);
  }), ya(t, "rtc");
}
function pd(n) {
  const e = new URL(an(n));
  return ya(e, "validate");
}
function gd(n) {
  return n.endsWith("/") ? n : "".concat(n, "/");
}
function ya(n, e) {
  return n.pathname = "".concat(gd(n.pathname)).concat(e), n.toString();
}
const vd = ["syncState", "trickle", "offer", "answer", "simulate", "leave"];
function bd(n) {
  const e = vd.indexOf(n.case) >= 0;
...
class wn {
  ...
  constructor() {
    ...
    var i;
    this.rtt = 0, this.state = G.DISCONNECTED, this.log = U, this._requestId = 0, this.resetCallbacks = () => {
    ...
    }, this.log = Me((i = t.loggerName) !== null && i !== void 0 ? i : ve.Signal), this.loggerContextCb = t.loggerContextCb, this.useJSON = e, this.requestQueue = new fd(), this.queuedRequests = [], this.closingLock = new re(), this.connectionLock = new re(), this.state = G.DISCONNECTED;
  }
  get logContext() {
    var e, t;
  ...
  join(e, t, i, s) {
    return f(this, void 0, void 0, function* () {
      return this.state = G.CONNECTING, this.options = i, yield this.connect(e, t, i, s);
    });
  }
  reconnect(e, t, i, s) {
    return f(this, void 0, void 0, function* () {
  ...
  connect(e, t, i, s) {
    ...
    const r = $c(), a = yd(t, r, i), o = md(e, a), c = pd(o);
    return new Promise((d, l) => f(this, void 0, void 0, function* () {
      const u = yield this.connectionLock.lock();
      try {
        const h = () => f(this, void 0, void 0, function* () {
          this.close(), clearTimeout(m), l(new K("room connection has been cancelled (signal)", B.Cancelled));
        }), m = setTimeout(() => {
          this.close(), l(new K("room connection has timed out (signal)", B.ServerUnreachable));
        }, i.websocketTimeout);
        s != null && s.aborted && h(), s == null || s.addEventListener("abort", h);
        const b = new URL(o);
        b.searchParams.has("access_token") && b.searchParams.set("access_token", "<redacted>"), this.log.debug("connecting to ".concat(b), Object.assign({
          ...
          clearTimeout(m);
        }, this.ws.onerror = (p) => f(this, void 0, void 0, function* () {
          if (this.state !== G.CONNECTED) {
            this.state = G.DISCONNECTED, clearTimeout(m);
            try {
              const P = yield fetch(c);
              if (P.status.toFixed(0).startsWith("4")) {
                const S = yield P.text();
                l(new K(S, B.NotAllowed, P.status));
              } else
                l(new K("Encountered unknown websocket error during connection: ".concat(p.toString()), B.InternalError, P.status));
            } catch (P) {
              l(new K(P instanceof Error ? P.message : "server was not reachable", B.ServerUnreachable));
            }
            return;
          }
          this.handleWSError(p);
        }), this.ws.onmessage = (p) => f(this, void 0, void 0, function* () {
          var P, S, O;
          let I;
          if (typeof p.data == "string") {
            ...
            I = $n.fromBinary(new Uint8Array(p.data));
          else {
          ...
          if (this.state !== G.CONNECTED) {
            let v = !1;
            if (((P = I.message) === null || P === void 0 ? void 0 : P.case) === "join" ? (this.state = G.CONNECTED, s == null || s.removeEventListener("abort", h), this.pingTimeoutDuration = I.message.value.pingTimeout, this.pingIntervalDuration = I.message.value.pingInterval, this.pingTimeoutDuration && this.pingTimeoutDuration > 0 && (this.log.debug("ping config", Object.assign(Object.assign({}, this.logContext), {
              timeout: this.pingTimeoutDuration,
              interval: this.pingIntervalDuration
            })), this.startPingInterval()), d(I.message.value)) : this.state === G.RECONNECTING && I.message.case !== "leave" ? (this.state = G.CONNECTED, s == null || s.removeEventListener("abort", h), this.startPingInterval(), ((S = I.message) === null || S === void 0 ? void 0 : S.case) === "reconnect" ? d(I.message.value) : (this.log.debug("declaring signal reconnected without reconnect response received", this.logContext), d(void 0), v = !0)) : this.isEstablishingConnection && I.message.case === "leave" ? l(new K("Received leave request while trying to (re)connect", B.LeaveRequest, void 0, I.message.value.reason)) : i.reconnect || l(new K("did not receive join response, got ".concat((O = I.message) === null || O === void 0 ? void 0 : O.case, " instead"), B.InternalError)), !v)
              return;
          }
          this.signalLatency && (yield ae(this.signalLatency)), this.handleSignalResponse(I);
        }), this.ws.onclose = (p) => {
          this.isEstablishingConnection && l(new K("Websocket got closed during a (re)connection attempt", B.InternalError)), this.log.warn("websocket closed", Object.assign(Object.assign({}, this.logContext), {
            reason: p.reason,
            code: p.code,
            wasClean: p.wasClean,
            state: this.state
      ...
      return function* () {
        ...
        try {
          if (e.clearPingInterval(), t && (e.state = G.DISCONNECTING), e.ws) {
            ...
            e.ws.readyState < e.ws.CLOSING && (e.ws.close(), yield Promise.race([s, ae(250)])), e.ws = void 0;
          }
        } finally {
          t && (e.state = G.DISCONNECTED), i();
        }
      }();
    });
  }
  ...
  sendPing() {
    return Promise.all([this.sendRequest({
      case: "ping",
      value: W.parse(Date.now())
    }), this.sendRequest({
      case: "pingReq",
      value: new Ir({
        timestamp: W.parse(Date.now()),
        rtt: W.parse(this.rtt)
      })
    })]);
  }
  ...
  sendLeave() {
    return this.sendRequest({
      case: "leave",
      value: new si({
        reason: ge.CLIENT_INITIATED,
        // server doesn't process this field, keeping it here to indicate the intent of a full disconnect
        action: at.DISCONNECT
      })
    });
  }
  sendRequest(e) {
    return f(this, arguments, void 0, function(t) {
      ...
      return function* () {
        if (!s && !bd(t) && i.state === G.RECONNECTING) {
        ...
        if (!i.ws || i.ws.readyState !== i.ws.OPEN) {
  ...
  handleSignalResponse(e) {
    ...
    if (s.case === "answer") {
      const a = Ts(s.value);
      this.onAnswer && this.onAnswer(a, s.value.id);
    } else if (s.case === "offer") {
      const a = Ts(s.value);
      this.onOffer && this.onOffer(a, s.value.id);
  ...
  resetPingTimeout() {
    ...
    this.pingTimeout = ee.setTimeout(() => {
   ...
   */
  clearPingTimeout() {
    this.pingTimeout && ee.clearTimeout(this.pingTimeout);
  }
  startPingInterval() {
    ...
    this.log.debug("start ping interval", this.logContext), this.pingInterval = ee.setInterval(() => {
      this.sendPing();
    }, this.pingIntervalDuration * 1e3);
  }
  clearPingInterval() {
    this.log.debug("clearing ping interval", this.logContext), this.clearPingTimeout(), this.pingInterval && ee.clearInterval(this.pingInterval);
  }
}
function Ts(n) {
  const e = {
...
var le = {}, _i = {}, Ii = { exports: {} }, Cs;
function _n() {
  if (Cs) return Ii.exports;
  Cs = 1;
  var n = Ii.exports = {
    v: [{
      name: "version",
...
function Td() {
  return Ps || (Ps = 1, function(n) {
    ...
    }, s = _n(), r = RegExp.prototype.test.bind(/^([a-z])=(.*)/);
    n.parse = function(o) {
      var c = {}, d = [], l = c;
    ...
    return c.forEach(function(u) {
      ...
      l.push(i("m", n.m[0], u)), d.forEach(function(h) {
        n[h].forEach(function(m) {
          m.name in u && u[m.name] != null ? l.push(i(h, m, u)) : m.push in u && u[m.push] != null && u[m.push].forEach(function(b) {
            l.push(i(h, m, b));
          });
        });
      });
...
function Cd() {
  ...
  Rs = 1;
  var n = Td(), e = Sd(), t = _n();
  return le.grammar = t, le.write = e, le.parse = n.parse, le.parseParams = n.parseParams, le.parseFmtpConfig = n.parseFmtpConfig, le.parsePayloads = n.parsePayloads, le.parseRemoteCandidates = n.parseRemoteCandidates, le.parseImageAttributes = n.parseImageAttributes, le.parseSimulcastStreamList = n.parseSimulcastStreamList, le;
}
var Ue = Cd();
function In(n, e, t) {
  var i, s, r;
...
const Pd = 0.7, Ed = 20, dt = {
  NegotiationStarted: "negotiationStarted",
  NegotiationComplete: "negotiationComplete",
  RTPVideoPayloadTypes: "rtpVideoPayloadTypes"
};
class ws extends we.EventEmitter {
  get pc() {
  ...
  constructor(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    var i;
    super(), this.log = U, this.ddExtID = 0, this.latestOfferId = 0, this.pendingCandidates = [], this.restartingIce = !1, this.renegotiate = !1, this.trackBitrates = [], this.remoteStereoMids = [], this.remoteNackMids = [], this.negotiate = In((s) => f(this, void 0, void 0, function* () {
      this.emit(dt.NegotiationStarted);
      try {
    ...
    }, this.log = Me((i = t.loggerName) !== null && i !== void 0 ? i : ve.PCTransport), this.loggerOptions = t, this.config = e, this._pc = this.createPC(), this.offerLock = new re();
  }
  createPC() {
  ...
  setRemoteDescription(e, t) {
    return f(this, void 0, void 0, function* () {
      ...
      if (e.type === "offer") {
        ...
        const r = Ue.parse((i = e.sdp) !== null && i !== void 0 ? i : "");
        r.media.forEach((a) => {
          a.type === "audio" && this.trackBitrates.some((o) => {
            if (!o.transceiver || a.mid != o.transceiver.mid)
              return !1;
            let c = 0;
            if (a.rtp.some((l) => l.codec.toUpperCase() === o.codec.toUpperCase() ? (c = l.payload, !0) : !1), c === 0)
              return !0;
            let d = !1;
            for (const l of a.fmtp)
              if (l.payload === c) {
                l.config = l.config.split(";").filter((u) => !u.includes("maxaveragebitrate")).join(";"), o.maxbr > 0 && (l.config += ";maxaveragebitrate=".concat(o.maxbr * 1e3)), d = !0;
                break;
              }
            return d || o.maxbr > 0 && a.fmtp.push({
              payload: c,
      ...
      }), this.pendingCandidates = [], this.restartingIce = !1, this.renegotiate ? (this.renegotiate = !1, yield this.createAndSendOffer()) : e.type === "answer" && (this.emit(dt.NegotiationComplete), e.sdp && Ue.parse(e.sdp).media.forEach((a) => {
        a.type === "video" && this.emit(dt.RTPVideoPayloadTypes, a.rtp);
      })), !0;
    });
  }
  createAndSendOffer(e) {
    return f(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const a = Ue.parse((t = r.sdp) !== null && t !== void 0 ? t : "");
        if (a.media.forEach((o) => {
          Is(o), o.type === "audio" ? _s(o, [], []) : o.type === "video" && this.trackBitrates.some((c) => {
            if (!o.msid || !c.cid || !o.msid.includes(c.cid))
              return !1;
            let d = 0;
            if (o.rtp.some((u) => u.codec.toUpperCase() === c.codec.toUpperCase() ? (d = u.payload, !0) : !1), d === 0 || (Se(c.codec) && !$e() && this.ensureVideoDDExtensionForSVC(o, a), c.codec !== "av1"))
              return !0;
            const l = Math.round(c.maxbr * Pd);
        ...
        yield this.setMungedSDP(r, Ue.write(a)), this.onOffer(r, this.latestOfferId);
      } finally {
        i();
      }
    });
  ...
  createAndSetAnswer() {
    return f(this, void 0, void 0, function* () {
      var e;
      const t = yield this.pc.createAnswer(), i = Ue.parse((e = t.sdp) !== null && e !== void 0 ? e : "");
      return i.media.forEach((s) => {
        Is(s), s.type === "audio" && _s(s, this.remoteStereoMids, this.remoteNackMids);
      }), yield this.setMungedSDP(t, Ue.write(i)), t;
    });
  }
  ...
  addTrack(e) {
    if (!this._pc)
      throw new X("PC closed, cannot add track");
  ...
  setConfiguration(e) {
    var t;
    if (!this._pc)
      throw new X("PC closed, cannot configure");
  ...
  ensureVideoDDExtensionForSVC(e, t) {
    var i, s;
    if (!((i = e.ext) === null || i === void 0 ? void 0 : i.some((a) => a.uri === ps))) {
      if (this.ddExtID === 0) {
        let a = 0;
        t.media.forEach((o) => {
          var c;
...
function Rd(n) {
  var e;
  const t = [], i = [], s = Ue.parse((e = n.sdp) !== null && e !== void 0 ? e : "");
  let r = 0;
...
const ln = "vp8", wd = {
  ...
  forceStereo: !1,
  simulcast: !0,
  screenShareEncoding: ai.h1080fps15.encoding,
...
class Id {
  ...
  constructor(e, t, i) {
    var s;
    this.peerConnectionTimeout = On.peerConnectionTimeout, this.log = U, this.updateState = () => {
      var r;
    ...
    }, this.log = Me((s = i.loggerName) !== null && s !== void 0 ? s : ve.PCManager), this.loggerOptions = i, this.isPublisherConnectionRequired = !t, this.isSubscriberConnectionRequired = t, this.publisher = new ws(e, i), this.subscriber = new ws(e, i), this.publisher.onConnectionStateChange = this.updateState, this.subscriber.onConnectionStateChange = this.updateState, this.publisher.onIceConnectionStateChange = this.updateState, this.subscriber.onIceConnectionStateChange = this.updateState, this.publisher.onSignalingStatechange = this.updateState, this.subscriber.onSignalingStatechange = this.updateState, this.publisher.onIceCandidate = (r) => {
      var a;
      (a = this.onIceCandidate) === null || a === void 0 || a.call(this, r, me.PUBLISHER);
    }, this.subscriber.onIceCandidate = (r) => {
      var a;
      (a = this.onIceCandidate) === null || a === void 0 || a.call(this, r, me.SUBSCRIBER);
    ...
    }, this.state = H.NEW, this.connectionLock = new re(), this.remoteOfferLock = new re();
  }
  get logContext() {
    var e, t;
    return Object.assign({}, (t = (e = this.loggerOptions).loggerContextCb) === null || t === void 0 ? void 0 : t.call(e));
  ...
  addIceCandidate(e, t) {
    return f(this, void 0, void 0, function* () {
      t === me.PUBLISHER ? yield this.publisher.addIceCandidate(e) : yield this.subscriber.addIceCandidate(e);
    });
  }
  ...
  negotiate(e) {
    return f(this, void 0, void 0, function* () {
      return new Promise((t, i) => f(this, void 0, void 0, function* () {
        ...
        e.signal.addEventListener("abort", r), this.publisher.once(dt.NegotiationStarted, () => {
  ...
  getConnectedAddress(e) {
    return e === me.PUBLISHER ? this.publisher.getConnectedAddress() : e === me.SUBSCRIBER ? this.publisher.getConnectedAddress() : this.requiredTransports[0].getConnectedAddress();
  }
      ...
      return function* () {
        if (i.getConnectionState() !== "connected")
          return new Promise((c, d) => f(r, void 0, void 0, function* () {
            const l = () => {
              this.log.warn("abort transport connection", this.logContext), ee.clearTimeout(u), d(new K("room connection has been cancelled", B.Cancelled));
            };
            s != null && s.signal.aborted && l(), s == null || s.signal.addEventListener("abort", l);
            const u = ee.setTimeout(() => {
              s == null || s.signal.removeEventListener("abort", l), d(new K("could not establish pc connection", B.InternalError));
            }, a);
            for (; this.state !== H.CONNECTED; )
              if (yield ae(50), s != null && s.signal.aborted) {
                d(new K("room connection has been cancelled", B.Cancelled));
                return;
              }
            ee.clearTimeout(u), s == null || s.signal.removeEventListener("abort", l), c();
          }));
      }();
    });
  }
...
class J extends Error {
   ...
   */
  constructor(e, t, i) {
    super(t), this.code = e, this.message = Os(t, J.MAX_MESSAGE_BYTES), this.data = i ? Os(i, J.MAX_DATA_BYTES) : void 0;
  }
  /**
   * @internal
   */
  static fromProto(e) {
    return new J(e.code, e.message, e.data);
  }
  /**
   * @internal
   */
   ...
   */
  static builtIn(e, t) {
    return new J(J.ErrorCode[e], J.ErrorMessage[e], t);
  }
}
J.MAX_MESSAGE_BYTES = 256;
J.MAX_DATA_BYTES = 15360;
J.ErrorCode = {
...
const Mn = typeof MediaRecorder < "u";
class Od {
  constructor() {
    throw new Error("MediaRecorder is not available in this environment");
  }
}
const Dd = Mn ? MediaRecorder : Od;
class xd extends Dd {
  constructor(e, t) {
    if (!Mn)
      throw new Error("MediaRecorder is not available in this environment");
    ...
    let i, s;
    const r = () => s === void 0, a = () => {
      this.removeEventListener("dataavailable", i), this.removeEventListener("stop", a), this.removeEventListener("error", o), s == null || s.close(), s = void 0;
    }, o = (c) => {
      s == null || s.error(c), this.removeEventListener("dataavailable", i), this.removeEventListener("stop", a), this.removeEventListener("error", o), s = void 0;
    };
...
class Ca extends k {
  ...
  constructor(e, t, i) {
    ...
    super(e, t, r), this.manuallyStopped = !1, this._isUpstreamPaused = !1, this.handleTrackMuteEvent = () => this.debouncedTrackMuteHandler().catch(() => this.log.debug("track mute bounce got cancelled by an unmute event", this.logContext)), this.debouncedTrackMuteHandler = In(() => f(this, void 0, void 0, function* () {
    ...
    }, this.reacquireTrack = !1, this.providedByUser = s, this.muteLock = new re(), this.pauseUpstreamLock = new re(), this.trackChangeLock = new re(), this.trackChangeLock.lock().then((a) => f(this, void 0, void 0, function* () {
      try {
  ...
  setMediaStreamTrack(e, t) {
    return f(this, void 0, void 0, function* () {
      ...
      if (this.processor && e) {
        ...
        this.processorElement && (st(e, this.processorElement), this.processorElement.muted = !0), yield this.processor.restart({
          track: e,
          kind: this.kind,
  ...
  waitForDimensions() {
    return f(this, arguments, void 0, function() {
      var e = this;
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Ad;
      return function* () {
        var i;
        if (e.kind === k.Kind.Audio)
          throw new Error("cannot get dimensions for audio tracks");
        ((i = de()) === null || i === void 0 ? void 0 : i.os) === "iOS" && (yield ae(10));
        const s = Date.now();
        for (; Date.now() - s < t; ) {
        ...
        throw new Te("unable to get track dimensions after timeout");
      }();
    });
  }
  setDeviceId(e) {
    return f(this, void 0, void 0, function* () {
      return this._constraints.deviceId === e && this._mediaStreamTrack.getSettings().deviceId === qe(e) || (this._constraints.deviceId = e, this.isMuted) ? !0 : (yield this.restartTrack(), qe(e) === this._mediaStreamTrack.getSettings().deviceId);
    });
  }
  /**
  ...
  getDeviceId() {
    return f(this, arguments, void 0, function() {
      ...
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0;
      return function* () {
        if (e.source === k.Source.ScreenShare)
          return;
        const {
          deviceId: i,
          groupId: s
        } = e._mediaStreamTrack.getSettings(), r = e.kind === k.Kind.Audio ? "audioinput" : "videoinput";
        return t ? Z.getInstance().normalizeDeviceId(r, i, s) : i;
      }();
    });
  }
  mute() {
  ...
  replaceTrack(e, t) {
    return f(this, void 0, void 0, function* () {
      ...
      try {
        if (!this.sender)
          throw new Te("unable to replace an unpublished track");
        let s, r;
  ...
  restart(e) {
    return f(this, void 0, void 0, function* () {
      ...
      try {
        ...
        this.kind === k.Kind.Video ? a.video = i || s ? {
          deviceId: i,
          facingMode: s
  ...
  pauseUpstream() {
    return f(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const i = de();
        if ((i == null ? void 0 : i.name) === "Safari" && Re(i.version, "12.0") < 0)
          throw new ri("pauseUpstream is not supported on Safari < 12.");
      ...
      return function* () {
        ...
        try {
          ...
          if (yield t.init(c), i.log.debug("processor initialized", i.logContext), i.processor && (yield i.internalStopProcessor()), i.kind === "unknown")
            throw TypeError("cannot set processor on track of unknown kind");
          if (st(i._mediaStreamTrack, o), o.muted = !0, o.play().catch((d) => {
            ...
            for (const d of i.attachedElements)
              d !== i.processorElement && s && (ct(i._mediaStreamTrack, d), st(i.processor.processedTrack, d));
  ...
  startPreConnectBuffer() {
    ...
    if (this.localTrackRecorder) {
      ...
      MediaRecorder.isTypeSupported(t) || (t = "video/mp4"), this.localTrackRecorder = new xd(this, {
        mimeType: t
      });
    }
...
class It extends Ca {
  ...
  constructor(e, t) {
    ...
    super(e, k.Kind.Audio, t, i, r), this.stopOnMute = !1, this.isKrispNoiseFilterEnabled = !1, this.monitorSender = () => f(this, void 0, void 0, function* () {
      if (!this.sender) {
      ...
      a && this.prevStats && (this._currentBitrate = oi(a, this.prevStats)), this.prevStats = a;
    }), this.handleKrispNoiseFilterEnable = () => {
      this.isKrispNoiseFilterEnabled = !0, this.log.debug("Krisp noise filter enabled", this.logContext), this.emit(R.AudioTrackFeatureUpdate, this, $.TF_ENHANCED_NOISE_CANCELLATION, !0);
    }, this.handleKrispNoiseFilterDisable = () => {
      this.isKrispNoiseFilterEnabled = !1, this.log.debug("Krisp noise filter disabled", this.logContext), this.emit(R.AudioTrackFeatureUpdate, this, $.TF_ENHANCED_NOISE_CANCELLATION, !1);
  ...
  mute() {
    ...
    return f(this, void 0, void 0, function* () {
      ...
      try {
        return this.isMuted ? (this.log.debug("Track already muted", this.logContext), this) : (this.source === k.Source.Microphone && this.stopOnMute && !this.isUserProvided && (this.log.debug("stopping mic track", this.logContext), this._mediaStreamTrack.stop()), yield e.mute.call(this), this);
      } finally {
        t();
      }
    });
  ...
  unmute() {
    ...
    return f(this, void 0, void 0, function* () {
      ...
      try {
        ...
        return this.source === k.Source.Microphone && (this.stopOnMute || this._mediaStreamTrack.readyState === "ended" || i) && !this.isUserProvided && (this.log.debug("reacquiring mic track", this.logContext), yield this.restartTrack()), yield e.unmute.call(this), this;
      } finally {
        t();
      }
    });
  ...
  checkForSilence() {
    return f(this, void 0, void 0, function* () {
      const e = yield ga(this);
      return e && (this.isMuted || this.log.warn("silence detected on local audio track", this.logContext), this.emit(R.AudioSilenceDetected)), e;
    });
  }
}
function Ld(n, e, t) {
  switch (n.kind) {
    case "audio":
      return new It(n, e, !1, void 0, t);
    case "video":
      return new Ot(n, e, !1, t);
    default:
      throw new Te("unsupported track type: ".concat(n.kind));
  }
}
const Ud = Object.values(wt), Fd = Object.values(en), Bd = Object.values(ai), jd = [wt.h180, wt.h360], Vd = [en.h180, en.h360], qd = (n) => [{
  scaleResolutionDownBy: 2,
  fps: n.encoding.maxFramerate
}].map((t) => {
  var i, s;
  return new q(Math.floor(n.width / t.scaleResolutionDownBy), Math.floor(n.height / t.scaleResolutionDownBy), Math.max(15e4, Math.floor(n.encoding.maxBitrate / (Math.pow(t.scaleResolutionDownBy, 2) * (((i = n.encoding.maxFramerate) !== null && i !== void 0 ? i : 30) / ((s = t.fps) !== null && s !== void 0 ? s : 30))))), t.fps, n.encoding.priority);
}), un = ["q", "h", "f"];
function hn(n, e, t, i) {
  var s, r;
  let a = i == null ? void 0 : i.videoEncoding;
  n && (a = i == null ? void 0 : i.screenShareEncoding);
  const o = i == null ? void 0 : i.simulcast, c = i == null ? void 0 : i.scalabilityMode, d = i == null ? void 0 : i.videoCodec;
  if (!a && !o && !c || !e || !t)
    return [{}];
  a || (a = Gd(n, e, t, d), U.debug("using video encoding", a));
  const l = a.maxFramerate, u = new q(e, t, a.maxBitrate, a.maxFramerate, a.priority);
  if (c && Se(d)) {
    const b = new Pa(c), p = [];
    if (b.spatial > 3)
      throw new Error("unsupported scalabilityMode: ".concat(c));
    const P = de();
    if (_t() || // Even tho RN runs M114, it does not produce SVC layers when a single encoding
    // is provided. So we'll use the legacy SVC specification for now.
    // TODO: when we upstream libwebrtc, this will need additional verification
    Ee() || (P == null ? void 0 : P.name) === "Chrome" && Re(P == null ? void 0 : P.version, "113") < 0) {
      const S = b.suffix == "h" ? 2 : 3, O = Jc(P);
      for (let I = 0; I < b.spatial; I += 1)
        p.push({
          rid: un[2 - I],
          maxBitrate: a.maxBitrate / Math.pow(S, I),
          maxFramerate: u.encoding.maxFramerate,
          scaleResolutionDownBy: O ? Math.pow(2, I) : void 0
        });
      p[0].scalabilityMode = c;
    } else
      p.push({
    ...
    return u.encoding.priority && (p[0].priority = u.encoding.priority, p[0].networkPriority = u.encoding.priority), U.debug("using svc encoding", {
      encodings: p
    }), p;
  }
  if (!o)
    return [a];
  let h = [];
  n ? h = (s = xs(i == null ? void 0 : i.screenShareSimulcastLayers)) !== null && s !== void 0 ? s : Ds(n, u) : h = (r = xs(i == null ? void 0 : i.videoSimulcastLayers)) !== null && r !== void 0 ? r : Ds(n, u);
  let m;
  if (h.length > 0) {
    const b = h[0];
    h.length > 1 && ([, m] = h);
    const p = Math.max(e, t);
    if (p >= 960 && m)
      return Di(e, t, [b, m, u], l);
    if (p >= 480)
      return Di(e, t, [b, u], l);
  }
  return Di(e, t, [u]);
...
function Kd(n, e, t) {
  ...
  return n.source === k.Source.ScreenShare && t.simulcast && (t.simulcast = !1), hn(n.source === k.Source.ScreenShare, c, d, t);
}
function Gd(n, e, t, i) {
  const s = Wd(n, e, t);
  let {
...
function Wd(n, e, t) {
  if (n)
    return Bd;
  const i = e > t ? e / t : t / e;
  return Math.abs(i - 16 / 9) < Math.abs(i - 4 / 3) ? Ud : Fd;
}
function Ds(n, e) {
  if (n)
    return qd(e);
  ...
  return Math.abs(s - 16 / 9) < Math.abs(s - 4 / 3) ? jd : Vd;
}
function Di(n, e, t, i) {
  const s = [];
  if (t.forEach((r, a) => {
...
function Hd(n) {
  return n.source === k.Source.ScreenShare || n.constraints.height && qe(n.constraints.height) >= 1080 ? "maintain-resolution" : "balanced";
}
const zd = 5e3;
class Ot extends Ca {
  get sender() {
  ...
  constructor(e, t) {
    ...
    super(e, k.Kind.Video, t, i, s), this.simulcastCodecs = /* @__PURE__ */ new Map(), this.degradationPreference = "balanced", this.isCpuConstrained = !1, this.optimizeForPerformance = !1, this.monitorSender = () => f(this, void 0, void 0, function* () {
      if (!this.sender) {
        this._currentBitrate = 0;
        return;
      }
  ...
  mute() {
    ...
    return f(this, void 0, void 0, function* () {
      const t = yield this.muteLock.lock();
      try {
        return this.isMuted ? (this.log.debug("Track already muted", this.logContext), this) : (this.source === k.Source.Camera && !this.isUserProvided && (this.log.debug("stopping camera track", this.logContext), this._mediaStreamTrack.stop()), yield e.mute.call(this), this);
      } finally {
        t();
      }
    });
  ...
  unmute() {
    ...
    return f(this, void 0, void 0, function* () {
      const t = yield this.muteLock.lock();
      try {
        return this.isMuted ? (this.source === k.Source.Camera && !this.isUserProvided && (this.log.debug("reacquiring camera track", this.logContext), yield this.restartTrack()), yield e.unmute.call(this), this) : (this.log.debug("Track already unmuted", this.logContext), this);
      } finally {
        t();
      }
    });
  ...
  setPublishingQuality(e) {
    const t = [];
    for (let i = ce.LOW; i <= ce.HIGH; i += 1)
      t.push(new Sn({
        quality: i,
        enabled: i <= e
      }));
    this.log.debug("setting publishing quality. max quality ".concat(e), this.logContext), this.setPublishingLayers(Se(this.codec), t);
  }
  restartTrack(e) {
    return f(this, void 0, void 0, function* () {
      var t, i, s, r, a;
    ...
    return f(this, arguments, void 0, function(i) {
      ...
      return function* () {
        ...
        if (yield t.setProcessor.call(s, i, r), !((l = s.processor) === null || l === void 0) && l.processedTrack)
          try {
            for (var h = !0, m = xe(s.simulcastCodecs.values()), b; b = yield m.next(), a = b.done, !a; h = !0)
              d = b.value, h = !1, yield (u = d.sender) === null || u === void 0 ? void 0 : u.replaceTrack(s.processor.processedTrack);
          } catch (p) {
            o = {
              error: p
            };
  ...
  setPublishingCodecs(e) {
    return f(this, void 0, void 0, function* () {
      ...
      if (this.log.debug("setting publishing codecs", Object.assign(Object.assign({}, this.logContext), {
        ...
        return yield this.setPublishingLayers(Se(e[0].codec), e[0].qualities), [];
      ...
      try {
        for (t = !0, i = xe(e); s = yield i.next(), r = s.done, !r; t = !0) {
          ...
          if (!this.codec || this.codec === l.codec)
            yield this.setPublishingLayers(Se(l.codec), l.qualities);
          else {
            ...
            } else u.encodings && (this.log.debug("try setPublishingLayersForSender ".concat(l.codec), this.logContext), yield Ms(u.sender, u.encodings, l.qualities, this.senderLock, Se(l.codec), this.log, this.logContext));
          }
        }
      } catch (l) {
        a = {
  ...
  setPublishingLayers(e, t) {
    return f(this, void 0, void 0, function* () {
      ...
      this.log.debug("setting publishing layers", Object.assign(Object.assign({}, this.logContext), {
        qualities: t
      })), !(!this.sender || !this.encodings) && (yield Ms(this.sender, this.encodings, t, this.senderLock, e, this.log, this.logContext));
    });
  }
  /**
      ...
      try {
        ...
        t.encodings = t.encodings.map((i, s) => {
          ...
          return Object.assign(Object.assign({}, i), {
            ...
            scalabilityMode: s === 0 && Se(this.codec) ? "L1T3" : void 0,
  ...
  handleAppVisibilityChanged() {
    ...
    return f(this, void 0, void 0, function* () {
      yield e.handleAppVisibilityChanged.call(this), ha() && this.isInBackground && this.source === k.Source.Camera && (this._mediaStreamTrack.enabled = !1);
    });
  }
}
  ...
  return f(this, void 0, void 0, function* () {
    ...
    try {
      ...
      !1 && d[0].scalabilityMode || (s && t.some((m) => m.enabled) && t.forEach((m) => m.enabled = !0), d.forEach((h, m) => {
        var b;
        let p = (b = h.rid) !== null && b !== void 0 ? b : "";
        p === "" && (p = "q");
        const P = Ea(p), S = t.find((O) => O.quality === P);
        S && h.active !== S.enabled && (l = !0, h.active = S.enabled, r.debug("setting layer ".concat(S.quality, " to ").concat(h.active ? "enabled" : "disabled"), a), Xe() && (S.enabled ? (h.scaleResolutionDownBy = e[m].scaleResolutionDownBy, h.maxBitrate = e[m].maxBitrate, h.maxFrameRate = e[m].maxFrameRate) : (h.scaleResolutionDownBy = 4, h.maxBitrate = 10, h.maxFrameRate = 2)));
...
function As(n, e, t, i) {
  ...
  if (i) {
    const s = t[0].scalabilityMode, r = new Pa(s), a = [], o = r.suffix == "h" ? 1.5 : 2, c = r.suffix == "h" ? 2 : 3;
    for (let d = 0; d < r.spatial; d += 1)
      a.push(new ze({
        quality: Math.min(ce.HIGH, r.spatial - 1) - d,
  ...
  return t.map((s) => {
    ...
    let d = Ea((a = s.rid) !== null && a !== void 0 ? a : "");
    return new ze({
      quality: d,
      width: Math.ceil(n / c),
...
const Ns = "_lossy", Ls = "_reliable", Jd = 2 * 1e3, xi = "leave-reconnect", Qd = 3e4;
var ue;
(function(n) {
...
class Yd extends we.EventEmitter {
  get isClosed() {
  ...
  constructor(e) {
    var t;
    super(), this.options = e, this.rtcConfig = {}, this.peerConnectionTimeout = On.peerConnectionTimeout, this.fullReconnectOnNext = !1, this.latestRemoteOfferId = 0, this.subscriberPrimary = !1, this.pcState = ue.New, this._isClosed = !0, this.pendingTrackResolvers = {}, this.reconnectAttempts = 0, this.reconnectStart = 0, this.attemptingReconnect = !1, this.joinAttempts = 0, this.maxJoinAttempts = 1, this.shouldFailNext = !1, this.log = U, this.reliableDataSequence = 1, this.reliableMessageBuffer = new Ss(), this.reliableReceivedState = new kd(Qd), this.handleDataChannel = (i) => f(this, [i], void 0, function(s) {
      var r = this;
      let {
        channel: a
      } = s;
      ...
      try {
        ...
        const c = ne.fromBinary(new Uint8Array(o));
        if (c.sequence > 0 && c.participantSid !== "") {
          const d = this.reliableReceivedState.get(c.participantSid);
          if (d && c.sequence <= d)
            return;
          this.reliableReceivedState.set(c.participantSid, c.sequence);
        }
        ((s = c.value) === null || s === void 0 ? void 0 : s.case) === "speaker" ? this.emit(_.ActiveSpeakersUpdate, c.value.value.speakers) : (((r = c.value) === null || r === void 0 ? void 0 : r.case) === "user" && $d(c, c.value.value), this.emit(_.DataPacketReceived, c));
      } finally {
        a();
      }
      ...
      i === xi && (o = 0), this.log.debug("reconnecting in ".concat(o, "ms"), this.logContext), this.clearReconnectTimeout(), this.token && this.regionUrlProvider && this.regionUrlProvider.updateToken(this.token), this.reconnectTimeout = ee.setTimeout(() => this.attemptReconnect(s).finally(() => this.reconnectTimeout = void 0), o);
    }, this.waitForRestarted = () => new Promise((i, s) => {
      this.pcState === ue.Connected && i();
      const r = () => {
      ...
      this.client.currentState === G.RECONNECTING && (this.clearReconnectTimeout(), this.attemptReconnect(tt.RR_SIGNAL_DISCONNECTED));
    }, this.log = Me((t = e.loggerName) !== null && t !== void 0 ? t : ve.Engine), this.loggerOptions = {
      loggerName: e.loggerName,
      loggerContextCb: () => this.logContext
    }, this.client = new wn(void 0, this.loggerOptions), this.client.signalLatency = this.options.expSignalLatency, this.reconnectPolicy = this.options.reconnectPolicy, this.registerOnLineListener(), this.closingLock = new re(), this.dataProcessLock = new re(), this.dcBufferStatus = /* @__PURE__ */ new Map([[L.LOSSY, !0], [L.RELIABLE, !0]]), this.client.onParticipantUpdate = (i) => this.emit(_.ParticipantUpdate, i), this.client.onConnectionQuality = (i) => this.emit(_.ConnectionQualityUpdate, i), this.client.onRoomUpdate = (i) => this.emit(_.RoomUpdate, i), this.client.onSubscriptionError = (i) => this.emit(_.SubscriptionError, i), this.client.onSubscriptionPermissionUpdate = (i) => this.emit(_.SubscriptionPermissionUpdate, i), this.client.onSpeakersChanged = (i) => this.emit(_.SpeakersChanged, i), this.client.onStreamStateUpdate = (i) => this.emit(_.StreamStateChanged, i), this.client.onRequestResponse = (i) => this.emit(_.SignalRequestResponse, i);
  }
  /** @internal */
  get logContext() {
    var e, t, i, s, r, a;
  ...
  join(e, t, i, s) {
    return f(this, void 0, void 0, function* () {
      ...
      try {
        ...
        return this._isClosed = !1, this.latestJoinResponse = r, this.subscriberPrimary = r.subscriberPrimary, this.pcManager || (yield this.configure(r)), (!this.subscriberPrimary || r.fastPublish) && this.negotiate(), this.clientConfiguration = r.clientConfiguration, this.emit(_.SignalConnected, r), r;
      } catch (r) {
        if (r instanceof K && r.reason === B.ServerUnreachable && (this.log.warn("Couldn't connect to server, attempt ".concat(this.joinAttempts, " of ").concat(this.maxJoinAttempts), this.logContext), this.joinAttempts < this.maxJoinAttempts))
  ...
  cleanupPeerConnections() {
    return f(this, void 0, void 0, function* () {
      ...
      t(this.lossyDC), t(this.lossyDCSub), t(this.reliableDC), t(this.reliableDCSub), this.lossyDC = void 0, this.lossyDCSub = void 0, this.reliableDC = void 0, this.reliableDCSub = void 0, this.reliableMessageBuffer = new Ss(), this.reliableDataSequence = 1, this.reliableReceivedState.clear();
    });
  }
  cleanupClient() {
    return f(this, void 0, void 0, function* () {
  ...
  addTrack(e) {
    if (this.pendingTrackResolvers[e.cid])
      throw new Te("a track with the same ID has already been published");
    return new Promise((t, i) => {
      const s = setTimeout(() => {
        delete this.pendingTrackResolvers[e.cid], i(new K("publication of local track timed out, no response from server", B.Timeout));
      }, 1e4);
  ...
  configure(e) {
    return f(this, void 0, void 0, function* () {
      ...
      this.pcManager = new Id(s, e.subscriberPrimary, this.loggerOptions), this.emit(_.TransportsCreated, this.pcManager.publisher, this.pcManager.subscriber), this.pcManager.onIceCandidate = (r, a) => {
        ...
        if (this.log.debug("primary PC state changed ".concat(r), this.logContext), ["closed", "disconnected", "failed"].includes(a) && (this.publisherConnectionPromise = void 0), r === H.CONNECTED) {
          const l = this.pcState === ue.New;
          this.pcState = ue.Connected, l && this.emit(_.Connected, e);
        } else r === H.FAILED && this.pcState === ue.Connected && (this.pcState = ue.Disconnected, this.handleDisconnect("peerconnection failed", o === "failed" ? tt.RR_SUBSCRIBER_FAILED : tt.RR_PUBLISHER_FAILED));
        const c = this.client.isDisconnected || this.client.currentState === G.RECONNECTING, d = [H.FAILED, H.CLOSING, H.CLOSED].includes(r);
        c && d && !this._isClosed && this.emit(_.Offline);
      }), this.pcManager.onTrack = (r) => {
        this.emit(_.MediaTrackAdded, r.track, r.streams[0], r.receiver);
      }, Xd((i = e.serverInfo) === null || i === void 0 ? void 0 : i.protocol) || this.createDataChannels();
    });
  }
  setupSignalClientCallbacks() {
    this.client.onAnswer = (e, t) => f(this, void 0, void 0, function* () {
    ...
    }, this.client.onOffer = (e, t) => f(this, void 0, void 0, function* () {
      if (this.latestRemoteOfferId = t, !this.pcManager)
        return;
      const i = yield this.pcManager.createSubscriberAnswerFromOffer(e, t);
      ...
      switch (this.log.debug("client leave request", Object.assign(Object.assign({}, this.logContext), {
        ...
        case at.DISCONNECT:
          ...
          break;
        case at.RECONNECT:
          this.fullReconnectOnNext = !0, this.handleDisconnect(xi);
          break;
        case at.RESUME:
          this.handleDisconnect(xi);
      }
    };
  }
  makeRTCConfiguration(e) {
    ...
    return e.clientConfiguration && e.clientConfiguration.forceRelay === Pt.ENABLED && (i.iceTransportPolicy = "relay"), i.sdpSemantics = "unified-plan", i.continualGatheringPolicy = "gather_continually", i;
  }
  createDataChannels() {
    this.pcManager && (this.lossyDC && (this.lossyDC.onmessage = null, this.lossyDC.onerror = null), this.reliableDC && (this.reliableDC.onmessage = null, this.reliableDC.onerror = null), this.lossyDC = this.pcManager.createPublisherDataChannel(Ns, {
      ordered: !1,
      maxRetransmits: 0
    }), this.reliableDC = this.pcManager.createPublisherDataChannel(Ls, {
      ordered: !0
  ...
  createSender(e, t, i) {
    return f(this, void 0, void 0, function* () {
      ...
      throw new X("Required webRTC APIs not supported on this device");
    });
  }
  createSimulcastSender(e, t, i, s) {
    return f(this, void 0, void 0, function* () {
      ...
      throw new X("Cannot stream on this device");
    });
  }
  createTransceiverRTCRtpSender(e, t, i) {
    return f(this, void 0, void 0, function* () {
      if (!this.pcManager)
        throw new X("publisher is closed");
      const s = [];
  ...
  attemptReconnect(e) {
    return f(this, void 0, void 0, function* () {
      ...
      if (!this._isClosed) {
        ...
        (((t = this.clientConfiguration) === null || t === void 0 ? void 0 : t.resumeConnection) === Pt.DISABLED || // signaling state could change to closed due to hardware sleep
        ...
        try {
          ...
          let a = !0;
          r instanceof X ? (this.log.debug("received unrecoverable error", Object.assign(Object.assign({}, this.logContext), {
            error: r
          })), a = !1) : r instanceof it || (this.fullReconnectOnNext = !0), a ? this.handleDisconnect("reconnect", tt.RR_UNKNOWN) : (this.log.info("could not recover connection after ".concat(this.reconnectAttempts, " attempts, ").concat(Date.now() - this.reconnectStart, "ms. giving up"), this.logContext), this.emit(_.Disconnected), yield this.close());
        } finally {
    ...
    return f(this, void 0, void 0, function* () {
      ...
      try {
        if (!this.url || !this.token)
          throw new X("could not reconnect, url or token not saved");
        ...
        try {
          if (!this.signalOpts)
            throw this.log.warn("attempted connection restart, without signal options present", this.logContext), new it();
          r = yield this.join(e ?? this.url, this.token, this.signalOpts);
        } catch (a) {
          throw a instanceof K && a.reason === B.NotAllowed ? new X("could not reconnect, token might be expired") : new it();
        }
        if (this.shouldFailNext)
          throw this.shouldFailNext = !1, new Error("simulated failure");
        if (this.client.setReconnected(), this.emit(_.SignalRestarted, r), yield this.waitForPCReconnected(), this.client.currentState !== G.CONNECTED)
  ...
  resumeConnection(e) {
    return f(this, void 0, void 0, function* () {
      ...
      if (!this.url || !this.token)
        throw new X("could not reconnect, url or token not saved");
      if (!this.pcManager)
        throw new X("publisher and subscriber connections unset");
      ...
      try {
        ...
        throw s instanceof Error && (r = s.message, this.log.error(s.message, Object.assign(Object.assign({}, this.logContext), {
          error: s
        }))), s instanceof K && s.reason === B.NotAllowed ? new X("could not reconnect, token might be expired") : s instanceof K && s.reason === B.LeaveRequest ? s : new it(r);
      }
      ...
      if (yield this.pcManager.triggerIceRestart(), yield this.waitForPCReconnected(), this.client.currentState !== G.CONNECTED)
        throw new it("Signal connection got severed during reconnect");
      this.client.setReconnected(), ((t = this.reliableDC) === null || t === void 0 ? void 0 : t.readyState) === "open" && this.reliableDC.id === null && this.createDataChannels(), i != null && i.lastMessageSeq && this.resendReliableMessagesForResume(i.lastMessageSeq), this.emit(_.Resumed);
    });
  }
  waitForPCInitialConnection(e, t) {
    return f(this, void 0, void 0, function* () {
      if (!this.pcManager)
        throw new X("PC manager is closed");
      yield this.pcManager.ensurePCTransportConnection(t, e);
    });
  }
  waitForPCReconnected() {
    return f(this, void 0, void 0, function* () {
      this.pcState = ue.Reconnecting, this.log.debug("waiting for peer connection to reconnect", this.logContext);
      try {
        if (yield ae(Jd), !this.pcManager)
          throw new X("PC manager is closed");
        yield this.pcManager.ensurePCTransportConnection(void 0, this.peerConnectionTimeout), this.pcState = ue.Connected;
      } catch (e) {
        throw this.pcState = ue.Disconnected, new K("could not establish PC connection, ".concat(e.message), B.InternalError);
      }
    });
  }
  /** @internal */
  ...
  sendDataPacket(e, t) {
    return f(this, void 0, void 0, function* () {
      yield this.ensurePublisherConnected(t), t === L.RELIABLE && (e.sequence = this.reliableDataSequence, this.reliableDataSequence += 1);
  ...
  ensureDataTransportConnected(e) {
    return f(this, arguments, void 0, function(t) {
      ...
      return function* () {
        ...
        if (!a)
          throw new K("".concat(o, " connection not set"), B.InternalError);
        let c = !1;
        ...
        throw new K("could not establish ".concat(o, " connection, state: ").concat(a.getICEConnectionState()), B.InternalError);
      }();
    });
  }
  ...
  negotiate() {
    return f(this, void 0, void 0, function* () {
      return new Promise((e, t) => f(this, void 0, void 0, function* () {
        ...
        this.isClosed && t("cannot negotiate on closed engine"), this.on(_.Closing, s), this.pcManager.publisher.once(dt.RTPVideoPayloadTypes, (r) => {
          const a = /* @__PURE__ */ new Map();
          r.forEach((o) => {
            const c = o.codec.toLowerCase();
            Zc(c) && a.set(o.payload, c);
          }), this.emit(_.RTPVideoMapUpdate, a);
        });
        try {
          yield this.pcManager.negotiate(i), e();
        } catch (r) {
          r instanceof Xi && (this.fullReconnectOnNext = !0), this.handleDisconnect("negotiation", tt.RR_UNKNOWN), t(r);
        } finally {
  ...
  sendSyncState(e, t) {
    ...
    const r = this.pcManager.subscriber.getLocalDescription(), a = this.pcManager.subscriber.getRemoteDescription(), o = (s = (i = this.signalOpts) === null || i === void 0 ? void 0 : i.autoSubscribe) !== null && s !== void 0 ? s : !0, c = new Array(), d = new Array();
    e.forEach((l) => {
      l.isDesired !== o && c.push(l.trackSid), l.isEnabled || d.push(l.trackSid);
    }), this.client.sendSyncState(new Rr({
      answer: r ? Zt({
        sdp: r.sdp,
        type: r.type
      }) : void 0,
      ...
      trackSidsDisabled: d,
      datachannelReceiveStates: this.reliableReceivedState.map((l, u) => new wr({
        publisherSid: u,
        lastSeq: l
      }))
    }));
  ...
  dataChannelsInfo() {
    const e = [], t = (i, s) => {
      (i == null ? void 0 : i.id) !== void 0 && i.id !== null && e.push(new _r({
        label: i.label,
        id: i.id,
        target: s
      }));
    };
    return t(this.dataChannelForKind(L.LOSSY), me.PUBLISHER), t(this.dataChannelForKind(L.RELIABLE), me.PUBLISHER), t(this.dataChannelForKind(L.LOSSY, !0), me.SUBSCRIBER), t(this.dataChannelForKind(L.RELIABLE, !0), me.SUBSCRIBER), e;
  }
  clearReconnectTimeout() {
    this.reconnectTimeout && ee.clearTimeout(this.reconnectTimeout);
  }
...
class fn {
  ...
  fetchRegionSettings(e) {
    return f(this, void 0, void 0, function* () {
      const t = yield fetch("".concat(Zd(this.serverUrl), "/regions"), {
        headers: {
      ...
      if (t.ok) {
        ...
        throw new K("Could not fetch region settings: ".concat(t.statusText), t.status === 401 ? B.NotAllowed : B.InternalError, t.status);
    });
  }
  ...
  validateBytesReceived() {
    ...
    if (!(typeof this.totalByteSize != "number" || this.totalByteSize === 0)) {
      if (e && this.bytesReceived < this.totalByteSize)
        throw new Fe("Not enough chunk(s) received - expected ".concat(this.totalByteSize, " bytes of data total, only received ").concat(this.bytesReceived, " bytes"), pe.Incomplete);
      if (this.bytesReceived > this.totalByteSize)
        throw new Fe("Extra chunk(s) received - expected ".concat(this.totalByteSize, " bytes of data total, received ").concat(this.bytesReceived, " bytes"), pe.LengthExceeded);
    }
  }
  constructor(e, t, i, s) {
...
class tl extends Ra {
  ...
  handleChunkReceived(e) {
    var t;
    const i = zt(e.chunkIndex), s = this.receivedChunks.get(i);
        ...
        try {
            ...
            };
          {
            ...
            try {
              ...
              throw new Fe("Cannot decode datastream chunk ".concat(l.chunkIndex, " as text: ").concat(h), pe.DecodeFailed);
            }
            return {
              done: !1,
              value: u
...
class il {
  ...
  registerTextStreamHandler(e, t) {
    if (this.textStreamHandlers.has(e))
      throw new Fe('A text stream handler for topic "'.concat(e, '" has already been set.'), pe.HandlerAlreadyRegistered);
  ...
  registerByteStreamHandler(e, t) {
    if (this.byteStreamHandlers.has(e))
      throw new Fe('A byte stream handler for topic "'.concat(e, '" has already been set.'), pe.HandlerAlreadyRegistered);
  ...
  validateParticipantHasNoActiveDataStreams(e) {
    ...
    if (a.length > 0 || o.length > 0) {
      const c = new Fe("Participant ".concat(e, " unexpectedly disconnected in the middle of sending data"), pe.AbnormalEnd);
      for (const [d, l] of o)
  ...
  handleDataStreamPacket(e) {
    return f(this, void 0, void 0, function* () {
      switch (e.value.case) {
        case "streamHeader":
          return this.handleStreamHeader(e.value.value, e.participantIdentity);
        case "streamChunk":
          return this.handleStreamChunk(e.value.value);
        case "streamTrailer":
          return this.handleStreamTrailer(e.value.value);
        default:
  ...
  handleStreamHeader(e, t) {
    return f(this, void 0, void 0, function* () {
      ...
      if (e.contentHeader.case === "byteHeader") {
        ...
        const a = new Ce(), o = {
          id: e.streamId,
          name: (i = e.contentHeader.value.name) !== null && i !== void 0 ? i : "unknown",
          mimeType: e.mimeType,
          ...
          start: (d) => {
            if (r = d, this.textStreamControllers.has(e.streamId))
              throw new Fe("A data stream read is already in progress for a stream with id ".concat(e.streamId, "."), pe.AlreadyOpened);
        ...
        s(new el(o, c, zt(e.totalLength), a), {
          identity: t
        });
      } else if (e.contentHeader.case === "textHeader") {
        const s = this.textStreamHandlers.get(e.topic);
        if (!s) {
        ...
        s(new tl(o, c, zt(e.totalLength), a), {
          identity: t
        });
      }
    });
...
class rl {
  ...
  sendText(e, t) {
    return f(this, void 0, void 0, function* () {
      var i;
      const s = crypto.randomUUID(), a = new TextEncoder().encode(e).byteLength, o = (i = t == null ? void 0 : t.attachments) === null || i === void 0 ? void 0 : i.map(() => crypto.randomUUID()), c = new Array(o ? o.length + 1 : 1).fill(0), d = (u, h) => {
        var m;
        c[h] = u;
        const b = c.reduce((p, P) => p + P, 0);
        (m = t == null ? void 0 : t.onProgress) === null || m === void 0 || m.call(t, b);
  ...
  streamText(e) {
    return f(this, void 0, void 0, function* () {
      var t, i;
      const s = (t = e == null ? void 0 : e.streamId) !== null && t !== void 0 ? t : crypto.randomUUID(), r = {
        id: s,
        mimeType: "text/plain",
        timestamp: Date.now(),
        ...
        mimeType: r.mimeType,
        topic: r.topic,
        timestamp: He(r.timestamp),
        totalLength: He(e == null ? void 0 : e.totalSize),
        ...
        contentHeader: {
          ...
          value: new vr({
            ...
            operationType: (e == null ? void 0 : e.type) === "update" ? Ui.UPDATE : Ui.CREATE
          })
        }
      }), o = e == null ? void 0 : e.destinationIdentities, c = new ne({
      ...
      yield this.engine.sendDataPacket(c, L.RELIABLE);
      let d = 0;
      const l = this.engine, u = new WritableStream({
        // Implement the sink
        write(b) {
          return f(this, void 0, void 0, function* () {
            for (const p of rd(b, Us)) {
              yield l.waitForBufferStatusLow(L.RELIABLE);
              const P = new Bi({
                content: p,
                streamId: s,
                chunkIndex: He(d)
              ...
              yield l.sendDataPacket(S, L.RELIABLE), d += 1;
            }
          });
        },
        close() {
          return f(this, void 0, void 0, function* () {
            ...
            yield l.sendDataPacket(p, L.RELIABLE);
          });
        },
        abort(b) {
          console.log("Sink error:", b);
        }
      });
      ...
      l.once(_.Closing, h);
      const m = new nl(u, r, () => this.engine.off(_.Closing, h));
      return m;
    });
  }
  sendFile(e, t) {
  ...
  streamBytes(e) {
    return f(this, void 0, void 0, function* () {
      var t, i, s, r, a;
      const o = (t = e == null ? void 0 : e.streamId) !== null && t !== void 0 ? t : crypto.randomUUID(), c = e == null ? void 0 : e.destinationIdentities, d = {
        id: o,
        ...
        totalLength: He((a = d.size) !== null && a !== void 0 ? a : 0),
        mimeType: d.mimeType,
        streamId: o,
        topic: d.topic,
        timestamp: He(Date.now()),
      ...
      yield this.engine.sendDataPacket(u, L.RELIABLE);
      let h = 0;
      const m = new re(), b = this.engine, p = this.log, P = new WritableStream({
        write(O) {
          return f(this, void 0, void 0, function* () {
            const I = yield m.lock();
            let v = 0;
            try {
              for (; v < O.byteLength; ) {
                const y = O.slice(v, v + Us);
                yield b.waitForBufferStatusLow(L.RELIABLE);
                const C = new ne({
                  destinationIdentities: c,
                  value: {
                    case: "streamChunk",
                ...
                yield b.sendDataPacket(C, L.RELIABLE), h += 1, v += y.byteLength;
              }
            } finally {
              I();
            }
        ...
        close() {
          return f(this, void 0, void 0, function* () {
            ...
            yield b.sendDataPacket(I, L.RELIABLE);
          });
        },
        abort(O) {
          p.error("Sink error:", O);
        }
      });
      return new sl(P, d);
    });
...
class _a extends k {
  ...
  setMediaStream(e) {
    this.mediaStream = e;
    const t = (i) => {
      i.track === this._mediaStreamTrack && (e.removeEventListener("removetrack", t), this.receiver && "playoutDelayHint" in this.receiver && (this.receiver.playoutDelayHint = void 0), this.receiver = void 0, this._currentBitrate = 0, this.emit(R.Ended, this));
    };
  ...
  /* @internal */
  startMonitor() {
    this.monitorInterval || (this.monitorInterval = setInterval(() => this.monitorReceiver(), xn)), cd() && this.registerTimeSyncUpdate();
  }
...
class al extends _a {
  constructor(e, t, i, s, r, a) {
    super(e, t, k.Kind.Audio, i, a), this.monitorReceiver = () => f(this, void 0, void 0, function* () {
      if (!this.receiver) {
        this._currentBitrate = 0;
        return;
      }
      const o = yield this.getReceiverStats();
      o && this.prevStats && this.receiver && (this._currentBitrate = oi(o, this.prevStats)), this.prevStats = o;
  ...
  setVolume(e) {
    ...
    Ee() && this._mediaStreamTrack._setVolume(e), this.elementVolume = e;
  }
  /**
...
class ol extends _a {
  constructor(e, t, i, s, r) {
    super(e, t, k.Kind.Video, i, r), this.elementInfos = [], this.monitorReceiver = () => f(this, void 0, void 0, function* () {
      if (!this.receiver) {
        this._currentBitrate = 0;
        return;
      }
      const a = yield this.getReceiverStats();
      a && this.prevStats && this.receiver && (this._currentBitrate = oi(a, this.prevStats)), this.prevStats = a;
    }), this.debouncedHandleResize = In(() => {
      this.updateDimensions();
    }, Mi), this.adaptiveStreamSettings = s;
  }
  get isAdaptiveStream() {
    return this.adaptiveStreamSettings !== void 0;
  }
  setStreamState(e) {
    super.setStreamState(e), console.log("setStreamState", e), e === k.StreamState.Active && this.updateVisibility();
  }
  /**
  ...
  setMuted(e) {
    super.setMuted(e), this.attachedElements.forEach((t) => {
      e ? ct(this._mediaStreamTrack, t) : st(this._mediaStreamTrack, t);
    });
  }
  attach(e) {
...
class cl {
  ...
  constructor(e, t) {
    this.onVisibilityChanged = (i) => {
      ...
      r === this.element && (this.isIntersecting = a, this.isPiP = vt(this.element), this.visibilityChangedAt = Date.now(), (s = this.handleVisibilityChanged) === null || s === void 0 || s.call(this));
    }, this.onEnterPiP = () => {
      var i, s, r;
      (s = (i = window.documentPictureInPicture) === null || i === void 0 ? void 0 : i.window) === null || s === void 0 || s.addEventListener("pagehide", this.onLeavePiP), this.isPiP = vt(this.element), (r = this.handleVisibilityChanged) === null || r === void 0 || r.call(this);
    }, this.onLeavePiP = () => {
      var i;
      this.isPiP = vt(this.element), (i = this.handleVisibilityChanged) === null || i === void 0 || i.call(this);
    }, this.element = e, this.isIntersecting = t ?? mn(e), this.isPiP = se() && vt(e), this.visibilityChangedAt = 0;
  }
  width() {
  ...
  observe() {
    var e, t, i;
    this.isIntersecting = mn(this.element), this.isPiP = vt(this.element), this.element.handleResize = () => {
      var s;
  ...
  stopObserving() {
    var e, t, i, s, r;
    (e = bs()) === null || e === void 0 || e.unobserve(this.element), (t = vs()) === null || t === void 0 || t.unobserve(this.element), this.element.removeEventListener("enterpictureinpicture", this.onEnterPiP), this.element.removeEventListener("leavepictureinpicture", this.onLeavePiP), (i = window.documentPictureInPicture) === null || i === void 0 || i.removeEventListener("enter", this.onEnterPiP), (r = (s = window.documentPictureInPicture) === null || s === void 0 ? void 0 : s.window) === null || r === void 0 || r.removeEventListener("pagehide", this.onLeavePiP);
  }
}
function vt(n) {
  var e, t;
  return document.pictureInPictureElement === n ? !0 : !((e = window.documentPictureInPicture) === null || e === void 0) && e.window ? mn(n, (t = window.documentPictureInPicture) === null || t === void 0 ? void 0 : t.window) : !1;
}
function mn(n, e) {
  const t = e || window;
...
class Ie extends we.EventEmitter {
  constructor(e, t, i, s) {
    var r;
    super(), this.metadataMuted = !1, this.encryption = oe.NONE, this.log = U, this.handleMuted = () => {
      this.emit(R.Muted);
    }, this.handleUnmuted = () => {
      this.emit(R.Unmuted);
    }, this.log = Me((r = s == null ? void 0 : s.loggerName) !== null && r !== void 0 ? r : ve.Publication), this.loggerContextCb = this.loggerContextCb, this.setMaxListeners(100), this.kind = e, this.trackSid = t, this.trackName = i, this.source = k.Source.Unknown;
  }
  /** @internal */
  setTrack(e) {
  ...
  get isEncrypted() {
    return this.encryption !== oe.NONE;
  }
  /**
  ...
  /** @internal */
  updateInfo(e) {
    this.trackSid = e.sid, this.trackName = e.name, this.source = k.sourceFromProto(e.source), this.mimeType = e.mimeType, this.kind === k.Kind.Video && e.width > 0 && (this.dimensions = {
      width: e.width,
      height: e.height
...
function ci(n, e) {
  return f(this, void 0, void 0, function* () {
    ...
    const c = pa(r, ka, Ta), d = En(c), l = navigator.mediaDevices.getUserMedia(d);
    r.audio && (Z.userMediaPromiseMap.set("audioinput", l), l.catch(() => Z.userMediaPromiseMap.delete("audioinput"))), r.video && (Z.userMediaPromiseMap.set("videoinput", l), l.catch(() => Z.userMediaPromiseMap.delete("videoinput")));
    try {
      const u = yield l;
      return yield Promise.all(u.getTracks().map((h) => f(this, void 0, void 0, function* () {
        const m = h.kind === "audio";
        let b = m ? c.audio : c.video;
        (typeof b == "boolean" || !b) && (b = {});
        let p;
        const P = m ? d.audio : d.video;
        typeof P != "boolean" && (p = P);
        const S = h.getSettings().deviceId;
        p != null && p.deviceId && qe(p.deviceId) !== S ? p.deviceId = S : p || (p = {
          deviceId: S
        });
        const O = Ld(h, p, e);
        return O.kind === k.Kind.Video ? O.source = k.Source.Camera : O.kind === k.Kind.Audio && (O.source = k.Source.Microphone), O.mediaStream = u, Pe(O) && i ? yield O.setProcessor(i) : Ge(O) && s && (yield O.setProcessor(s)), O;
      })));
    } catch (u) {
      if (!t)
        throw u;
      return ci(Object.assign(Object.assign({}, n), {
        audio: a,
        video: o
      }), e);
    }
...
function zl(n) {
  return f(this, void 0, void 0, function* () {
    if (n === void 0 && (n = {}), n.resolution === void 0 && !ua() && (n.resolution = ai.h1080fps30.resolution), navigator.mediaDevices.getDisplayMedia === void 0)
      throw new ri("getDisplayMedia not supported");
    const e = va(n), t = yield navigator.mediaDevices.getDisplayMedia(e), i = t.getVideoTracks();
    if (i.length === 0)
      throw new Te("no video track found");
    const s = new Ot(i[0], void 0, !1);
    s.source = k.Source.ScreenShare;
    const r = [s];
    if (t.getAudioTracks().length > 0) {
      const a = new It(t.getAudioTracks()[0], void 0, !1);
      a.source = k.Source.ScreenShareAudio, r.push(a);
    }
    return r;
  });
}
...
class Ia extends we.EventEmitter {
  get logContext() {
    var e, t;
  ...
  get isAgent() {
    var e;
    return ((e = this.permissions) === null || e === void 0 ? void 0 : e.agent) || this.kind === Et.AGENT;
  }
  get isActive() {
    var e;
    return ((e = this.participantInfo) === null || e === void 0 ? void 0 : e.state) === rt.ACTIVE;
  }
  get kind() {
    return this._kind;
  }
  ...
  /** @internal */
  constructor(e, t, i, s, r, a) {
    let o = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : Et.STANDARD;
    var c;
    super(), this.audioLevel = 0, this.isSpeaking = !1, this._connectionQuality = Be.Unknown, this.log = U, this.log = Me((c = a == null ? void 0 : a.loggerName) !== null && c !== void 0 ? c : ve.Participant), this.loggerOptions = a, this.setMaxListeners(100), this.sid = e, this.identity = t, this.name = i, this.metadata = s, this.audioTrackPublications = /* @__PURE__ */ new Map(), this.videoTrackPublications = /* @__PURE__ */ new Map(), this.trackPublications = /* @__PURE__ */ new Map(), this._kind = o, this._attributes = r ?? {};
  }
   ...
   */
  waitUntilActive() {
    return this.isActive ? Promise.resolve() : this.activeFuture ? this.activeFuture.promise : (this.activeFuture = new Ce(), this.once(w.Active, () => {
      var e, t;
  ...
  get isCameraEnabled() {
    var e;
    const t = this.getTrackPublication(k.Source.Camera);
    return !(!((e = t == null ? void 0 : t.isMuted) !== null && e !== void 0) || e);
  }
  get isMicrophoneEnabled() {
    var e;
    const t = this.getTrackPublication(k.Source.Microphone);
    return !(!((e = t == null ? void 0 : t.isMuted) !== null && e !== void 0) || e);
  }
  get isScreenShareEnabled() {
    return !!this.getTrackPublication(k.Source.ScreenShare);
  }
  get isLocal() {
    return !1;
  }
  ...
  setConnectionQuality(e) {
    ...
    this._connectionQuality = ul(e), t !== this._connectionQuality && this.emit(w.ConnectionQualityChanged, this._connectionQuality);
  }
  /**
   * @internal
   */
...
class fl extends Ia {
  ...
  constructor(e, t, i, s, r, a) {
    super(e, t, void 0, void 0, void 0, {
    ...
    }), this.pendingPublishing = /* @__PURE__ */ new Set(), this.pendingPublishPromises = /* @__PURE__ */ new Map(), this.participantTrackPermissions = [], this.allParticipantsAllowedToSubscribe = !0, this.encryptionType = oe.NONE, this.enabledPublishVideoCodecs = [], this.pendingAcks = /* @__PURE__ */ new Map(), this.pendingResponses = /* @__PURE__ */ new Map(), this.handleReconnecting = () => {
      this.reconnectFuture || (this.reconnectFuture = new Ce());
      ...
      var c, d;
      o.participant && this.updateInfo(o.participant), this.signalConnectedFuture || (this.signalConnectedFuture = new Ce()), (d = (c = this.signalConnectedFuture).resolve) === null || d === void 0 || d.call(c);
      ...
      u && (d !== Cn.OK && u.reject(new fs(l, d)), this.pendingSignalRequests.delete(c));
    }, this.handleDataPacket = (o) => {
      switch (o.value.case) {
        case "rpcResponse":
          let c = o.value.value, d = null, l = null;
          c.value.case === "payload" ? d = c.value.value : c.value.case === "error" && (l = J.fromProto(c.value.value)), this.handleIncomingRpcResponse(c.requestId, d, l);
          break;
        case "rpcAck":
          let u = o.value.value;
      ...
      })), this.engine.client.sendUpdateSubscriptionPermissions(this.allParticipantsAllowedToSubscribe, this.participantTrackPermissions.map((o) => hl(o)));
      ...
      if (!m.videoTrack)
        return;
      const b = yield m.videoTrack.setPublishingCodecs(o.subscribedCodecs);
      try {
        for (var p = !0, P = xe(b), S; S = yield P.next(), c = S.done, !c; p = !0) {
          u = S.value, p = !1;
          const O = u;
          qc(O) && (this.log.debug("publish ".concat(O, " for ").concat(m.videoTrack.sid), Object.assign(Object.assign({}, this.logContext), F(m))), yield this.publishAdditionalCodecForTrack(m.videoTrack, O, m.options));
        }
      } catch (O) {
        d = {
          error: O
      ...
      if (o.source === k.Source.ScreenShare || o.source === k.Source.ScreenShareAudio)
        ...
        try {
          if (se())
            try {
              const c = yield navigator == null ? void 0 : navigator.permissions.query({
                ...
                // @ts-ignore
                name: o.source === k.Source.Camera ? "camera" : "microphone"
              });
              if (c && c.state === "denied")
          ...
          o.isMuted || (this.log.debug("track ended, attempting to use a different device", Object.assign(Object.assign({}, this.logContext), F(o))), _e(o) ? yield o.restartTrack({
            deviceId: "default"
  ...
  get isE2EEEnabled() {
    return this.encryptionType !== oe.NONE;
  }
  getTrackPublication(e) {
        ...
        return new Promise((o, c) => f(i, void 0, void 0, function* () {
          ...
          try {
            ...
            for (this.pendingSignalRequests.set(h, {
              ...
              if ((!r || this.name === r) && (!s || this.metadata === s) && (!a || Object.entries(a).every((b) => {
                let [p, P] = b;
                return this.attributes[p] === P || P === "" && !this.attributes[p];
              }))) {
            ...
            c(new fs("Request to update local metadata timed out", "TimeoutError"));
          } catch (u) {
  ...
  setCameraEnabled(e, t, i) {
    return this.setTrackEnabled(k.Source.Camera, e, t, i);
  }
  /**
  ...
  setMicrophoneEnabled(e, t, i) {
    return this.setTrackEnabled(k.Source.Microphone, e, t, i);
  }
  /**
  ...
  setScreenShareEnabled(e, t, i) {
    return this.setTrackEnabled(k.Source.ScreenShare, e, t, i);
  }
  /** @internal */
  setPermissions(e) {
    const t = this.permissions, i = super.setPermissions(e);
    return i && t && this.emit(w.ParticipantPermissionsChanged, t), i;
  }
  /** @internal */
  setE2EEEnabled(e) {
    return f(this, void 0, void 0, function* () {
      this.encryptionType = e ? oe.GCM : oe.NONE, yield this.republishAllTracks(void 0, !1);
    });
  }
      ...
      if (t)
        if (o)
          ...
          for (const d of c) {
            ...
            e === k.Source.Microphone && Pe(d) && l.preConnectBuffer && (this.log.info("starting preconnect buffer for microphone", Object.assign({}, this.logContext)), d.startPreConnectBuffer());
          }
          try {
            const d = [];
            for (const u of c)
        ...
        if (e === k.Source.ScreenShare) {
          o = yield this.unpublishTrack(o.track);
          const c = this.getTrackPublication(k.Source.ScreenShareAudio);
  ...
  enableCameraAndMicrophone() {
    return f(this, void 0, void 0, function* () {
      if (!(this.pendingPublishing.has(k.Source.Camera) || this.pendingPublishing.has(k.Source.Microphone))) {
        this.pendingPublishing.add(k.Source.Camera), this.pendingPublishing.add(k.Source.Microphone);
        try {
          ...
          this.pendingPublishing.delete(k.Source.Camera), this.pendingPublishing.delete(k.Source.Microphone);
        }
      }
    });
  }
  ...
  createTracks(e) {
    return f(this, void 0, void 0, function* () {
      var t, i;
      e ?? (e = {});
      const s = pa(e, (t = this.roomOptions) === null || t === void 0 ? void 0 : t.audioCaptureDefaults, (i = this.roomOptions) === null || i === void 0 ? void 0 : i.videoCaptureDefaults);
      try {
        return (yield ci(s, {
          loggerName: this.roomOptions.loggerName,
          loggerContextCb: () => this.logContext
        })).map((o) => (Pe(o) && (this.microphoneError = void 0, o.setAudioContext(this.audioContext), o.source = k.Source.Microphone, this.emit(w.AudioStreamAcquired)), Ge(o) && (this.cameraError = void 0, o.source = k.Source.Camera), o));
      } catch (r) {
  ...
  createScreenTracks(e) {
    return f(this, void 0, void 0, function* () {
      if (e === void 0 && (e = {}), navigator.mediaDevices.getDisplayMedia === void 0)
        throw new ri("getDisplayMedia not supported");
      e.resolution === void 0 && !ua() && (e.resolution = ai.h1080fps30.resolution);
      const t = va(e), i = yield navigator.mediaDevices.getDisplayMedia(t), s = i.getVideoTracks();
      if (s.length === 0)
        throw new Te("no video track found");
      const r = new Ot(s[0], void 0, !1, {
        loggerName: this.roomOptions.loggerName,
        loggerContextCb: () => this.logContext
      });
      ...
      if (i.getAudioTracks().length > 0) {
        ...
        const o = new It(i.getAudioTracks()[0], void 0, !1, this.audioContext, {
          loggerName: this.roomOptions.loggerName,
          loggerContextCb: () => this.logContext
        });
        o.source = k.Source.ScreenShareAudio, a.push(o);
      }
      return a;
    });
  }
  ...
  publishOrRepublishTrack(e, t) {
    return f(this, arguments, void 0, function(i, s) {
      ...
      return function* () {
        var o, c, d, l;
        _e(i) && i.setAudioContext(r.audioContext), yield (o = r.reconnectFuture) === null || o === void 0 ? void 0 : o.promise, r.republishPromise && !a && (yield r.republishPromise), Je(i) && r.pendingPublishPromises.has(i) && (yield r.pendingPublishPromises.get(i));
        let u;
        ...
        if (i instanceof MediaStreamTrack)
          switch (i.kind) {
            ...
            case "video":
              ...
              break;
            default:
              throw new Te("unsupported MediaStreamTrack kind ".concat(i.kind));
          }
        else
        ...
        const m = "channelCount" in i.mediaStreamTrack.getSettings() && // @ts-ignore `channelCount` on getSettings() is currently only available for Safari, but is generally the best way to determine a stereo track https://developer.mozilla.org/en-US/docs/Web/API/MediaTrackSettings/channelCount
        i.mediaStreamTrack.getSettings().channelCount === 2 || i.mediaStreamTrack.getConstraints().channelCount === 2, b = (c = s == null ? void 0 : s.forceStereo) !== null && c !== void 0 ? c : m;
        b && (s || (s = {}), s.dtx === void 0 && r.log.info("Opus DTX will be disabled for stereo tracks by default. Enable them explicitly to make it work.", Object.assign(Object.assign({}, r.logContext), F(i))), s.red === void 0 && r.log.info("Opus RED will be disabled for stereo tracks by default. Enable them explicitly to make it work."), (d = s.dtx) !== null && d !== void 0 || (s.dtx = !1), (l = s.red) !== null && l !== void 0 || (s.red = !1));
        const p = Object.assign(Object.assign({}, r.roomOptions.publishDefaults), s);
        !Qc() && r.roomOptions.e2ee && (r.log.info("End-to-end encryption is set up, simulcast publishing will be disabled on Safari versions and iOS browsers running iOS < v17.2", Object.assign({}, r.logContext)), p.simulcast = !1), p.source && (i.source = p.source);
        const P = new Promise((S, O) => f(r, void 0, void 0, function* () {
          try {
            if (this.engine.client.currentState !== G.CONNECTED) {
              ...
              const I = setTimeout(() => {
                O(new hs("publishing rejected as engine not connected within timeout", 408));
              }, 15e3);
              yield this.waitUntilEngineConnected(), clearTimeout(I);
              const v = yield this.publish(i, p, b);
              S(v);
            } else
              try {
                const I = yield this.publish(i, p, b);
                S(I);
              } catch (I) {
                O(I);
              }
        ...
        r.pendingPublishPromises.set(i, P);
        try {
          return yield P;
        } catch (S) {
          throw S;
  ...
  waitUntilEngineConnected() {
    return this.signalConnectedFuture || (this.signalConnectedFuture = new Ce()), this.signalConnectedFuture.promise;
  }
  hasPermissionsToPublish(e) {
    ...
    return t && (i.length === 0 || i.map((s) => ld(s)).includes(e.source)) ? !0 : (this.log.warn("insufficient permissions to publish", Object.assign(Object.assign({}, this.logContext), F(e))), !1);
  }
  publish(e, t, i) {
    return f(this, void 0, void 0, function* () {
      var s, r, a, o, c, d, l, u, h, m;
      if (!this.hasPermissionsToPublish(e))
        throw new hs("failed to publish track, insufficient permissions", 403);
      Array.from(this.trackPublications.values()).find((D) => Je(e) && D.source === e.source) && e.source !== k.Source.Unknown && this.log.info("publishing a second track with the same source: ".concat(e.source), Object.assign(Object.assign({}, this.logContext), F(e))), t.stopMicTrackOnMute && Pe(e) && (e.stopOnMute = !0), e.source === k.Source.ScreenShare && Xe() && (t.simulcast = !1), t.videoCodec === "av1" && !Wc() && (t.videoCodec = void 0), t.videoCodec === "vp9" && !Hc() && (t.videoCodec = void 0), t.videoCodec === void 0 && (t.videoCodec = ln), this.enabledPublishVideoCodecs.length > 0 && (this.enabledPublishVideoCodecs.some((D) => t.videoCodec === St(D.mime)) || (t.videoCodec = St(this.enabledPublishVideoCodecs[0].mime)));
      ...
      const P = [], S = !(!((s = t.dtx) !== null && s !== void 0) || s), O = e.getSourceTrackSettings();
      O.autoGainControl && P.push($.TF_AUTO_GAIN_CONTROL), O.echoCancellation && P.push($.TF_ECHO_CANCELLATION), O.noiseSuppression && P.push($.TF_NOISE_SUPPRESSION), O.channelCount && O.channelCount > 1 && P.push($.TF_STEREO), S && P.push($.TF_NO_DTX), _e(e) && e.hasPreConnectBuffer && P.push($.TF_PRECONNECT_BUFFER);
      const I = new Ki({
        // get local track id for use during publishing
        cid: e.mediaStreamTrack.id,
        name: t.name,
        type: k.kindToProto(e.kind),
        muted: e.isMuted,
        source: k.sourceToProto(e.source),
        disableDtx: S,
      ...
      if (e.kind === k.Kind.Video) {
        ...
        I.width = D.width, I.height = D.height, Le(e) && (Se(p) && (e.source === k.Source.ScreenShare && (t.scalabilityMode = "L1T3", "contentHint" in e.mediaStreamTrack && (e.mediaStreamTrack.contentHint = "motion", this.log.info("forcing contentHint to motion for screenshare with SVC codecs", Object.assign(Object.assign({}, this.logContext), F(e))))), t.scalabilityMode = (c = t.scalabilityMode) !== null && c !== void 0 ? c : "L3T3_KEY"), I.simulcastCodecs = [new qi({
          codec: p,
          cid: e.mediaStreamTrack.id
        })], t.backupCodec === !0 && (t.backupCodec = {
          codec: ln
        }), t.backupCodec && p !== t.backupCodec.codec && // TODO remove this once e2ee is supported for backup codecs
        I.encryption === oe.NONE && (this.roomOptions.dynacast || (this.roomOptions.dynacast = !0), I.simulcastCodecs.push(new qi({
          codec: t.backupCodec.codec,
          cid: ""
        })))), v = hn(e.source === k.Source.ScreenShare, I.width, I.height, t), I.layers = As(I.width, I.height, v, Se(t.videoCodec));
      } else e.kind === k.Kind.Audio && (v = [{
      ...
      if (!this.engine || this.engine.isClosed)
        throw new X("cannot publish track when not connected");
      const y = () => f(this, void 0, void 0, function* () {
        var D, A, N;
        if (!this.engine.pcManager)
          throw new X("pcManager is not ready");
        if (e.sender = yield this.engine.createSender(e, t, v), this.emit(w.LocalSenderCreated, e.sender, e), Le(e) && ((D = t.degradationPreference) !== null && D !== void 0 || (t.degradationPreference = Hd(e)), e.setDegradationPreference(t.degradationPreference)), v)
          if (Xe() && e.kind === k.Kind.Audio) {
            let j;
            ...
            j && this.engine.pcManager.publisher.setTrackCodecBitrate({
              transceiver: j,
              codec: "opus",
              maxbr: !((A = v[0]) === null || A === void 0) && A.maxBitrate ? v[0].maxBitrate / 1e3 : 0
            });
          } else e.codec && Se(e.codec) && (!((N = v[0]) === null || N === void 0) && N.maxBitrate) && this.engine.pcManager.publisher.setTrackCodecBitrate({
            cid: I.cid,
            codec: e.codec,
      ...
      const x = new Promise((D, A) => f(this, void 0, void 0, function* () {
        var N;
        try {
          C = yield this.engine.addTrack(I), D(C);
        } catch (j) {
          e.sender && (!((N = this.engine.pcManager) === null || N === void 0) && N.publisher) && (this.engine.pcManager.publisher.removeTrack(e.sender), yield this.engine.negotiate().catch((te) => {
      ...
      if (this.enabledPublishVideoCodecs.length > 0)
        C = (yield Promise.all([x, y()]))[0];
      else {
        C = yield x;
        let D;
        if (C.codecs.forEach((A) => {
          D === void 0 && (D = A.mimeType);
        }), D && e.kind === k.Kind.Video) {
          const A = St(D);
          A !== p && (this.log.debug("falling back to server selected codec", Object.assign(Object.assign(Object.assign({}, this.logContext), F(e)), {
            codec: A
          })), t.videoCodec = A, v = hn(e.source === k.Source.ScreenShare, I.width, I.height, t));
        }
        yield y();
      }
      const M = new pn(e.kind, C, e, {
        loggerName: this.roomOptions.loggerName,
        loggerContextCb: () => this.logContext
      });
      if (M.on(R.CpuConstrained, (D) => this.onTrackCpuConstrained(D, M)), M.options = t, e.sid = C.sid, this.log.debug("publishing ".concat(e.kind, " with encodings"), Object.assign(Object.assign({}, this.logContext), {
        encodings: v,
        trackInfo: C
      })), Le(e) ? e.startMonitor(this.engine.client) : _e(e) && e.startMonitor(), this.addTrackPublication(M), this.emit(w.LocalTrackPublished, M), _e(e) && C.audioFeatures.includes($.TF_PRECONNECT_BUFFER)) {
        const D = e.getPreConnectBuffer(), A = e.getPreConnectBufferMimeType();
        this.on(w.LocalTrackSubscribed, (N) => {
          if (N.trackSid === C.sid) {
        ...
        }), D && new Promise((j, te) => f(this, void 0, void 0, function* () {
          var Ae, ut, An, Nn, di, li;
          try {
            ...
            }, 1e4), Da = yield this.waitUntilActiveAgentPresent();
            clearTimeout(mi), this.log.debug("sending preconnect buffer", Object.assign(Object.assign({}, this.logContext), F(e)));
            const Ln = yield this.streamBytes({
              name: "preconnect-buffer",
              mimeType: A,
              topic: "lk.agent.pre-connect-audio-buffer",
              destinationIdentities: [Da.identity],
              attributes: {
                trackId: M.trackSid,
                sampleRate: String((di = O.sampleRate) !== null && di !== void 0 ? di : "48000"),
                channels: String((li = O.channelCount) !== null && li !== void 0 ? li : "1")
              }
            });
            try {
              for (var ui = !0, hi = xe(D), fi; fi = yield hi.next(), Ae = fi.done, !Ae; ui = !0) {
                Nn = fi.value, ui = !1;
                const pi = Nn;
                yield Ln.write(pi);
              }
              ...
              try {
                !ui && !Ae && (An = hi.return) && (yield An.call(hi));
              } finally {
  ...
  publishAdditionalCodecForTrack(e, t, i) {
    return f(this, void 0, void 0, function* () {
      var s;
      if (this.encryptionType !== oe.NONE)
        return;
      let r;
      if (this.trackPublications.forEach((m) => {
        m.track && m.track === e && (r = m);
      }), !r)
        throw new Te("track is not published");
      if (!Le(e))
        throw new Te("track is not a video track");
      const a = Object.assign(Object.assign({}, (s = this.roomOptions) === null || s === void 0 ? void 0 : s.publishDefaults), i), o = Kd(e, t, a);
      if (!o) {
      ...
      if (d.layers = As(d.width, d.height, o), !this.engine || this.engine.isClosed)
        throw new X("cannot publish track when not connected");
    ...
    return f(this, void 0, void 0, function* () {
      ...
      if (e.sender = void 0, this.engine.pcManager && this.engine.pcManager.currentState < H.FAILED && c)
        try {
          ...
          if (this.engine.removeTrack(c) && (o = !0), Le(e)) {
        ...
        i.republishPromise && (yield i.republishPromise), i.republishPromise = new Promise((r, a) => f(i, void 0, void 0, function* () {
          try {
            ...
            this.trackPublications.forEach((c) => {
              ...
              const d = c.track;
              yield this.unpublishTrack(d, !1), s && !d.isMuted && d.source !== k.Source.ScreenShare && d.source !== k.Source.ScreenShareAudio && (_e(d) || Le(d)) && !d.isUserProvided && (this.log.debug("restarting existing track", Object.assign(Object.assign({}, this.logContext), {
                track: c.trackSid
  ...
  publishData(e) {
    return f(this, arguments, void 0, function(t) {
      ...
      return function* () {
        const r = s.reliable ? L.RELIABLE : L.LOSSY, a = s.destinationIdentities, o = s.topic, c = new ne({
          kind: r,
          value: {
            case: "user",
            value: new rr({
  ...
  sendChatMessage(e, t) {
    return f(this, void 0, void 0, function* () {
      const i = {
        ...
        value: {
          case: "chatMessage",
          value: new Li(Object.assign(Object.assign({}, i), {
            timestamp: W.parse(i.timestamp)
          }))
        }
      });
    ...
    return f(this, void 0, void 0, function* () {
      const i = Object.assign(Object.assign({}, t), {
        ...
        value: {
          ...
          value: new Li(Object.assign(Object.assign({}, i), {
            timestamp: W.parse(i.timestamp),
            editTimestamp: W.parse(i.editTimestamp)
          }))
        }
      });
      return yield this.engine.sendDataPacket(s, L.RELIABLE), this.emit(w.ChatMessage, i), i;
  ...
  performRpc(e) {
    return f(this, arguments, void 0, function(t) {
      ...
      return function* () {
        return new Promise((d, l) => f(i, void 0, void 0, function* () {
          var u, h, m, b;
          if (Dn(a) > Sa) {
            l(J.builtIn("REQUEST_PAYLOAD_TOO_LARGE"));
            return;
          }
          if (!((h = (u = this.engine.latestJoinResponse) === null || u === void 0 ? void 0 : u.serverInfo) === null || h === void 0) && h.version && Re((b = (m = this.engine.latestJoinResponse) === null || m === void 0 ? void 0 : m.serverInfo) === null || b === void 0 ? void 0 : b.version, "1.8.0") < 0) {
            l(J.builtIn("UNSUPPORTED_SERVER"));
            return;
          }
          const p = crypto.randomUUID();
          yield this.publishRpcRequest(s, p, r, a, o - 2e3);
          const P = setTimeout(() => {
            this.pendingAcks.delete(p), l(J.builtIn("CONNECTION_TIMEOUT")), this.pendingResponses.delete(p), clearTimeout(S);
          }, 2e3);
          ...
          const S = setTimeout(() => {
            this.pendingResponses.delete(p), l(J.builtIn("RESPONSE_TIMEOUT"));
          }, o);
          this.pendingResponses.set(p, {
            resolve: (O, I) => {
              clearTimeout(S), this.pendingAcks.has(p) && (console.warn("RPC response received before ack", p), this.pendingAcks.delete(p), clearTimeout(P)), I ? l(I) : d(O ?? "");
            },
            participantIdentity: s
          });
        }));
  ...
  handleParticipantDisconnected(e) {
    ...
    for (const [t, {
      ...
      i === e && (s(null, J.builtIn("RECIPIENT_DISCONNECTED")), this.pendingResponses.delete(t));
  }
  /** @internal */
  ...
  waitUntilActiveAgentPresent() {
    return this.firstActiveAgent ? Promise.resolve(this.firstActiveAgent) : (this.activeAgentFuture || (this.activeAgentFuture = new Ce()), this.activeAgentFuture.promise);
  }
  getPublicationForTrack(e) {
    let t;
    return this.trackPublications.forEach((i) => {
      const s = i.track;
      s && (e instanceof MediaStreamTrack ? (_e(s) || Le(s)) && s.mediaStreamTrack === e && (t = i) : e === s && (t = i));
    }), t;
  }
...
class ml extends Ie {
  ...
  get subscriptionStatus() {
    return this.subscribed === !1 ? Ie.SubscriptionStatus.Unsubscribed : super.isSubscribed ? Ie.SubscriptionStatus.Subscribed : Ie.SubscriptionStatus.Desired;
  }
  get permissionStatus() {
    return this.allowed ? Ie.PermissionStatus.Allowed : Ie.PermissionStatus.NotAllowed;
  }
  /**
  ...
  setVideoDimensions(e) {
    var t, i;
    this.isManualOperationAllowed() && (((t = this.requestedVideoDimensions) === null || t === void 0 ? void 0 : t.width) === e.width && ((i = this.requestedVideoDimensions) === null || i === void 0 ? void 0 : i.height) === e.height || (Ri(this.track) && (this.requestedVideoDimensions = e), this.requestedMaxQuality = void 0, this.emitTrackUpdate()));
  }
  setVideoFPS(e) {
    this.isManualOperationAllowed() && Ri(this.track) && this.fps !== e && (this.fps = e, this.emitTrackUpdate());
  }
  get videoQuality() {
    var e;
    return (e = this.requestedMaxQuality) !== null && e !== void 0 ? e : ce.HIGH;
  }
  /** @internal */
  setTrack(e) {
  ...
  get isAdaptiveStream() {
    return Ri(this.track) && this.track.isAdaptiveStream;
  }
  /* @internal */
  emitTrackUpdate() {
    const e = new yr({
    ...
    if (this.kind === k.Kind.Video) {
      ...
      if (this.videoDimensionsAdaptiveStream !== void 0)
        if (t)
          ks(this.videoDimensionsAdaptiveStream, t) && (this.log.debug("using adaptive stream dimensions instead of requested", Object.assign(Object.assign({}, this.logContext), this.videoDimensionsAdaptiveStream)), t = this.videoDimensionsAdaptiveStream);
        else if (this.requestedMaxQuality !== void 0 && this.trackInfo) {
          const i = ud(this.trackInfo, this.requestedMaxQuality);
          i && ks(this.videoDimensionsAdaptiveStream, i) && (this.log.debug("using adaptive stream dimensions instead of max quality layer", Object.assign(Object.assign({}, this.logContext), this.videoDimensionsAdaptiveStream)), t = this.videoDimensionsAdaptiveStream);
        } else
...
class ei extends Ia {
  ...
  static fromParticipantInfo(e, t, i) {
    return new ei(e, t.sid, t.identity, t.name, t.metadata, t.attributes, i, t.kind);
  }
  get logContext() {
  ...
  constructor(e, t, i, s, r, a, o) {
    let c = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : Et.STANDARD;
   ...
   */
  setVolume(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : k.Source.Microphone;
   ...
   */
  getVolume() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : k.Source.Microphone;
  ...
  addSubscribedMediaTrack(e, t, i, s, r, a) {
    ...
    let d;
    return c ? d = new ol(e, t, s, r) : d = new al(e, t, s, this.audioContext, this.audioOutput), d.source = o.source, d.isMuted = o.isMuted, d.setMediaStream(i), d.start(), o.setTrack(d), this.volumeMap.has(o.source) && on(d) && Pe(d) && d.setVolume(this.volumeMap.get(o.source)), o;
  }
  /** @internal */
  get hasMetadata() {
  ...
  updateInfo(e) {
    ...
    return e.tracks.forEach((s) => {
      ...
      if (o)
        ...
        const c = k.kindFromProto(s.type);
        if (!c)
          return;
        o = new ml(c, s, (r = this.signalClient.connectOptions) === null || r === void 0 ? void 0 : r.autoSubscribe, {
          loggerContextCb: () => this.logContext,
        ...
        d && o.source !== k.Source.Unknown && this.log.debug("received a second track publication for ".concat(this.identity, " with the same source: ").concat(o.source), Object.assign(Object.assign({}, this.logContext), {
          oldTrack: F(d),
          newTrack: F(o)
  ...
  setAudioOutput(e) {
    return f(this, void 0, void 0, function* () {
      ...
      this.audioTrackPublications.forEach((i) => {
        var s;
        Pe(i.track) && on(i.track) && t.push(i.track.setSinkId((s = e.deviceId) !== null && s !== void 0 ? s : "default"));
      }), yield Promise.all(t);
    });
  }
  /** @internal */
...
const pl = 4 * 1e3;
class Dt extends we.EventEmitter {
  /**
  ...
  constructor(e) {
    var t, i, s, r;
    if (super(), t = this, this.state = V.Disconnected, this.activeSpeakers = [], this.isE2EEEnabled = !1, this.audioEnabled = !0, this.isVideoPlaybackBlocked = !1, this.log = U, this.bufferedEvents = [], this.isResuming = !1, this.rpcHandlers = /* @__PURE__ */ new Map(), this.connect = (a, o, c) => f(this, void 0, void 0, function* () {
      var d;
      if (!zc())
        throw Ee() ? Error("WebRTC isn't detected, have you called registerGlobals?") : Error("LiveKit doesn't seem to be supported on this browser. Try to update your browser and make sure no browser extensions are disabling webRTC.");
      ...
      this.setAndEmitConnectionState(V.Connecting), ((d = this.regionUrlProvider) === null || d === void 0 ? void 0 : d.getServerUrl().toString()) !== a && (this.regionUrl = void 0, this.regionUrlProvider = void 0), sn(new URL(a)) && (this.regionUrlProvider === void 0 ? this.regionUrlProvider = new fn(a, o) : this.regionUrlProvider.updateToken(o), this.regionUrlProvider.fetchRegionSettings().then((m) => {
        var b;
        (b = this.regionUrlProvider) === null || b === void 0 || b.setServerReportedRegions(m);
      }).catch((m) => {
        this.log.warn("could not fetch region settings", Object.assign(Object.assign({}, this.logContext), {
          error: m
        }));
      }));
      const u = (m, b, p) => f(this, void 0, void 0, function* () {
        var P, S;
        this.abortController && this.abortController.abort();
        const O = new AbortController();
        this.abortController = O, l == null || l();
        try {
          yield this.attemptConnection(p ?? a, o, c, O), this.abortController = void 0, m();
        } catch (I) {
          if (this.regionUrlProvider && I instanceof K && I.reason !== B.Cancelled && I.reason !== B.NotAllowed) {
            let v = null;
            try {
              v = yield this.regionUrlProvider.getNextBestRegionUrl((P = this.abortController) === null || P === void 0 ? void 0 : P.signal);
            } catch (y) {
              if (y instanceof K && (y.status === 401 || y.reason === B.Cancelled)) {
                this.handleDisconnect(this.options.stopLocalTrackOnUnpublish), b(y);
                return;
              }
            }
            v && !(!((S = this.abortController) === null || S === void 0) && S.signal.aborted) ? (this.log.info("Initial connection failed with ConnectionError: ".concat(I.message, ". Retrying with another region: ").concat(v), this.logContext), this.recreateEngine(), yield u(m, b, v)) : (this.handleDisconnect(this.options.stopLocalTrackOnUnpublish, ys(I)), b(I));
          } else {
            let v = ge.UNKNOWN_REASON;
            I instanceof K && (v = ys(I)), this.handleDisconnect(this.options.stopLocalTrackOnUnpublish, v), b(I);
          }
        }
      }), h = this.regionUrl;
      return this.regionUrl = void 0, this.connectFuture = new Ce((m, b) => {
        u(m, b, h);
      }, () => {
      ...
      }), this.serverInfo = P, this.log.debug("connected to Livekit Server ".concat(Object.entries(P).map((S) => {
        let [O, I] = S;
        return "".concat(O, ": ").concat(I);
      }).join(", ")), {
        room: (h = p.room) === null || h === void 0 ? void 0 : h.name,
        roomSid: (m = p.room) === null || m === void 0 ? void 0 : m.sid,
        identity: (b = p.participant) === null || b === void 0 ? void 0 : b.identity
      }), !P.version)
        throw new xc("unknown server version");
      return P.version === "0.15.1" && this.options.dynacast && (this.log.debug("disabling dynacast due to server version", this.logContext), l.dynacast = !1), p;
    }), this.applyJoinResponse = (a) => {
      const o = a.participant;
      if (this.localParticipant.sid = o.sid, this.localParticipant.identity = o.identity, this.localParticipant.setEnabledPublishCodecs(a.enabledPublishCodecs), this.options.e2ee && this.e2eeManager)
        try {
      ...
      try {
        ...
        const m = new K("could not establish signal connection", B.ServerUnreachable);
        throw h instanceof Error && (m.message = "".concat(m.message, ": ").concat(h.message)), h instanceof K && (m.reason = h.reason, m.status = h.status), this.log.debug("error trying to establish signal connection", Object.assign(Object.assign({}, this.logContext), {
          error: h
        })), m;
      }
      if (d.signal.aborted)
        throw yield this.engine.close(), this.recreateEngine(), new K("Connection attempt aborted", B.Cancelled);
      try {
      ...
      se() && this.options.disconnectOnPageLeave && (window.addEventListener("pagehide", this.onPageLeave), window.addEventListener("beforeunload", this.onPageLeave)), se() && document.addEventListener("freeze", this.onPageLeave), this.setAndEmitConnectionState(V.Connected), this.emit(E.Connected), this.registerConnectionReconcile();
      ...
      return f(t, [...o], void 0, function() {
        ...
        return function* () {
          var u, h, m, b;
          const p = yield d.disconnectLock.lock();
          try {
            if (d.state === V.Disconnected) {
              d.log.debug("already disconnected", d.logContext);
              return;
            }
            d.log.info("disconnect from room", Object.assign({}, d.logContext)), (d.state === V.Connecting || d.state === V.Reconnecting || d.isResuming) && (d.log.warn("abort connection attempt", d.logContext), (u = d.abortController) === null || u === void 0 || u.abort(), (m = (h = d.connectFuture) === null || h === void 0 ? void 0 : h.reject) === null || m === void 0 || m.call(h, new K("Client initiated disconnect", B.Cancelled)), d.connectFuture = void 0), !((b = d.engine) === null || b === void 0) && b.client.isDisconnected || (yield d.engine.client.sendLeave()), d.engine && (yield d.engine.close()), d.handleDisconnect(l, ge.CLIENT_INITIATED), d.engine = void 0;
          } finally {
            p();
          }
        }();
      ...
      this.setAndEmitConnectionState(V.Reconnecting) && this.emit(E.Reconnecting);
      ...
      this.setAndEmitConnectionState(V.Connected), this.emit(E.Reconnected), this.registerConnectionReconcile(), this.emitBufferedEvents();
      ...
      a.forEach((o) => {
        ...
        o.state === rt.DISCONNECTED ? this.handleParticipantDisconnected(o.identity, d) : d = this.getOrCreateParticipant(o.identity, o);
      });
      ...
      const o = this.remoteParticipants.get(a.participantIdentity);
      if (a.value.case === "user")
        this.handleUserPacket(o, a.value.value, a.kind);
      else if (a.value.case === "transcription")
        this.handleTranscription(o, a.value.value);
      else if (a.value.case === "sipDtmf")
        this.handleSipDtmf(o, a.value.value);
      else if (a.value.case === "chatMessage")
        this.handleChatMessage(o, a.value.value);
      else if (a.value.case === "metrics")
        this.handleMetrics(a.value.value, o);
      else if (a.value.case === "streamHeader" || a.value.case === "streamChunk" || a.value.case === "streamTrailer")
        this.handleDataStream(a);
      ...
      this.emit(E.DataReceived, o.payload, a, c, o.topic), a == null || a.emit(w.DataReceived, o.payload, c);
    }, this.handleSipDtmf = (a, o) => {
      this.emit(E.SipDTMFReceived, o, a), a == null || a.emit(w.SipDTMFReceived, o);
    }, this.handleTranscription = (a, o) => {
      const c = o.transcribedParticipantIdentity === this.localParticipant.identity ? this.localParticipant : this.getParticipantByIdentity(o.transcribedParticipantIdentity), d = c == null ? void 0 : c.trackPublications.get(o.trackId), l = td(o, this.transcriptionReceivedTimes);
      d == null || d.emit(R.TranscriptionReceived, l), c == null || c.emit(w.TranscriptionReceived, l, d), this.emit(E.TranscriptionReceived, l, c, d);
      ...
      this.incomingDataStreamManager.handleDataStreamPacket(a);
      ...
      var a;
      ((a = de()) === null || a === void 0 ? void 0 : a.os) !== "iOS" && (yield this.selectDefaultDevices()), this.emit(E.MediaDevicesChanged);
    }), this.handleRoomUpdate = (a) => {
      const o = this.roomInfo;
      this.roomInfo = a, o && o.metadata !== a.metadata && this.emitWhenConnected(E.RoomMetadataChanged, a.metadata), (o == null ? void 0 : o.activeRecording) !== a.activeRecording && this.emitWhenConnected(E.RecordingStatusChanged, a.activeRecording);
      ...
      var o, c, d, l, u, h;
      (o = a.track) === null || o === void 0 || o.on(R.TrackProcessorUpdate, this.onTrackProcessorUpdate), (c = a.track) === null || c === void 0 || c.on(R.Restarted, this.onLocalTrackRestarted), (u = (l = (d = a.track) === null || d === void 0 ? void 0 : d.getProcessor()) === null || l === void 0 ? void 0 : l.onPublish) === null || u === void 0 || u.call(l, this), this.emit(E.LocalTrackPublished, a, this.localParticipant), _e(a.track) && (yield a.track.checkForSilence()) && this.emit(E.LocalAudioSilenceDetected, a);
      const m = yield (h = a.track) === null || h === void 0 ? void 0 : h.getDeviceId(!1), b = dn(a.source);
      b && m && m !== this.localParticipant.activeDeviceMap.get(b) && (this.localParticipant.activeDeviceMap.set(b, m), this.emit(E.ActiveDeviceChanged, b, m));
    }), this.onLocalTrackUnpublished = (a) => {
      var o, c;
      (o = a.track) === null || o === void 0 || o.off(R.TrackProcessorUpdate, this.onTrackProcessorUpdate), (c = a.track) === null || c === void 0 || c.off(R.Restarted, this.onLocalTrackRestarted), this.emit(E.LocalTrackUnpublished, a, this.localParticipant);
    }, this.onLocalTrackRestarted = (a) => f(this, void 0, void 0, function* () {
      const o = yield a.getDeviceId(!1), c = dn(a.source);
    ...
    }, this.setMaxListeners(100), this.remoteParticipants = /* @__PURE__ */ new Map(), this.sidToIdentity = /* @__PURE__ */ new Map(), this.options = Object.assign(Object.assign({}, _d), e), this.log = Me((i = this.options.loggerName) !== null && i !== void 0 ? i : ve.Room), this.transcriptionReceivedTimes = /* @__PURE__ */ new Map(), this.options.audioCaptureDefaults = Object.assign(Object.assign({}, ka), e == null ? void 0 : e.audioCaptureDefaults), this.options.videoCaptureDefaults = Object.assign(Object.assign({}, Ta), e == null ? void 0 : e.videoCaptureDefaults), this.options.publishDefaults = Object.assign(Object.assign({}, wd), e == null ? void 0 : e.publishDefaults), this.maybeCreateEngine(), this.incomingDataStreamManager = new il(), this.outgoingDataStreamManager = new rl(this.engine, this.log), this.disconnectLock = new re(), this.localParticipant = new fl("", "", this.engine, this.options, this.rpcHandlers, this.outgoingDataStreamManager), this.options.videoCaptureDefaults.deviceId && this.localParticipant.activeDeviceMap.set("videoinput", qe(this.options.videoCaptureDefaults.deviceId)), this.options.audioCaptureDefaults.deviceId && this.localParticipant.activeDeviceMap.set("audioinput", qe(this.options.audioCaptureDefaults.deviceId)), !((s = this.options.audioOutput) === null || s === void 0) && s.deviceId && this.switchActiveDevice("audiooutput", qe(this.options.audioOutput.deviceId)).catch((a) => this.log.warn("Could not set audio output: ".concat(a.message), this.logContext)), this.options.e2ee && this.setupE2EE(), se()) {
  ...
  setupE2EE() {
    var e;
    this.options.e2ee && ("e2eeManager" in this.options.e2ee ? this.e2eeManager = this.options.e2ee.e2eeManager : this.e2eeManager = new hd(this.options.e2ee), this.e2eeManager.on(je.ParticipantEncryptionStatusChanged, (t, i) => {
      sd(i) && (this.isE2EEEnabled = t), this.emit(E.ParticipantEncryptionStatusChanged, t, i);
    }), this.e2eeManager.on(je.EncryptionError, (t) => this.emit(E.EncryptionError, t)), (e = this.e2eeManager) === null || e === void 0 || e.setup(this));
  }
  get logContext() {
    var e;
    return {
  ...
  maybeCreateEngine() {
    this.engine && !this.engine.isClosed || (this.engine = new Yd(this.options), this.engine.on(_.ParticipantUpdate, this.handleParticipantUpdates).on(_.RoomUpdate, this.handleRoomUpdate).on(_.SpeakersChanged, this.handleSpeakersChanged).on(_.StreamStateChanged, this.handleStreamStateUpdate).on(_.ConnectionQualityUpdate, this.handleConnectionQualityUpdate).on(_.SubscriptionError, this.handleSubscriptionError).on(_.SubscriptionPermissionUpdate, this.handleSubscriptionPermissionUpdate).on(_.MediaTrackAdded, (e, t, i) => {
      ...
      this.clearConnectionReconcile(), this.isResuming = !0, this.log.info("Resuming signal connection", this.logContext), this.setAndEmitConnectionState(V.SignalReconnecting) && this.emit(E.SignalReconnecting);
    }).on(_.Resumed, () => {
      this.registerConnectionReconcile(), this.isResuming = !1, this.log.info("Resumed signal connection", this.logContext), this.updateSubscriptions(), this.emitBufferedEvents(), this.setAndEmitConnectionState(V.Connected) && this.emit(E.Reconnected);
    }).on(_.SignalResumed, () => {
  ...
  static getLocalDevices(e) {
    ...
    return Z.getInstance().getDevices(e, t);
  }
  /**
  ...
  prepareConnection(e, t) {
    return f(this, void 0, void 0, function* () {
      if (this.state === V.Disconnected) {
        ...
        try {
          if (sn(new URL(e)) && t) {
            this.regionUrlProvider = new fn(e, t);
            const i = yield this.regionUrlProvider.getNextBestRegionUrl();
            i && this.state === V.Disconnected && (this.regionUrl = i, yield fetch(an(i), {
              method: "HEAD"
  ...
  switchActiveDevice(e, t) {
    return f(this, arguments, void 0, function(i, s) {
      ...
      return function* () {
        ...
        if (i === "audioinput") {
          p = r.localParticipant.audioTrackPublications.size === 0;
          const S = (o = r.getActiveDevice(i)) !== null && o !== void 0 ? o : r.options.audioCaptureDefaults.deviceId;
          r.options.audioCaptureDefaults.deviceId = P;
          const O = Array.from(r.localParticipant.audioTrackPublications.values()).filter((v) => v.source === k.Source.Microphone);
          try {
            b = (yield Promise.all(O.map((v) => {
              var y;
              return (y = v.audioTrack) === null || y === void 0 ? void 0 : y.setDeviceId(P);
            }))).every((v) => v === !0);
          } catch (v) {
            throw r.options.audioCaptureDefaults.deviceId = S, v;
          }
          const I = O.some((v) => {
            var y, C;
          ...
          p = r.localParticipant.videoTrackPublications.size === 0;
          const S = (c = r.getActiveDevice(i)) !== null && c !== void 0 ? c : r.options.videoCaptureDefaults.deviceId;
          r.options.videoCaptureDefaults.deviceId = P;
          const O = Array.from(r.localParticipant.videoTrackPublications.values()).filter((v) => v.source === k.Source.Camera);
          try {
            b = (yield Promise.all(O.map((v) => {
              var y;
              return (y = v.videoTrack) === null || y === void 0 ? void 0 : y.setDeviceId(P);
            }))).every((v) => v === !0);
          } catch (v) {
            throw r.options.videoCaptureDefaults.deviceId = S, v;
          }
          const I = O.some((v) => {
            var y, C;
            return (C = (y = v.track) === null || y === void 0 ? void 0 : y.isMuted) !== null && C !== void 0 ? C : !1;
          ...
          if (p = !0, !nn() && !r.options.webAudioMix || r.options.webAudioMix && r.audioContext && !("setSinkId" in r.audioContext))
            throw new Error("cannot switch audio output, the current browser does not support it");
          r.options.webAudioMix && (s = (d = yield Z.getInstance().normalizeDeviceId("audiooutput", s)) !== null && d !== void 0 ? d : ""), (l = (m = r.options).audioOutput) !== null && l !== void 0 || (m.audioOutput = {});
          const S = (u = r.getActiveDevice(i)) !== null && u !== void 0 ? u : r.options.audioOutput.deviceId;
          r.options.audioOutput.deviceId = s;
          try {
            r.options.webAudioMix && ((h = r.audioContext) === null || h === void 0 || h.setSinkId(s)), yield Promise.all(Array.from(r.remoteParticipants.values()).map((O) => O.setAudioOutput({
              deviceId: s
            })));
          } catch (O) {
            throw r.options.audioOutput.deviceId = S, O;
          }
        }
        return p && (r.localParticipant.activeDeviceMap.set(i, s), r.emit(E.ActiveDeviceChanged, i, s)), b;
      }();
    });
  }
  ...
  onTrackAdded(e, t, i) {
    ...
    l != null && l.isEncrypted && !this.e2eeManager && this.emit(E.EncryptionError, new Error("Encrypted ".concat(l.source, " track received from participant ").concat(c.sid, ", but room does not have encryption enabled!")));
  }
  handleDisconnect() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0, t = arguments.length > 1 ? arguments[1] : void 0;
    var i;
    if (this.clearConnectionReconcile(), this.isResuming = !1, this.bufferedEvents = [], this.transcriptionReceivedTimes.clear(), this.incomingDataStreamManager.clearHandlersAndControllers(), this.state !== V.Disconnected) {
      ...
      try {
        ...
        }), this.localParticipant.off(w.ParticipantMetadataChanged, this.onLocalParticipantMetadataChanged).off(w.ParticipantNameChanged, this.onLocalParticipantNameChanged).off(w.AttributesChanged, this.onLocalAttributesChanged).off(w.TrackMuted, this.onLocalTrackMuted).off(w.TrackUnmuted, this.onLocalTrackUnmuted).off(w.LocalTrackPublished, this.onLocalTrackPublished).off(w.LocalTrackUnpublished, this.onLocalTrackUnpublished).off(w.ConnectionQualityChanged, this.onLocalConnectionQualityChanged).off(w.MediaDevicesError, this.onMediaDevicesError).off(w.AudioStreamAcquired, this.startAudio).off(w.ChatMessage, this.onLocalChatMessageSent).off(w.ParticipantPermissionsChanged, this.onLocalParticipantPermissionsChanged), this.localParticipant.trackPublications.clear(), this.localParticipant.videoTrackPublications.clear(), this.localParticipant.audioTrackPublications.clear(), this.remoteParticipants.clear(), this.sidToIdentity.clear(), this.activeSpeakers = [], this.audioContext && typeof this.options.webAudioMix == "boolean" && (this.audioContext.close(), this.audioContext = void 0), se() && (window.removeEventListener("beforeunload", this.onPageLeave), window.removeEventListener("pagehide", this.onPageLeave), window.removeEventListener("freeze", this.onPageLeave), (i = navigator.mediaDevices) === null || i === void 0 || i.removeEventListener("devicechange", this.handleDeviceChange));
      } finally {
        this.setAndEmitConnectionState(V.Disconnected), this.emit(E.Disconnected, t);
      }
    }
  }
  ...
  handleIncomingRpcRequest(e, t, i, s, r, a) {
    return f(this, void 0, void 0, function* () {
      if (yield this.engine.publishRpcAck(e, t), a !== 1) {
        yield this.engine.publishRpcResponse(e, t, null, J.builtIn("UNSUPPORTED_VERSION"));
        return;
      }
      const o = this.rpcHandlers.get(i);
      if (!o) {
        yield this.engine.publishRpcResponse(e, t, null, J.builtIn("UNSUPPORTED_METHOD"));
        return;
      }
      let c = null, d = null;
      try {
        ...
        Dn(l) > Sa ? (c = J.builtIn("RESPONSE_PAYLOAD_TOO_LARGE"), console.warn("RPC Response payload too large for ".concat(i))) : d = l;
      } catch (l) {
        l instanceof J ? c = l : (console.warn("Uncaught error returned by RPC handler for ".concat(i, ". Returning APPLICATION_ERROR instead."), l), c = J.builtIn("APPLICATION_ERROR"));
      }
  ...
  selectDefaultDevices() {
    return f(this, void 0, void 0, function* () {
      var e, t, i;
      const s = Z.getInstance().previousDevices, r = yield Z.getInstance().getDevices(void 0, !1), a = de();
      ...
      for (let c of o) {
        const d = ad(c), l = this.localParticipant.getTrackPublication(d);
        ...
        c === "audioinput" && !_t() || c === "videoinput" || u.length > 0 && !u.find((m) => m.deviceId === this.getActiveDevice(c)) && // avoid switching audio output on safari without explicit user action as it leads to slowed down audio playback
        (c !== "audiooutput" || !_t()) && (yield this.switchActiveDevice(c, u[0].deviceId));
      }
    });
  }
  acquireAudioContext() {
    return f(this, void 0, void 0, function* () {
      var e, t;
      if (typeof this.options.webAudioMix != "boolean" && this.options.webAudioMix.audioContext ? this.audioContext = this.options.webAudioMix.audioContext : (!this.audioContext || this.audioContext.state === "closed") && (this.audioContext = (e = Rn()) !== null && e !== void 0 ? e : void 0), this.options.webAudioMix && this.remoteParticipants.forEach((s) => s.setAudioContext(this.audioContext)), this.localParticipant.setAudioContext(this.audioContext), this.audioContext && this.audioContext.state === "suspended")
        try {
  ...
  createParticipant(e, t) {
    var i;
    let s;
    return t ? s = ei.fromParticipantInfo(this.engine.client, t, {
      loggerContextCb: () => this.logContext,
      loggerName: this.options.loggerName
    }) : s = new ei(this.engine.client, "", e, void 0, void 0, void 0, {
      loggerContextCb: () => this.logContext,
      loggerName: this.options.loggerName
  ...
  getOrCreateParticipant(e, t) {
    ...
    return this.remoteParticipants.set(e, i), this.sidToIdentity.set(t.sid, t.identity), this.emitWhenConnected(E.ParticipantConnected, i), i.on(w.TrackPublished, (s) => {
      ...
      s.kind === k.Kind.Audio ? (s.on(R.AudioPlaybackStarted, this.handleAudioPlaybackStarted), s.on(R.AudioPlaybackFailed, this.handleAudioPlaybackFailed)) : s.kind === k.Kind.Video && (s.on(R.VideoPlaybackFailed, this.handleVideoPlaybackFailed), s.on(R.VideoPlaybackStarted, this.handleVideoPlaybackStarted)), this.emit(E.TrackSubscribed, s, r, i);
      ...
      this.emitWhenConnected(E.ParticipantActive, i), i.kind === Et.AGENT && this.localParticipant.setActiveAgent(i);
    }), t && i.updateInfo(t), i;
  }
  sendSyncState() {
  ...
  updateSubscriptions() {
    for (const e of this.remoteParticipants.values())
      for (const t of e.videoTrackPublications.values())
        t.isSubscribed && nd(t) && t.emitTrackUpdate();
  }
  ...
  registerConnectionReconcile() {
    ...
    let e = 0;
    this.connectionReconcileInterval = ee.setInterval(() => {
      ...
      })), e >= 3 && (this.recreateEngine(), this.handleDisconnect(this.options.stopLocalTrackOnUnpublish, ge.STATE_MISMATCH))) : e = 0;
    }, pl);
  }
  clearConnectionReconcile() {
    this.connectionReconcileInterval && ee.clearInterval(this.connectionReconcileInterval);
  }
  ...
  emitWhenConnected(e) {
    for (var t = arguments.length, i = new Array(t > 1 ? t - 1 : 0), s = 1; s < t; s++)
      i[s - 1] = arguments[s];
    if (this.state === V.Reconnecting || this.isResuming || !this.engine || this.engine.pendingReconnect)
      this.bufferedEvents.push([e, i]);
    else if (this.state === V.Connected)
  ...
  simulateParticipants(e) {
    return f(this, void 0, void 0, function* () {
      ...
      if (this.handleDisconnect(), this.roomInfo = new ii({
        sid: "RM_SIMULATED",
        name: "simulated-room",
        emptyTimeout: 0,
        maxParticipants: 0,
        creationTime: W.parse((/* @__PURE__ */ new Date()).getTime()),
        metadata: "",
        numParticipants: 1,
        numPublishers: 1,
        turnPassword: "",
        enabledCodecs: [],
        activeRecording: !1
      }), this.localParticipant.updateInfo(new Qe({
        identity: "simulated-local",
        name: "local-name"
      })), this.setupLocalParticipantEvents(), this.emit(E.SignalConnected), this.emit(E.Connected), this.setAndEmitConnectionState(V.Connected), s.video) {
        const a = new pn(k.Kind.Video, new nt({
          source: Y.CAMERA,
          sid: Math.floor(Math.random() * 1e4).toString(),
          type: fe.AUDIO,
          name: "video-dummy"
        }), new Ot(s.useRealTracks ? (yield window.navigator.mediaDevices.getUserMedia({
          video: !0
        })).getVideoTracks()[0] : rn(160 * ((t = r.aspectRatios[0]) !== null && t !== void 0 ? t : 1), 160, !0, !0), void 0, !1, {
          loggerName: this.options.loggerName,
          loggerContextCb: () => this.logContext
        }), {
          loggerName: this.options.loggerName,
      ...
      if (s.audio) {
        const a = new pn(k.Kind.Audio, new nt({
          source: Y.MICROPHONE,
          sid: Math.floor(Math.random() * 1e4).toString(),
          type: fe.AUDIO
        }), new It(s.useRealTracks ? (yield navigator.mediaDevices.getUserMedia({
          audio: !0
        })).getAudioTracks()[0] : Ei(), void 0, !1, this.audioContext, {
          loggerName: this.options.loggerName,
          loggerContextCb: () => this.logContext
        }), {
          loggerName: this.options.loggerName,
      ...
      for (let a = 0; a < r.count - 1; a += 1) {
        let o = new Qe({
          ...
          state: rt.ACTIVE,
          tracks: [],
          joinedAt: W.parse(Date.now())
        });
        const c = this.getOrCreateParticipant(o.identity, o);
        if (r.video) {
          const d = rn(160 * ((i = r.aspectRatios[a % r.aspectRatios.length]) !== null && i !== void 0 ? i : 1), 160, !1, !0), l = new nt({
            source: Y.CAMERA,
            sid: Math.floor(Math.random() * 1e4).toString(),
            type: fe.AUDIO
          });
  ...
  emit(e) {
    ...
    if (e !== E.ActiveSpeakersChanged && e !== E.TranscriptionReceived) {
      const r = Oa(i).filter((a) => a !== void 0);
...
Dt.cleanupRegistry = typeof FinalizationRegistry < "u" && new FinalizationRegistry((n) => {
  n();
});
function Oa(n) {
  return n.map((e) => {
    if (e)
      return Array.isArray(e) ? Oa(e) : typeof e == "object" ? "logContext" in e ? e.logContext : void 0 : e;
  });
}
class gl {
...
class We extends we.EventEmitter {
  constructor(e, t) {
    let i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    super(), this.status = he.IDLE, this.logs = [], this.options = {}, this.url = e, this.token = t, this.name = this.constructor.name, this.room = new Dt(i.roomOptions), this.connectOptions = i.connectOptions, this.options = i;
  }
  run(e) {
    return f(this, void 0, void 0, function* () {
      if (this.status !== he.IDLE)
        throw Error("check is running already");
      this.setStatus(he.RUNNING);
      try {
        yield this.perform();
      } catch (t) {
        t instanceof Error && (this.options.errorsAsWarnings ? this.appendWarning(t.message) : this.appendError(t.message));
      }
      return yield this.disconnect(), yield new Promise((t) => setTimeout(t, 500)), this.status !== he.SKIPPED && this.setStatus(this.isSuccess() ? he.SUCCESS : he.FAILED), e && e(), this.getInfo();
    });
  }
  isSuccess() {
  ...
  connect(e) {
    return f(this, void 0, void 0, function* () {
      return this.room.state === V.Connected ? this.room : (e || (e = this.url), yield this.room.connect(e, this.token, this.connectOptions), this.room);
    });
  }
  disconnect() {
    return f(this, void 0, void 0, function* () {
...
class vl extends We {
  ...
  perform() {
    return f(this, void 0, void 0, function* () {
      const e = new fn(this.url, this.token);
      if (!e.isCloud()) {
        this.skip();
        return;
      }
  ...
  checkCloudRegion(e) {
    return f(this, void 0, void 0, function* () {
      ...
      return h == null || h.forEach((b) => {
        b.type === "candidate-pair" && b.nominated && (m.rtt = b.currentRoundTripTime * 1e3);
...
class bl extends We {
  ...
  perform() {
    return f(this, void 0, void 0, function* () {
      ...
      this.appendMessage("upstream bitrate: ".concat((i.bitrateTotal / i.count / 1e3 / 1e3).toFixed(2), " mbps")), this.appendMessage("RTT: ".concat((i.rttTotal / i.count * 1e3).toFixed(2), " ms")), this.appendMessage("jitter: ".concat((i.jitterTotal / i.count * 1e3).toFixed(2), " ms")), i.packetsLost > 0 && this.appendWarning("packets lost: ".concat((i.packetsLost / i.packetsSent * 100).toFixed(2), "%")), i.qualityLimitationDurations.bandwidth > 1 && this.appendWarning("bandwidth limited ".concat((i.qualityLimitationDurations.bandwidth / (Ai / 1e3) * 100).toFixed(2), "%")), i.qualityLimitationDurations.cpu > 0 && this.appendWarning("cpu limited ".concat((i.qualityLimitationDurations.cpu / (Ai / 1e3) * 100).toFixed(2), "%"));
    });
  }
  getInfo() {
    const e = super.getInfo();
  ...
  checkConnectionProtocol(e) {
    return f(this, void 0, void 0, function* () {
      ...
      return yield new Promise((h) => setTimeout(h, Ai)), clearInterval(u), o.stop(), t.remove(), yield this.disconnect(), l;
    });
  }
}
class yl extends We {
  ...
  perform() {
    return f(this, void 0, void 0, function* () {
      var e;
      const t = yield this.connect(), i = yield ll();
      if (yield ga(i, 1e3))
...
class kl extends We {
  ...
  perform() {
    return f(this, void 0, void 0, function* () {
      var e;
      const t = yield this.connect(), i = yield dl();
  ...
  checkForVideo(e) {
    return f(this, void 0, void 0, function* () {
      ...
      i.srcObject = t, i.muted = !0, yield new Promise((s) => {
        i.onplay = () => {
          setTimeout(() => {
            var r, a, o, c;
            ...
            m.drawImage(i, 0, 0);
            const p = m.getImageData(0, 0, d.width, d.height).data;
            let P = !0;
            for (let S = 0; S < p.length; S += 4)
              if (p[S] !== 0 || p[S + 1] !== 0 || p[S + 2] !== 0) {
                P = !1;
                break;
              }
...
class Sl extends We {
  ...
  perform() {
    return f(this, void 0, void 0, function* () {
      var e, t;
      const i = new wn(), s = yield i.join(this.url, this.token, {
        autoSubscribe: !0,
        maxRetries: 0,
        e2eeEnabled: !1,
        websocketTimeout: 15e3
      ...
      this.room.on(E.SignalConnected, () => {
        ...
        this.room.engine.client.onTrickle = (s, r) => {
          if (s.candidate) {
            ...
            a.address && (Pl(a.address) ? o += " (private)" : a.protocol === "tcp" && a.tcpType === "passive" ? (e = !0, o += " (passive)") : a.protocol === "udp" && (t = !0)), this.appendMessage(o);
          }
          i && i(s, r);
...
class El extends We {
  ...
  perform() {
    return f(this, void 0, void 0, function* () {
      ...
      this.appendMessage("Connected to server, version ".concat(r.serverVersion, ".")), ((e = r.serverInfo) === null || e === void 0 ? void 0 : e.edition) === fr.Cloud && (!((t = r.serverInfo) === null || t === void 0) && t.region) && this.appendMessage("LiveKit Cloud: ".concat((i = r.serverInfo) === null || i === void 0 ? void 0 : i.region)), yield s.close();
    });
  }
}
class Ql extends we.EventEmitter {
  constructor(e, t) {
    let i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  isSuccess() {
    return Array.from(this.checkResults.values()).every((e) => e.status !== he.FAILED);
  }
  getResults() {
  ...
  checkWebsocket() {
    return f(this, void 0, void 0, function* () {
      return this.createAndRunCheck(El);
    });
  }
  checkWebRTC() {
    return f(this, void 0, void 0, function* () {
      return this.createAndRunCheck(Cl);
    });
  }
  checkTURN() {
    return f(this, void 0, void 0, function* () {
      return this.createAndRunCheck(Sl);
    });
  }
  checkReconnect() {
    return f(this, void 0, void 0, function* () {
      return this.createAndRunCheck(Tl);
    });
  }
  checkPublishAudio() {
    return f(this, void 0, void 0, function* () {
      return this.createAndRunCheck(yl);
    });
  }
  checkPublishVideo() {
    return f(this, void 0, void 0, function* () {
...
function Yl(n) {
  ...
  var t;
  const i = Je(n) ? n.mediaStreamTrack : n, s = i.getSettings();
  let r = {
  ...
  if ("facingMode" in s) {
    ...
    U.trace("rawFacingMode", {
      rawFacingMode: a
    }), a && typeof a == "string" && _l(a) && (r = {
      facingMode: a,
      confidence: "high"
    });
  }
  if (["low", "medium"].includes(r.confidence)) {
    U.trace("Try to get facing mode from device label: (".concat(i.label, ")"));
    const a = wl(i.label);
    a !== void 0 && (r = a);
  }
  return r;
}
const Fs = /* @__PURE__ */ new Map([["obs virtual camera", {
  facingMode: "environment",
  confidence: "medium"
}]]), Rl = /* @__PURE__ */ new Map([["iphone", {
  facingMode: "environment",
  confidence: "medium"
}], ["ipad", {
  facingMode: "environment",
...
function wl(n) {
  ...
  if (t !== "")
    return Fs.has(t) ? Fs.get(t) : (e = Array.from(Rl.entries()).find((i) => {
      let [s] = i;
      return t.includes(s);
    })) === null || e === void 0 ? void 0 : e[1];
}
function _l(n) {
  return n === void 0 || ["user", "environment", "left", "right"].includes(n);
}
export {
  Zi as AudioPresets,
  ms as BackupCodecPolicy,
  Dc as BaseKeyProvider,
  he as CheckStatus,
  We as Checker,
  Ql as ConnectionCheck,
  K as ConnectionError,
  B as ConnectionErrorReason,
  Be as ConnectionQuality,
  V as ConnectionState,
  ee as CriticalTimers,
  Vl as CryptorError,
  $i as CryptorErrorReason,
  ls as CryptorEvent,
  L as DataPacket_Kind,
  Fe as DataStreamError,
  pe as DataStreamErrorReason,
  hc as DefaultReconnectPolicy,
  ri as DeviceUnsupportedError,
  ge as DisconnectReason,
  je as EncryptionEvent,
  _ as EngineEvent,
  Bl as ExternalE2EEKeyProvider,
  ds as KeyHandlerEvent,
  Ve as KeyProviderEvent,
  be as LivekitError,
  It as LocalAudioTrack,
  fl as LocalParticipant,
  Ca as LocalTrack,
  pn as LocalTrackPublication,
  xd as LocalTrackRecorder,
  Ot as LocalVideoTrack,
  Rt as LogLevel,
  ve as LoggerNames,
  Xt as MediaDeviceFailure,
  re as Mutex,
  Xi as NegotiationError,
  Ia as Participant,
  w as ParticipantEvent,
  Et as ParticipantKind,
  jl as PublishDataError,
  hs as PublishTrackError,
  al as RemoteAudioTrack,
  ei as RemoteParticipant,
  _a as RemoteTrack,
  ml as RemoteTrackPublication,
  ol as RemoteVideoTrack,
  Dt as Room,
  E as RoomEvent,
  J as RpcError,
  ai as ScreenSharePresets,
  fs as SignalRequestError,
  Io as SubscriptionError,
  k as Track,
  R as TrackEvent,
  Te as TrackInvalidError,
  Ie as TrackPublication,
  fe as TrackType,
  X as UnexpectedConnectionState,
  xc as UnsupportedServer,
  q as VideoPreset,
  wt as VideoPresets,
  en as VideoPresets43,
  ce as VideoQuality,
  st as attachToElement,
  Jl as attributes,
  Re as compareVersions,
  Wl as createAudioAnalyser,
  Al as createE2EEKey,
  Ic as createKeyMaterialFromBuffer,
  _c as createKeyMaterialFromString,
  ll as createLocalAudioTrack,
  zl as createLocalScreenTracks,
  ci as createLocalTracks,
  dl as createLocalVideoTrack,
  Ml as deriveKeys,
  ct as detachTrack,
  wl as facingModeFromDeviceLabel,
  Yl as facingModeFromLocalTrack,
  de as getBrowser,
  Ei as getEmptyAudioStreamTrack,
  Gl as getEmptyVideoStreamTrack,
  Me as getLogger,
  xl as importKey,
  Pe as isAudioTrack,
  qc as isBackupCodec,
  zc as isBrowserSupported,
  Rc as isE2EESupported,
  wc as isInsertableStreamSupported,
  sd as isLocalParticipant,
  Je as isLocalTrack,
  Hl as isRemoteParticipant,
  on as isRemoteTrack,
  Yi as isScriptTransformSupported,
  Dl as isVideoFrame,
  Ge as isVideoTrack,
  Ll as needsRbspUnescaping,
  Ul as parseRbsp,
  Fc as protocolVersion,
  Nl as ratchet,
  Ol as setLogExtension,
  Il as setLogLevel,
  Wc as supportsAV1,
  ql as supportsAdaptiveStream,
  Kl as supportsDynacast,
  Hc as supportsVP9,
  Uc as version,
  Vc as videoCodecs,
  Fl as writeRbsp
