...
export function CollegeDashboardNmc({ onNavigate }: CollegeDashboardNmcProps) {
  ...
  const collegeInfo = {
    ...
    shortName: 'NMC',
    contactPerson: 'Neda De Leon Guerro',
  ...
  // Regional Feed Data (same as NMTECH for consistency)
  const regionalFeed = [
    {
      id: '1',
  ...
  // Programs Data (NMC specific programs)
  const programs = [
    {
      id: 'prog_1',
      name: 'Nursing (RN)',
      description: 'Comprehensive nursing program preparing students for RN certification',
      category: 'Healthcare',
      duration: '3 years',
    ...
    },
    {
      id: 'prog_2',
      name: 'Education',
      description: 'Teacher preparation program with elementary and secondary focus',
      category: 'Education',
      duration: '4 years',
    ...
    },
    {
      ...
      description: 'Law enforcement and public safety professional training',
    ...
    },
    {
      id: 'prog_4',
      name: 'Liberal Arts',
      description: 'Foundational studies in humanities, social sciences, and communication',
  ...
  // Board Posts Data (same posts for shared board)
  const boardPosts = [
    {
      id: 'post_1',
  ...
  return (
    <div className="min-h-screen pt-16 sm:pt-20 bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 rounded-3xl p-8 text-white shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-4xl font-black mb-2">{collegeInfo.shortName} 🎓</h1>
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-purple-100">Partner Rating</p>
            </div>
          </div>
        </div>
